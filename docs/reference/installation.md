...
- The activation of output filters
  (see [thematic-trimming](solver/parameters.md#thematic-trimming) and [geographic-trimming](solver/parameters.md#geographic-trimming) parameters).
- The number of Monte-Carlo years involved in the simulation session, if the storage of detailed
  [year-by-year results](solver/parameters.md#year-by-year) is activated
- Whether [MPS export](solver/parameters.md#include-exportmps) is activated
...
- The simulation [mode](solver/parameters.md#mode)
- The [unit commitment resolution mode](solver/parameters.md#unit-commitment-mode)
