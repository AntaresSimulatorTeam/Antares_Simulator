...
1. Initializing or updating the input data (time-series, grid topology, fleet description, etc.).  
   *In this step, the user is expected to provide all the input data they have, except the time-series that are 
   supposed to be [automatically generated](solver/legacy-solver/04-parameters.md#generate) by *Antares* (see step (3)).*  
...
3. *(Optional)* If some time-series are supposed to be [automatically generated](solver/legacy-solver/04-parameters.md#generate), 
