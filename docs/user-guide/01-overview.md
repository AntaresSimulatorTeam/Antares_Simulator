...
In these studies, the default *Antares* option to use is the [`economy`](solver/legacy-solver/04-parameters.md#mode) simulation mode.
...
[^2]: See [hydro-pricing-mode](solver/legacy-solver/04-parameters.md#hydro-pricing-mode), [unit-commitment-mode](solver/legacy-solver/04-parameters.md#unit-commitment-mode)
...
[^3]: See how *Antares* addresses stock dependency between successive problems [here](solver/legacy-solver/06-hydro-heuristics.md#seasonal-hydro-pre-allocation).