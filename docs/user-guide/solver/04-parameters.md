...
- **Required:** no
- **Default value:** `false`
  - `true`: Output files in format remix-*year*-*week*.csv containing withdrawal for all storages. Each line of the
    file is associated to an hour and is formatted like this : *area*, *storage*, *hour*, *withdrawal*
  - `false`: Doesn't create the folder
