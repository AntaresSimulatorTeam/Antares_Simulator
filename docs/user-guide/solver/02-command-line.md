...
| --expansion            | Force the simulation in [expansion](legacy-solver/04-parameters.md#mode) mode                                                     |
| --economy              | Force the simulation in [economy](legacy-solver/04-parameters.md#mode) mode                                                       |
| --adequacy             | Force the simulation in [adequacy](legacy-solver/04-parameters.md#mode) mode                                                      |
...
| -y, --year=VALUE         | Override the [number of MC years](legacy-solver/04-parameters.md#nbyears)                                       |
| --year-by-year           | Force the [writing the result output for each year](legacy-solver/04-parameters.md#year-by-year) (economy only) |
| --derated                | Force the [derated](legacy-solver/04-parameters.md#derated) mode                                                |
...
| command                  | usage                                                                                                                                                                                                                                                  |
|:-------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| --optimization-range     | Force the [simplex optimization range](legacy-solver/04-parameters.md#simplex-range) ('day' or 'week')                                                                                                                                                 |
