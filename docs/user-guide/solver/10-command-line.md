...
| --parallel-week-count=VALUE         | Number of weeks to solve [concurrently within each MC year](optional-features/multi-threading.md#week-level-parallelism-intra-year) (default: 1, requires Fast Mode UC)                             |
