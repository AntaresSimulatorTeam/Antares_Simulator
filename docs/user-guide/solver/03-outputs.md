...
| 9.1 | **Short-term storage** (static groups : PSP_open, PSP_closed, Pondage, Battery, Other1 to Other5) : <br>\<STS static group\>_injection <br> \<STS static group\>_withdrawal <br> \<STS static group\>_level| values-*.txt | yes |
