...
- The activation of output filters
  (see [thematic-trimming](solver/legacy-solver/04-parameters.md#thematic-trimming) and [geographic-trimming](solver/legacy-solver/04-parameters.md#geographic-trimming) parameters).
