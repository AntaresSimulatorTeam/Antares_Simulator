...
#define YUNI_OS_CLANG_VERSION \
    (__GNUC__ * 10000 + __GNUC_MINOR__ * 100 + __GNUC_PATCHLEVEL__) // compatible mode
#else
...
#ifdef YUNI_COMPILER_NAME /* in some cases, the compiler may already have been detected as Visual \
                             Studio */
...
/* 32/64 Bits modes */
  ...
  || defined(_M_IA64) || defined(_WIN64) || defined(__MINGW64__)
#define YUNI_OS_64
#else
#define YUNI_OS_32
#endif
...
**
** \see Rules and Limitations for TLS on Windows
