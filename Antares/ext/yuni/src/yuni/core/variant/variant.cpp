...
Variant::Variant(const Private::Variant::IDataHolder* rhs, bool ref) :
 pData(const_cast<Private::Variant::IDataHolder*>(rhs)), pShareContent(ref)
{
}

Variant::Variant(Private::Variant::IDataHolder* rhs, bool ref) : pData(rhs), pShareContent(ref)
{
}
