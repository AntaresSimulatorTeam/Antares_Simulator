...
inline Point3D<T> LinePlaneIntersection(const Point3D<T>& linePoint,
                                        const Vector3D<T>& lineDirection,
                                        const Point3D<T>& planePoint,
...
template<typename T>
inline bool SegmentIntersectsPlane(const Point3D<T>& startPoint,
                                   const Point3D<T>& endPoint,
                                   const Point3D<T>& planePoint,
                                   const Vector3D<T>& planeNormal)
{
    ...
    return Math::Zero(startDot) || Math::Zero(endDot) || (startDot > 0) != (endDot > 0);
}

// http://geomalgorithms.com/a06-_intersect-2.html
template<typename T>
inline bool SegmentIntersectsTriangle(const Point3D<T>& segmentStart,
                                      const Point3D<T>& segmentEnd,
                                      const Point3D<T>& p1,
                                      const Point3D<T>& p2,
                                      const Point3D<T>& p3)
{
...
template<typename T>
inline bool SegmentIntersectsQuad(const Point3D<T>& segmentStart,
                                  const Point3D<T>& segmentEnd,
                                  const Point3D<T>& p1,
                                  const Point3D<T>& p2,
                                  const Point3D<T>& p3,
...
template<typename T>
inline bool SegmentIntersectsSphere(const Point3D<T>& startPoint,
                                    const Point3D<T>& endPoint,
