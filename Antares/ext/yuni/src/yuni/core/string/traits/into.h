...
public:
    ...
    static bool Perform(const StringT&, T& out)
    {
        out = T();
        return true;
    }
    ...
    template<class StringT>
    static T Perform(const StringT&)
    {
        return T();
    }
};
...
public:
    ...
    template<class StringT>
    static bool Perform(const StringT& s, const char*& out)
    {
        out = s.data();
        return true;
    }
    ...
    template<class StringT>
    static const char* Perform(const StringT& s)
    {
        return s.data();
    }
};
...
public:
    ...
    template<class StringT>
    static bool Perform(const StringT& s, char& out)
    {
        out = (!s) ? '\0' : s[0];
        return true;
    }
    ...
    template<class StringT>
    static char Perform(const StringT& s)
    {
        return (!s) ? '\0' : s[0];
    }
};
...
public:
    ...
    template<class StringT>
    static bool Perform(const StringT& s, unsigned char& out)
    {
    ...
    template<class StringT>
    static unsigned char Perform(const StringT& s)
    {
...
public:
    ...
    template<class StringT>
    static bool Perform(const StringT& s, bool& out)
    {
        out = Perform(s);
        return true;
    }
    ...
    template<class StringT>
    static bool Perform(const StringT& s)
    {
        if (not s.empty())
        {
            ...
            if (count < 5)
            {
                if (count == 1)
                {
                    return ('1' == s[0] or 'Y' == s[0] or 'y' == s[0] or 'O' == s[0] || 'o' == s[0]
                            or 't' == s[0] or 'T' == s[0]);
                }
...
public:
    ...
    template<class StringT>
    static bool Perform(const StringT& s, float& out)
    {
        if (not s.empty())
        {
            char* pend;
    ...
    template<class StringT>
    static float Perform(const StringT& s)
    {
        if (not s.empty())
        {
            char* pend;
...
public:
    ...
    template<class StringT>
    static bool Perform(const StringT& s, double& out)
    {
        if (not s.empty())
        {
            char* pend;
    ...
    template<class StringT>
    static double Perform(const StringT& s)
    {
        if (not s.empty())
        {
            char* pend;
