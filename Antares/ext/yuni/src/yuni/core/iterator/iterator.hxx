...
inline IIterator<ModelT, ConstT>::IIterator() : AncestorType()
{
}
...
template<class ModelT, bool ConstT>
template<class U1>
inline IIterator<ModelT, ConstT>::IIterator(const U1& u1) : AncestorType(u1)
{
}

template<class ModelT, bool ConstT>
template<class U1, class U2>
inline IIterator<ModelT, ConstT>::IIterator(const U1& u1, const U2& u2) : AncestorType(u1, u2)
{
}
...
template<class ModelT, bool ConstT>
inline void IIterator<ModelT, ConstT>::forward(
  typename IIterator<ModelT, ConstT>::difference_type n)
{
...
template<class ModelT, bool ConstT>
inline void IIterator<ModelT, ConstT>::advance(
  typename IIterator<ModelT, ConstT>::difference_type n)
{
    if (n > 0)
    {
...
template<class ModelT, bool ConstT>
template<class M, bool C>
inline typename IIterator<ModelT, ConstT>::difference_type IIterator<ModelT, ConstT>::distance(
  const IIterator<M, C>& rhs) const
{
    return AncestorType::distance(static_cast<const typename IIterator<M, C>::AncestorType&>(rhs));
}

template<class ModelT, bool ConstT>
inline typename IIterator<ModelT, ConstT>::reference IIterator<ModelT, ConstT>::operator*()
{
    return AncestorType::operator*();
}

template<class ModelT, bool ConstT>
inline typename IIterator<ModelT, ConstT>::const_reference IIterator<ModelT, ConstT>::operator*()
  const
{
    return AncestorType::operator*();
}
...
template<class ModelT, bool ConstT>
inline typename IIterator<ModelT, ConstT>::pointer IIterator<ModelT, ConstT>::operator->()
{
    return AncestorType::operator->();
}

template<class ModelT, bool ConstT>
inline typename IIterator<ModelT, ConstT>::const_pointer IIterator<ModelT, ConstT>::operator->()
  const
{
    return AncestorType::operator->();
}
...
inline bool IIterator<ModelT, ConstT>::operator!=(const IIterator<M, C>& rhs) const
{
    return not AncestorType::equals(
      static_cast<const typename IIterator<M, C>::AncestorType&>(rhs));
}
...
template<class ModelT, bool ConstT>
inline IIterator<ModelT, ConstT>& IIterator<ModelT, ConstT>::operator=(
  const IIterator<ModelT, ConstT>& rhs)
{
