...
inline bool TreeN<T, TP, ChckP, ConvP>::remove(Ptr& node)
{
    ...
    return (Ptr::WeakPointer(node->parent()) == this) ? internalRemoveChild(*node) : false;
}

template<class T, template<class> class TP, template<class> class ChckP, class ConvP>
typename TreeN<T, TP, ChckP, ConvP>::Ptr TreeN<T, TP, ChckP, ConvP>::findFromIndexWL(
  const typename TreeN<T, TP, ChckP, ConvP>::SizeType index)
{
...
template<class T, template<class> class TP, template<class> class ChckP, class ConvP>
inline typename TreeN<T, TP, ChckP, ConvP>::Ptr TreeN<T, TP, ChckP, ConvP>::find(
  const typename TreeN<T, TP, ChckP, ConvP>::SizeType index)
{
    typename ThreadingPolicy::MutexLocker locker(*this);
...
template<class T, template<class> class TP, template<class> class ChckP, class ConvP>
inline typename TreeN<T, TP, ChckP, ConvP>::Ptr TreeN<T, TP, ChckP, ConvP>::find(
  const typename TreeN<T, TP, ChckP, ConvP>::SignedSizeType index)
{
    if (index >= 0)
    {
        typename ThreadingPolicy::MutexLocker locker(*this);
...
template<class T, template<class> class TP, template<class> class ChckP, class ConvP>
inline bool TreeN<T, TP, ChckP, ConvP>::remove(
  const typename TreeN<T, TP, ChckP, ConvP>::SizeType index)
{
    typename ThreadingPolicy::MutexLocker locker(*this);
...
template<class T, template<class> class TP, template<class> class ChckP, class ConvP>
void TreeN<T, TP, ChckP, ConvP>::internalDetachFromParentWithoutNotify()
{
    typename ThreadingPolicy::MutexLocker locker(*this);
...
template<class T, template<class> class TP, template<class> class ChckP, class ConvP>
inline void TreeN<T, TP, ChckP, ConvP>::append(typename TreeN<T, TP, ChckP, ConvP>::Ptr& node)
{
    typename ThreadingPolicy::MutexLocker locker(*this);
    pushBackWL(node);
}
...
template<class T, template<class> class TP, template<class> class ChckP, class ConvP>
inline void TreeN<T, TP, ChckP, ConvP>::append(T* node)
{
    Ptr tmp(node);
    typename ThreadingPolicy::MutexLocker locker(*this);
    pushBackWL(tmp);
...
template<class T, template<class> class TP, template<class> class ChckP, class ConvP>
inline void TreeN<T, TP, ChckP, ConvP>::push_back(T* node)
{
    Ptr tmp(node);
    typename ThreadingPolicy::MutexLocker locker(*this);
    pushBackWL(tmp);
...
template<class T, template<class> class TP, template<class> class ChckP, class ConvP>
inline void TreeN<T, TP, ChckP, ConvP>::push_front(T* node)
{
    Ptr tmp(node);
    typename ThreadingPolicy::MutexLocker locker(*this);
    pushFrontWL(tmp);
...
template<class T, template<class> class TP, template<class> class ChckP, class ConvP>
inline void TreeN<T, TP, ChckP, ConvP>::push_back(Ptr& node)
{
    typename ThreadingPolicy::MutexLocker locker(*this);
    pushBackWL(node);
}
...
template<class T, template<class> class TP, template<class> class ChckP, class ConvP>
void TreeN<T, TP, ChckP, ConvP>::pushBackWL(Ptr& node)
{
    if (!pChildrenCount)
    {
        pFirstChild = node;
...
template<class T, template<class> class TP, template<class> class ChckP, class ConvP>
inline void TreeN<T, TP, ChckP, ConvP>::push_front(Ptr& node)
{
    typename ThreadingPolicy::MutexLocker locker(*this);
    pushFrontWL(node);
}
...
template<class T, template<class> class TP, template<class> class ChckP, class ConvP>
void TreeN<T, TP, ChckP, ConvP>::pushFrontWL(Ptr& node)
{
    if (!pChildrenCount)
    {
        pFirstChild = node;
...
template<class T, template<class> class TP, template<class> class ChckP, class ConvP>
inline void TreeN<T, TP, ChckP, ConvP>::printBeginWL(std::ostream& out, uint) const
{
    out << "<node>";
}

template<class T, template<class> class TP, template<class> class ChckP, class ConvP>
inline void TreeN<T, TP, ChckP, ConvP>::printEndWL(std::ostream& out, uint) const
{
    out << "</node>";
}

template<class T, template<class> class TP, template<class> class ChckP, class ConvP>
std::ostream& TreeN<T, TP, ChckP, ConvP>::print(std::ostream& out, bool recursive, uint level)
{
    typename ThreadingPolicy::MutexLocker locker(*this);
...
template<class T, template<class> class TP, template<class> class ChckP, class ConvP>
typename TreeN<T, TP, ChckP, ConvP>::SizeType TreeN<T, TP, ChckP, ConvP>::depth() const
{
    typename ThreadingPolicy::MutexLocker locker(*this);
...
template<class T, template<class> class TP, template<class> class ChckP, class ConvP>
typename TreeN<T, TP, ChckP, ConvP>::SizeType TreeN<T, TP, ChckP, ConvP>::treeHeight()
{
    typename ThreadingPolicy::MutexLocker locker(*this);
    if (!pChildrenCount)
        return 0;
...
template<class T, template<class> class TP, template<class> class ChckP, class ConvP>
void TreeN<T, TP, ChckP, ConvP>::sendToBack()
{
    // Locking
    typename ThreadingPolicy::MutexLocker locker(*this);
...
template<class T, template<class> class TP, template<class> class ChckP, class ConvP>
inline void TreeN<T, TP, ChckP, ConvP>::invalidate()
{
    typename ThreadingPolicy::MutexLocker locker(*this);
    invalidateWL();
}
...
template<class T, template<class> class TP, template<class> class ChckP, class ConvP>
inline bool TreeN<T, TP, ChckP, ConvP>::isInvalidated()
{
    typename ThreadingPolicy::MutexLocker locker(*this);
