...
template<typename T,
         ...
         class ConsP>
inline SmartPtr<T, OwspP, ChckP, ConvP, StorP, ConsP>::SmartPtr(
  typename SmartPtr<T, OwspP, ChckP, ConvP, StorP, ConsP>::ExplicitStoredType ptr) :
 StoragePolicy(ptr)
{
...
template<typename T,
         ...
         class ConsP>
inline SmartPtr<T, OwspP, ChckP, ConvP, StorP, ConsP>::SmartPtr(
  typename SmartPtr<T, OwspP, ChckP, ConvP, StorP, ConsP>::ImplicitStoredType ptr) :
 StoragePolicy(ptr)
{
    // Check if the checking policy allows the given value
    CheckingPolicy::onInit(storagePointer(*this));
...
template<typename T,
         ...
         class ConsP>
inline SmartPtr<T, OwspP, ChckP, ConvP, StorP, ConsP>::SmartPtr(
  typename SmartPtr<T, OwspP, ChckP, ConvP, StorP, ConsP>::CopyType& rhs) :
...
template<typename T1,
         ...
         class ConsP1>
inline SmartPtr<T, OwspP, ChckP, ConvP, StorP, ConsP>::SmartPtr(
  const SmartPtr<T1, OwspP1, ChckP1, ConvP1, StorP1, ConsP1>& rhs) :
 StoragePolicy(rhs), OwnershipPolicy(rhs), CheckingPolicy(rhs), ConversionPolicy(rhs)
{
    // Cloning the stored data
    storageReference(*this) = OwnershipPolicy::clone(storageReference(rhs));
...
template<typename T1,
         ...
         class ConsP1>
inline SmartPtr<T, OwspP, ChckP, ConvP, StorP, ConsP>::SmartPtr(
  SmartPtr<T1, OwspP1, ChckP1, ConvP1, StorP1, ConsP1>& rhs) :
 StoragePolicy(rhs), OwnershipPolicy(rhs), CheckingPolicy(rhs), ConversionPolicy(rhs)
{
    // Cloning the stored data
    storageReference(*this) = OwnershipPolicy::clone(storageReference(rhs));
...
{
    // Cloning the stored data
    storageReference(*this) = OwnershipPolicy::clone(
      dynamic_cast<typename StoragePolicy::StoredType>(storageReference(rhs)));
}
...
template<typename T,
         ...
         class ConsP>
inline SmartPtr<T, OwspP, ChckP, ConvP, StorP, ConsP>::SmartPtr(
  Static::MoveConstructor<SmartPtr<T, OwspP, ChckP, ConvP, StorP, ConsP>> rhs) :
 StoragePolicy(rhs), OwnershipPolicy(rhs), CheckingPolicy(rhs), ConversionPolicy(rhs)
{
}
...
template<typename T,
         ...
         template<class>
         class ConsP>
inline void SmartPtr<T, OwspP, ChckP, ConvP, StorP, ConsP>::swap(
  SmartPtr<T, OwspP, ChckP, ConvP, StorP, ConsP>& rhs)
{
...
template<typename T,
         ...
         template<class>
         class ConsP>
inline bool SmartPtr<T, OwspP, ChckP, ConvP, StorP, ConsP>::operator!() const
{
...
template<typename T1,
         ...
         template<class>
         class ConsP1>
inline bool SmartPtr<T, OwspP, ChckP, ConvP, StorP, ConsP>::operator==(
  const SmartPtr<T1, OwspP1, ChckP1, ConvP1, StorP1, ConsP1>& rhs) const
{
...
template<typename T,
         ...
         template<class>
         class ConsP>
inline bool SmartPtr<T, OwspP, ChckP, ConvP, StorP, ConsP>::operator==(const T* rhs) const
{
...
template<typename T,
         ...
         template<class>
         class ConsP>
inline bool SmartPtr<T, OwspP, ChckP, ConvP, StorP, ConsP>::operator==(const NullPtr&) const
{
    return (storagePointer(*this) == NULL);
}
...
template<typename T,
         ...
         class ConsP>
template<class S1>
inline S1 SmartPtr<T, OwspP, ChckP, ConvP, StorP, ConsP>::DynamicCast(
  SmartPtr<T, OwspP, ChckP, ConvP, StorP, ConsP> rhs)
{
