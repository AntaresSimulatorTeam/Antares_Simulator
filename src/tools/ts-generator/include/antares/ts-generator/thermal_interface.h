...
{
    std::array<double, 8760> foDuration;
    std::array<double, 8760> poDuration;
    std::array<double, 8760> foRate;
    std::array<double, 8760> poRate;
    std::array<double, 8760> npoMin;
    std::array<double, 8760> npoMax;
