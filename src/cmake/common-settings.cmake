...
if (NOT WIN32)
    ...
    if (NOT CMAKE_SYSTEM_PROCESSOR MATCHES "arm64|aarch64")
        set(COMMON_GCC_FLAGS "${COMMON_GCC_FLAGS} -pipe -msse -msse2")
    endif()
    set(COMMON_GCC_FLAGS "${COMMON_GCC_FLAGS} -Wunused-but-set-variable -Wunused-but-set-parameter")
...
macro(executable_strip TARGET)
    if ("${CMAKE_BUILD_TYPE}" STREQUAL "Release")
        if (NOT MSVC)
            ...
            elseif (APPLE)
                add_custom_command(TARGET ${TARGET} POST_BUILD COMMAND ${CMAKE_STRIP} -x $<TARGET_FILE:${TARGET}>)
            else ()
