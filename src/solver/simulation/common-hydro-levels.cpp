...
void
computingHydroLevels(const Data::AreaList& areas,
...
void
interpolateWaterValue(const Data::AreaList& areas,
                      PROBLEME_HEBDO& problem,
...
void
updatingWeeklyFinalHydroLevel(const Data::AreaList& areas, PROBLEME_HEBDO& problem)
{
    areas.each(
            [&](const Data::Area& area)
            {
...
void
updatingAnnualFinalHydroLevel(const Data::AreaList& areas, PROBLEME_HEBDO& problem)
{
    ...
    areas.each(
            [&](const Data::Area& area)
            {
                ...
                problem.previousYearFinalLevels
                        [index] = problem.previousSimulationFinalLevel[index] / reservoirCapacity;
            });
}
