...
void
BindingConstraintHour::add(int pdt, int cntCouplante)
{
    data.CorrespondanceCntNativesCntOptim[pdt].NumeroDeContrainteDesContraintesCouplantes
            [cntCouplante] = builder.data.nombreDeContraintes;
