...
void
ConstraintBuilder::AddVariable(int varIndex, double coeff)
{
    if (varIndex >= 0)
    {
...
ConstraintBuilder&
ConstraintBuilder::DispatchableProduction(unsigned int index, double coeff, int offset, int delta)
{
...
ConstraintBuilder&
ConstraintBuilder::NTCDirect(unsigned int index, double coeff, int offset, int delta)
{
...
ConstraintBuilder&
ConstraintBuilder::ShortTermStorageLevel(unsigned int index, double coeff, int offset, int delta)
{
...
void
ConstraintBuilder::OPT_ChargerLaContrainteDansLaMatriceDesContraintes()
{
    data.IndicesDebutDeLigne
            [data.nombreDeContraintes] = data.nombreDeTermesDansLaMatriceDeContrainte;
    for (int i = 0; i < nombreDeTermes_; i++)
    {
        data.CoefficientsDeLaMatriceDesContraintes
                [data.nombreDeTermesDansLaMatriceDeContrainte] = data.Pi[i];
...
void
ConstraintBuilder::OPT_AugmenterLaTailleDeLaMatriceDesContraintes()
{
