...
#include "antares/solver/optimisation/ComponentToThermalCapacityConnectionFiller.h"
...
void ComponentToThermalCapacityConnectionFiller::addVariables(const FillContext&)
{
    // nothing to do
}
...
IMipConstraint* ComponentToThermalCapacityConnectionFiller::getBalanceConstraint(
...
void ComponentToThermalCapacityConnectionFiller::addExpressionToConstraint(
  Optimisation::LinearProblemApi::ILinearProblem& pb,
  ...
  const std::string& areaId) const
{
    ...
    //      ++localIndex)
    // {
    //     IMipConstraint* areaBalanceConstraint = getBalanceConstraint(pb, lowerAreaId,
    //     localIndex);
    //
...
void ComponentToThermalCapacityConnectionFiller::addComponentPortContributionToArea(
  ILinearProblem& pb,
  const FillContext& ctx,
...
void ComponentToThermalCapacityConnectionFiller::addObjectives(const FillContext&)
{
    // nothing to do
}

void ComponentToThermalCapacityConnectionFiller::updateUpperBound(unsigned int index, double newUp)
{
}
} // namespace Antares::Optimization
