...
int
VariableManager::GetShiftedTimeStep(int offset, int delta, unsigned int hourInWeek) const
{
...
int&
VariableManager::DispatchableProduction(unsigned int index,
...
int&
VariableManager::NumberOfDispatchableUnits(unsigned int index,
                                           unsigned int hourInWeek,
                                           int offset,
                                           int delta)
{
...
int&
VariableManager::NumberStoppingDispatchableUnits(unsigned int index,
                                                 unsigned int hourInWeek,
                                                 int offset,
                                                 int delta)
{
...
int&
VariableManager::NumberStartingDispatchableUnits(unsigned int index,
                                                 unsigned int hourInWeek,
                                                 int offset,
                                                 int delta)
{
...
int&
VariableManager::NumberBreakingDownDispatchableUnits(unsigned int index,
                                                     unsigned int hourInWeek,
                                                     int offset,
                                                     int delta)
{
...
int&
VariableManager::NTCDirect(unsigned int index, unsigned int hourInWeek, int offset, int delta)
{
    auto pdt = GetShiftedTimeStep(offset, delta, hourInWeek);
...
int&
VariableManager::IntercoDirectCost(unsigned int index,
                                   unsigned int hourInWeek,
                                   int offset,
                                   int delta)
{
...
int&
VariableManager::IntercoIndirectCost(unsigned int index,
                                     unsigned int hourInWeek,
                                     int offset,
                                     int delta)
{
...
int&
VariableManager::ShortTermStorageInjection(unsigned int index,
                                           unsigned int hourInWeek,
                                           int offset,
                                           int delta)
{
...
int&
VariableManager::ShortTermStorageWithdrawal(unsigned int index,
                                            unsigned int hourInWeek,
                                            int offset,
                                            int delta)
{
...
int&
VariableManager::ShortTermStorageLevel(unsigned int index,
                                       unsigned int hourInWeek,
                                       int offset,
                                       int delta)
{
...
int&
VariableManager::HydProd(unsigned int index, unsigned int hourInWeek, int offset, int delta)
{
    auto pdt = GetShiftedTimeStep(offset, delta, hourInWeek);
...
int&
VariableManager::HydProdDown(unsigned int index, unsigned int hourInWeek, int offset, int delta)
{
    auto pdt = GetShiftedTimeStep(offset, delta, hourInWeek);
...
int&
VariableManager::HydProdUp(unsigned int index, unsigned int hourInWeek, int offset, int delta)
{
    auto pdt = GetShiftedTimeStep(offset, delta, hourInWeek);
...
int&
VariableManager::Pumping(unsigned int index, unsigned int hourInWeek, int offset, int delta)
{
    auto pdt = GetShiftedTimeStep(offset, delta, hourInWeek);
...
int&
VariableManager::HydroLevel(unsigned int index, unsigned int hourInWeek, int offset, int delta)
{
    auto pdt = GetShiftedTimeStep(offset, delta, hourInWeek);
...
int&
VariableManager::Overflow(unsigned int index, unsigned int hourInWeek, int offset, int delta)
{
    auto pdt = GetShiftedTimeStep(offset, delta, hourInWeek);
...
int&
VariableManager::FinalStorage(unsigned int index)
{
    return NumeroDeVariableStockFinal_[index];
}

int&
VariableManager::LayerStorage(unsigned area, unsigned layer)
{
    return NumeroDeVariableDeTrancheDeStock_[area][layer];
}

int&
VariableManager::PositiveUnsuppliedEnergy(unsigned int index,
                                          unsigned int hourInWeek,
                                          int offset,
                                          int delta)
{
...
int&
VariableManager::NegativeUnsuppliedEnergy(unsigned int index,
                                          unsigned int hourInWeek,
                                          int offset,
                                          int delta)
{
