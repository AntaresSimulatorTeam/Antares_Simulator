...
std::string
BuildName(const std::string& name, const std::string& location, const std::string& timeIdentifier)
{
...
void
Namer::SetLinkElementName(unsigned int element, const std::string& elementType)
{
...
void
Namer::SetAreaElementNameHour(unsigned int element, const std::string& elementType)
{
    SetAreaElementName(element, elementType, HOUR);
}

void
Namer::SetAreaElementNameWeek(unsigned int element, const std::string& elementType)
{
    SetAreaElementName(element, elementType, WEEK);
}

void
Namer::SetAreaElementName(unsigned int element,
...
void
VariableNamer::SetAreaVariableName(unsigned int variable,
...
void
Namer::SetThermalClusterElementName(unsigned int variable,
                                    const std::string& elementType,
...
void
VariableNamer::DispatchableProduction(unsigned int variable, const std::string& clusterName)
{
    SetThermalClusterElementName(variable, "DispatchableProduction", clusterName);
}

void
VariableNamer::NODU(unsigned int variable, const std::string& clusterName)
{
    SetThermalClusterElementName(variable, "NODU", clusterName);
}

void
VariableNamer::NumberStoppingDispatchableUnits(unsigned int variable,
                                               const std::string& clusterName)
{
...
void
VariableNamer::NumberStartingDispatchableUnits(unsigned int variable,
                                               const std::string& clusterName)
{
...
void
VariableNamer::NumberBreakingDownDispatchableUnits(unsigned int variable,
                                                   const std::string& clusterName)
{
...
void
VariableNamer::NTCDirect(unsigned int variable,
...
void
VariableNamer::IntercoDirectCost(unsigned int variable,
                                 const std::string& origin,
                                 const std::string& destination)
{
    origin_ = origin;
...
void
VariableNamer::IntercoIndirectCost(unsigned int variable,
                                   const std::string& origin,
                                   const std::string& destination)
{
    origin_ = origin;
...
void
VariableNamer::SetShortTermStorageVariableName(unsigned int variable,
                                               const std::string& variableType,
...
void
VariableNamer::ShortTermStorageInjection(unsigned int variable,
                                         const std::string& shortTermStorageName)
{
...
void
VariableNamer::ShortTermStorageWithdrawal(unsigned int variable,
                                          const std::string& shortTermStorageName)
{
...
void
VariableNamer::ShortTermStorageLevel(unsigned int variable, const std::string& shortTermStorageName)
{
    SetShortTermStorageVariableName(variable, "Level", shortTermStorageName);
}

void
VariableNamer::HydProd(unsigned int variable)
{
    SetAreaElementNameHour(variable, "HydProd");
}

void
VariableNamer::HydProdDown(unsigned int variable)
{
    SetAreaElementNameHour(variable, "HydProdDown");
}

void
VariableNamer::HydProdUp(unsigned int variable)
{
    SetAreaElementNameHour(variable, "HydProdUp");
}

void
VariableNamer::Pumping(unsigned int variable)
{
    SetAreaElementNameHour(variable, "Pumping");
}

void
VariableNamer::HydroLevel(unsigned int variable)
{
    SetAreaElementNameHour(variable, "HydroLevel");
}

void
VariableNamer::Overflow(unsigned int variable)
{
    SetAreaElementNameHour(variable, "Overflow");
}

void
VariableNamer::LayerStorage(unsigned int variable, int layerIndex)
{
    SetAreaVariableName(variable, "LayerStorage", layerIndex);
}

void
VariableNamer::FinalStorage(unsigned int variable)
{
    SetAreaElementNameHour(variable, "FinalStorage");
}

void
VariableNamer::PositiveUnsuppliedEnergy(unsigned int variable)
{
    SetAreaElementNameHour(variable, "PositiveUnsuppliedEnergy");
}

void
VariableNamer::NegativeUnsuppliedEnergy(unsigned int variable)
{
    SetAreaElementNameHour(variable, "NegativeUnsuppliedEnergy");
}

void
VariableNamer::AreaBalance(unsigned int variable)
{
    SetAreaElementNameHour(variable, "AreaBalance");
}

void
ConstraintNamer::FlowDissociation(unsigned int constraint,
                                  const std::string& origin,
                                  const std::string& destination)
{
    origin_ = origin;
...
void
ConstraintNamer::CsrFlowDissociation(unsigned int constraint,
                                     const std::string& origin,
                                     const std::string& destination)
{
    origin_ = origin;
...
void
ConstraintNamer::CsrAreaBalance(unsigned int constraint)
{
    SetAreaElementNameHour(constraint, "CsrAreaBalance");
}

void
ConstraintNamer::AreaBalance(unsigned int constraint)
{
    SetAreaElementNameHour(constraint, "AreaBalance");
}

void
ConstraintNamer::FictiveLoads(unsigned int constraint)
{
    SetAreaElementNameHour(constraint, "FictiveLoads");
}

void
ConstraintNamer::HydroPower(unsigned int constraint)
{
    SetAreaElementNameWeek(constraint, "HydroPower");
}

void
ConstraintNamer::HydroPowerSmoothingUsingVariationSum(unsigned int constraint)
{
    SetAreaElementNameHour(constraint, "HydroPowerSmoothingUsingVariationSum");
}

void
ConstraintNamer::HydroPowerSmoothingUsingVariationMaxDown(unsigned int constraint)
{
    SetAreaElementNameHour(constraint, "HydroPowerSmoothingUsingVariationMaxDown");
}

void
ConstraintNamer::HydroPowerSmoothingUsingVariationMaxUp(unsigned int constraint)
{
    SetAreaElementNameHour(constraint, "HydroPowerSmoothingUsingVariationMaxUp");
}

void
ConstraintNamer::MinHydroPower(unsigned int constraint)
{
    SetAreaElementNameWeek(constraint, "MinHydroPower");
}

void
ConstraintNamer::MaxHydroPower(unsigned int constraint)
{
    SetAreaElementNameWeek(constraint, "MaxHydroPower");
}

void
ConstraintNamer::MaxPumping(unsigned int constraint)
{
    SetAreaElementNameWeek(constraint, "MaxPumping");
}

void
ConstraintNamer::AreaHydroLevel(unsigned int constraint)
{
    SetAreaElementNameHour(constraint, "AreaHydroLevel");
}

void
ConstraintNamer::FinalStockEquivalent(unsigned int constraint)
{
    SetAreaElementNameHour(constraint, "FinalStockEquivalent");
}

void
ConstraintNamer::FinalStockExpression(unsigned int constraint)
{
    SetAreaElementNameHour(constraint, "FinalStockExpression");
}

void
ConstraintNamer::nameWithTimeGranularity(unsigned int constraint,
...
void
ConstraintNamer::NbUnitsOutageLessThanNbUnitsStop(unsigned int constraint,
                                                  const std::string& clusterName)
{
...
void
ConstraintNamer::NbDispUnitsMinBoundSinceMinUpTime(unsigned int constraint,
                                                   const std::string& clusterName)
{
...
void
ConstraintNamer::MinDownTime(unsigned int constraint, const std::string& clusterName)
{
    SetThermalClusterElementName(constraint, "MinDownTime", clusterName);
}

void
ConstraintNamer::PMaxDispatchableGeneration(unsigned int constraint, const std::string& clusterName)
{
    SetThermalClusterElementName(constraint, "PMaxDispatchableGeneration", clusterName);
}

void
ConstraintNamer::PMinDispatchableGeneration(unsigned int constraint, const std::string& clusterName)
{
    SetThermalClusterElementName(constraint, "PMinDispatchableGeneration", clusterName);
}

void
ConstraintNamer::ConsistenceNODU(unsigned int constraint, const std::string& clusterName)
{
    SetThermalClusterElementName(constraint, "ConsistenceNODU", clusterName);
}

void
ConstraintNamer::ShortTermStorageLevel(unsigned int constraint, const std::string& name)
{
...
void
ConstraintNamer::BindingConstraintHour(unsigned int constraint, const std::string& name)
{
    nameWithTimeGranularity(constraint, name, HOUR);
}

void
ConstraintNamer::CsrBindingConstraintHour(unsigned int constraint, const std::string& name)
{
    nameWithTimeGranularity(constraint, name, HOUR);
}

void
ConstraintNamer::BindingConstraintDay(unsigned int constraint, const std::string& name)
{
    nameWithTimeGranularity(constraint, name, DAY);
}

void
ConstraintNamer::BindingConstraintWeek(unsigned int constraint, const std::string& name)
{
