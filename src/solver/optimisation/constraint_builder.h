...
private:
    int getVariableIndex(Variable variable, int timeShift, bool wrap) const
    {
      ...
      case Variable::NODU:
        return nativeOptimVar.NumeroDeVariableDuNombreDeGroupesEnMarcheDuPalierThermique.at(thermalClusterIndex_);
      case Variable::NumberStoppingDispatchableUnits:
        return nativeOptimVar.NumeroDeVariableDuNombreDeGroupesQuiSArretentDuPalierThermique.at(thermalClusterIndex_);
      case Variable::NumberStartingDispatchableUnits:
        return nativeOptimVar.NumeroDeVariableDuNombreDeGroupesQuiDemarrentDuPalierThermique.at(thermalClusterIndex_);
      case Variable::NumberBreakingDownDispatchableUnits:
        return nativeOptimVar.NumeroDeVariableDuNombreDeGroupesQuiTombentEnPanneDuPalierThermique.at(thermalClusterIndex_);
      ...
      case Variable::IntercoDirectCost:
        return nativeOptimVar.NumeroDeVariableCoutOrigineVersExtremiteDeLInterconnexion.at(linkIndex_);
      case Variable::IntercoIndirectCost:
        return nativeOptimVar.NumeroDeVariableCoutExtremiteVersOrigineDeLInterconnexion.at(linkIndex_);
      case Variable::ShortTermStorageInjection:
        return nativeOptimVar.SIM_ShortTermStorage.InjectionVariable.at(shortTermStorageIndex_);
      case Variable::ShortTermStorageWithdrawal:
        return nativeOptimVar.SIM_ShortTermStorage.WithdrawalVariable.at(shortTermStorageIndex_);
      ...
      case Variable::LayerStorage:
        return problemeHebdo.NumeroDeVariableDeTrancheDeStock.at(areaIndex_).at(layerIndex_);
