...
void OPT_LiberationProblemesSimplexe(PROBLEME_HEBDO* const);
bool OPT_OptimisationLineaire(PROBLEME_HEBDO*, uint);
void OPT_SauvegarderLesPmaxThermiques(PROBLEME_HEBDO*);
void OPT_RestaurerLesDonnees(PROBLEME_HEBDO* const, const int);
/*------------------------------*/
...
double OPT_SommeDesPminThermiques(PROBLEME_HEBDO* const, int, int);
