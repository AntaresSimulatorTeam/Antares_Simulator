...
#include "opt-period-as-string-base.h"
...
*/
bool OPT_AppelDuSimplexe(PROBLEME_HEBDO*, int, const int, std::shared_ptr<optPeriodAsString>);
...
void OPT_EcrireResultatFonctionObjectiveAuFormatTXT(double, std::shared_ptr<optPeriodAsString>, int);
