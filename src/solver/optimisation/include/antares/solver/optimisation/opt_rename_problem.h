...
public:
    ...
    void ProductionIncreaseAboveMin(unsigned varIndex, const std::string& clusterName);
    void ProductionDecreaseAboveMin(unsigned varIndex, const std::string& clusterName);
