...
void OPT_OptimisationHebdomadaire(PROBLEME_HEBDO* pProblemeHebdo, AdqPatchParams& adqPatchParams, uint numSpace)
{
    if (pProblemeHebdo->TypeDOptimisation == OPTIMISATION_LINEAIRE)
    {
        if (!OPT_PilotageOptimisationLineaire(pProblemeHebdo, adqPatchParams, numSpace))
        {
