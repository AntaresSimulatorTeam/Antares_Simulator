...
# define AJOUT_DE_COUTS_HYDRAULIQUES OUI_ANTARES   /* OUI_ANTARES ou NON_ANTARES */

# define COUT_TRANSPORT    OUI_ANTARES
...
# define SUBSTITUTION_DE_LA_VARIABLE_MPLUS NON_ANTARES /* Attention, dans le cas de OUI_ANTARES, la partie pour recuperer
