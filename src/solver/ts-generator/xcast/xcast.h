...
private:
    ...
    **
    ** \code
    ** code loi		a				b			g				d       autres
    *contraintes Loi marginale
    ** 1		quelconque     quelconque  g> INFININ/2   d<INFINIP/2			g<=d
    *Uniforme sur l'intervalle	(g,d)
    ** 2			a>0				b>0    g> INFININ/2   d<INFINIP/2		    g<=d
    *Bêta (a,b)sur l'intervalle (g,d)
    ...
    ** 5			a>=1			b>0	   g> INFININ/2   d non défini					     Gamma
