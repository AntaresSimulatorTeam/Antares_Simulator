...
struct ProductionByDispatchablePlantTraits
{
    ...
    static void initializeData(std::vector<std::vector<double>>& pMinBySpace,
                                        Data::Study*,
    ...
    static void yearBegin(std::vector<std::vector<double>>& pMinBySpace,
                          unsigned int,
    ...
    static void setHourlyValuesForCurrentYear(std::vector<IntermediateValues>& clusterValues,
                                              std::vector<std::vector<double>>& pMinBySpace,
                                              State& state,
                                              unsigned int numSpace)
    {
