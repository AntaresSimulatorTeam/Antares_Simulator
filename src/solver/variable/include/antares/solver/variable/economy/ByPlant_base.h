...
struct VCardByPlantBase
{
    ...
    typedef VCardByPlantBase VCardForSpatialAggregate;
...
}; // class VCardByPlantBase

template<class Traits, class NextT = Container::EndOfList>
class ByPlantBase
    : public Variable::IVariable<ByPlantBase<Traits, NextT>, NextT, VCardByPlantBase<Traits>>
{
public:
    //! Type of the next static variable
    typedef NextT NextType;
    //! VCard
    typedef VCardByPlantBase<Traits> VCardType;
    //! Ancestor
    typedef Variable::IVariable<ByPlantBase<Traits, NextT>, NextT, VCardType> AncestorType;
