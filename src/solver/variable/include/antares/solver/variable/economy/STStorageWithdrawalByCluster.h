...
{
struct VCardSTstorageWithdrawalByCluster
{
    //! Caption
    ...
    typedef VCardSTstorageWithdrawalByCluster VCardForSpatialAggregate;
...
class STstorageWithdrawalByCluster: public Variable::IVariable<STstorageWithdrawalByCluster<NextT>,
                                                               NextT,
                                                               VCardSTstorageWithdrawalByCluster>
{
public:
    //! Type of the next static variable
    typedef NextT NextType;
    //! VCard
    typedef VCardSTstorageWithdrawalByCluster VCardType;
    //! Ancestor
    typedef Variable::IVariable<STstorageWithdrawalByCluster<NextT>, NextT, VCardType> AncestorType;
...
public:
    ...
    {
        uint64_t r = (sizeof(IntermediateValues) * nbClusters_ +
...
}; // class STstorageWithdrawalByCluster
