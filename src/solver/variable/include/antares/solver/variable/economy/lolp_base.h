...
/*!
** \brief Base class for LOLP and LOLP_CSR variables
*/
template<class Traits, class NextT = Container::EndOfList>
class LOLP_Base: public Variable::IVariable<LOLP_Base<Traits, NextT>, NextT, VCardLOLP_Base<Traits>>
{
public:
    //! Type of the next static variable
    typedef NextT NextType;
    //! VCard
    typedef VCardLOLP_Base<Traits> VCardType;
    //! Ancestor
    typedef Variable::IVariable<LOLP_Base<Traits, NextT>, NextT, VCardType> AncestorType;
