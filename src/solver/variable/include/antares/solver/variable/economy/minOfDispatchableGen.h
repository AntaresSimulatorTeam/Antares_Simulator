...
{
struct VCardMinOfDispatchableGen
{
    //! Caption
    static std::string Caption()
    {
        return "Min. Dispatch. Gen.";
    }
    ...
    {
        return "Min of dispatchable generation throughout all MC years";
    }
    ...
    typedef VCardMinOfDispatchableGen VCardForSpatialAggregate;
...
class MinOfDispatchableGen
    : public Variable::IVariable<MinOfDispatchableGen<NextT>, NextT, VCardMinOfDispatchableGen>
{
public:
    //! Type of the next static variable
    typedef NextT NextType;
    //! VCard
    typedef VCardMinOfDispatchableGen VCardType;
    //! Ancestor
    typedef Variable::IVariable<MinOfDispatchableGen<NextT>, NextT, VCardType> AncestorType;
    ...
    void initializeFromArea(Data::Study* study, Data::Area* area)
    {
        ...
        {
            names.insert("MinGen-" + cluster->getGroup());
        }
    ...
    void hourForEachArea(State& state, unsigned int numSpace)
    {
        ...
        {
            unsigned int groupNumber = groupToNumbers_["MinGen-" + cluster->getGroup()];
