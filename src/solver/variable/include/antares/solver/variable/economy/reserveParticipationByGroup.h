...
*/
#ifndef __SOLVER_VARIABLE_ECONOMY_ReserveParticipationByGroup_H__
#define __SOLVER_VARIABLE_ECONOMY_ReserveParticipationByGroup_H__

#include "../variable.h"
#include "./vCardReserveParticipationByGroup.h"
...
class ReserveParticipationByGroup : public Variable::IVariable<ReserveParticipationByGroup<NextT>,
                                                               NextT,
                                                               VCardReserveParticipationByGroup>
{
public:
    //! Type of the next static variable
    typedef NextT NextType;
    //! VCard
    typedef VCardReserveParticipationByGroup VCardType;
    //! Ancestor
    typedef Variable::IVariable<ReserveParticipationByGroup<NextT>, NextT, VCardType> AncestorType;
...
public:
    ReserveParticipationByGroup() : pValuesForTheCurrentYear(NULL), pSize(0)
    {
    }

    ~ReserveParticipationByGroup()
    {
        ...
        for (auto  [reserveName, _] : area->allCapacityReservations.areaCapacityReservationsUp)
        {
            for (int indexGroup = 0; indexGroup < Antares::Data::groupMax; indexGroup++)
            {
                pValuesForTheCurrentYear[numSpace][column].hour[state.hourInTheYear]
                  += state.thermalReserveParticipationPerGroupForYear
                       [state.hourInTheYear][static_cast<Data::ThermalDispatchableGroup>(indexGroup)]
                       [reserveName];
                column++;
            }
        }
...
}; // class ReserveParticipationByGroup
...
#endif // __SOLVER_VARIABLE_ECONOMY_ReserveParticipationByGroup_H__