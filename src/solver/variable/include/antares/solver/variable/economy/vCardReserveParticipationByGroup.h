...
*/
#ifndef __SOLVER_VARIABLE_ECONOMY_VCardReserveParticipationByGroup_H__
#define __SOLVER_VARIABLE_ECONOMY_VCardReserveParticipationByGroup_H__
...
namespace Economy
{
struct VCardReserveParticipationByGroup
{
    //! Caption
    ...
    typedef VCardReserveParticipationByGroup VCardForSpatialAggregate;
