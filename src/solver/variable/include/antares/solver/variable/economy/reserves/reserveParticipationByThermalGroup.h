...
class ReserveParticipationByThermalGroup
    : public IVariable<ReserveParticipationByThermalGroup, VCardReserveParticipationByThermalGroup>
{
public:
    using VCardType = VCardReserveParticipationByThermalGroup;
    using AncestorType = IVariable<ReserveParticipationByThermalGroup, VCardType>;
