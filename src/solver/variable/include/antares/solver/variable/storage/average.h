...
private:
    ...
    void InternalExportValues(SurveyResults& report, const std::vector<HighPrecision>& array) const
    {
        ...
        case Category::hourly:
        {
            ...
            {
                report.values[report.data.columnIndex][h] = array[h].getSum();
            }
            break;
        }
        case Category::daily:
        {
            ...
            {
                report.values[report.data.columnIndex][d] = array[d].getSum();
            }
            break;
        }
        ...
        case Category::weekly:
        {
            ...
            {
                report.values[report.data.columnIndex][w] = array[w].getSum();
            }
            break;
        }
        ...
        case Category::monthly:
        {
            ...
            {
                report.values[report.data.columnIndex][m] = array[m].getSum();
            }
            break;
        }
        case Category::annual:
