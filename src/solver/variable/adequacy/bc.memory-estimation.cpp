...
// #define NEXTTYPE Adequacy::VariablesPerBindingConstraints
...
{
template<>
uint64 BindingConstraints<Adequacy::VariablesPerBindingConstraints>::memoryUsage() const
{
...
template<>
void BindingConstraints<Adequacy::VariablesPerBindingConstraints>::EstimateMemoryUsage(Data::StudyMemoryUsage& u)
{
