...
namespace Adequacy
{
	...
	*/
	typedef // Prices
			...
			< Variable::Economy::ProductionByDispatchablePlant    // Energy generated by thermal dispatchable clusters
	...
	*/
	typedef // Prices
			Common::SpatialAggregate<Variable::Adequacy::OverallCost,
			Common::SpatialAggregate<Variable::Economy::OperatingCost,
			Common::SpatialAggregate<Variable::Economy::Price,
			// CO2
			Common::SpatialAggregate<Variable::Economy::CO2,
			// Production by thermal cluster
			Common::SpatialAggregate<Variable::Economy::Balance,
			// Misc Gen.
			Common::SpatialAggregate<Variable::Economy::RowBalance,
			Common::SpatialAggregate<Variable::Economy::PSP,
			Common::SpatialAggregate<Variable::Economy::MiscGenMinusRowPSP,
			// Time series
			Common::SpatialAggregate<Variable::Economy::TimeSeriesValuesLoad,
			Common::SpatialAggregate<Variable::Economy::TimeSeriesValuesHydro,
			Common::SpatialAggregate<Variable::Economy::TimeSeriesValuesWind,
			Common::SpatialAggregate<Variable::Economy::TimeSeriesValuesSolar,
			// Other
			...
			// LOLD
			Common::SpatialAggregate<Variable::Economy::LOLD,
			Common::SpatialAggregate<Variable::Economy::LOLP,
