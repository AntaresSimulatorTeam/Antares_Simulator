...
protected:
    void initializeFromStudy(Antares::Data::Study& study)
    {
        ...
        pNbYearsCapacity
          = pNbYears + study.runtime->rangeLimits.year[Antares::Data::rangeBegin] + 1;
...
private:
    ...
    void InternalExportValuesMC(int precision,
                                ...
                                const double* array) const
    {
        ...
        (void)::memcpy(
          report.data.matrix[report.data.columnIndex], array, pNbYears * sizeof(double));
