...
*/
#ifndef __SOLVER_VARIABLE_ADEQUACY_MinMarg_CN_H__
# define __SOLVER_VARIABLE_ADEQUACY_MinMarg_CN_H__
...
namespace AdequacyDraft
{
	...
	struct VCardMinMarg_CN
	{
		//! Caption
		static const char* Caption() {return "MARG CN";}
		//! Unit
		static const char* Unit() {return "MW";}

		//! The short description of the variable
		static const char* Description() {return "Operation margin observed throughout all MC years";}
	...
	/*!
	** \brief Marginal MinMarg_CN
	*/
	template<class NextT = Container::EndOfList>
	class MinMarg_CN : public Variable::IVariable<MinMarg_CN<NextT>, NextT, VCardMinMarg_CN>
	{
	public:
		//! Type of the next static variable
		typedef NextT NextType;
		//! VCard
		typedef VCardMinMarg_CN VCardType;
		//! Ancestor
		typedef Variable::IVariable<MinMarg_CN<NextT>, NextT, VCardType> AncestorType;
	...
	public:
		...
		{
			pValuesForTheCurrentYear[state.hourInTheYear] = state.hourlyAdequacyResults->MargeAvecReseau;
			// Next variable
...
#endif // __SOLVER_VARIABLE_ADEQUACY_MinMarg_CN_H__
