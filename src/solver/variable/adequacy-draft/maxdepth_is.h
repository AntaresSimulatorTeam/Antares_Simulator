...
namespace AdequacyDraft
{
	...
	{
		//! Caption
		static const char* Caption() {return "MAX DEPTH IS";}
		//! Unit
		static const char* Unit() {return "MW";}

		//! The short description of the variable
		static const char* Description() {return "Maximum shortfall expected throughout all MC years without the network";}
