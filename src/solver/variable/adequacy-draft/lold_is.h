...
*/
#ifndef __SOLVER_VARIABLE_ADEQUACY_LOLD_IS_H__
# define __SOLVER_VARIABLE_ADEQUACY_LOLD_IS_H__
...
namespace AdequacyDraft
{
	...
	{
		//! Caption
		static const char* Caption() {return "LOLD IS";}
		//! Unit
		static const char* Unit() {return "hours";}

		//! The short description of the variable
		static const char* Description() {return "Expectation of the Loss of Load Duration, throughout all MC years";}
		...
		enum
		{
			...
			categoryFileLevel = ResultsType::categoryFile & (Category::id | Category::is | Category::mc),
			//! Precision (views)
	...
	/*!
	** \brief Marginal LOLD_IS
	*/
	template<class NextT = Container::EndOfList>
	class LOLD_IS : public Variable::IVariable<LOLD_IS<NextT>, NextT, VCardLOLD_IS>
	{
	public:
		//! Type of the next static variable
		typedef NextT NextType;
		//! VCard
		typedef VCardLOLD_IS VCardType;
		//! Ancestor
		typedef Variable::IVariable<LOLD_IS<NextT>, NextT, VCardType> AncestorType;
	...
	public:
		...
		{
			if (state.hourlyAdequacyResults->DefaillanceHorsReseau > 0.)
			{
				pValuesForTheCurrentYear.hour[state.hourInTheYear] += 1.;
				state.loleSystemIS_HasFailure = true;
			}
			// Next variable
...
#endif // __SOLVER_VARIABLE_ADEQUACY_LOLD_IS_H__
