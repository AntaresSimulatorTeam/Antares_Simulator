...
*/
#ifndef __SOLVER_VARIABLE_ADEQUACY_LOLD_CN_System_H__
# define __SOLVER_VARIABLE_ADEQUACY_LOLD_CN_System_H__
...
namespace AdequacyDraft
{
	...
	struct VCardLOLD_CN_System
	{
		//! Caption
		static const char* Caption() {return "LOLD CN Sys.";}
		//! Unit
	...
	/*!
	** \brief Marginal LOLD_CN_System
	*/
	template<class NextT = Container::EndOfList>
	class LOLD_CN_System : public Variable::IVariable<LOLD_CN_System<NextT>, NextT, VCardLOLD_CN_System>
	{
	public:
		//! Type of the next static variable
		typedef NextT NextType;
		//! VCard
		typedef VCardLOLD_CN_System VCardType;
		//! Ancestor
		typedef Variable::IVariable<LOLD_CN_System<NextT>, NextT, VCardType> AncestorType;
...
#endif // __SOLVER_VARIABLE_ADEQUACY_LOLD_CN_System_H__
