...
*/
#ifndef __SOLVER_VARIABLE_ADEQUACY_ENS_CN_System_H__
# define __SOLVER_VARIABLE_ADEQUACY_ENS_CN_System_H__
...
namespace AdequacyDraft
{
	...
	struct VCardENS_CN_System
	{
		//! Caption
		static const char* Caption() {return "ENS CN";}
		//! Unit
	...
	/*!
	** \brief Marginal ENS_CN_System
	*/
	template<class NextT = Container::EndOfList>
	class ENS_CN_System : public Variable::IVariable<ENS_CN_System<NextT>, NextT, VCardENS_CN_System>
	{
	public:
		//! Type of the next static variable
		typedef NextT NextType;
		//! VCard
		typedef VCardENS_CN_System VCardType;
		//! Ancestor
		typedef Variable::IVariable<ENS_CN_System<NextT>, NextT, VCardType> AncestorType;
	...
	public:
		...
		{
			AncestorType::pResults.rawdata.hourly[hourInTheYear] += state.eensSystemCN * pRatio;
			AncestorType::pResults.rawdata.year[0] += state.eensSystemCN * pRatio;
			// Next
...
#endif // __SOLVER_VARIABLE_ADEQUACY_ENS_CN_System_H__
