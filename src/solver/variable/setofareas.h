...
namespace Variable
{
	...
	{
		//! Caption
		static const char* Caption() {return "Sets of Areas";}
		//! Unit
	...
	public:
		...
		*/
		...
		template<class V> void yearEndSpatialAggregates(V& allVars, unsigned int year, unsigned int numSpace);

		template<class V> void computeSpatialAggregatesSummary(V& allVars, std::map<unsigned int, unsigned int> & numSpaceToYear, unsigned int);
