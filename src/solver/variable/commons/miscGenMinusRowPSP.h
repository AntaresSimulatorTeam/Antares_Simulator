...
namespace Economy
{
	...
	{
		//! Caption
		static const char* Caption() {return "MISC. NDG";}
		//! Unit
		static const char* Unit() {return "MWh";}

		//! The short description of the variable
		static const char* Description() {return "Non-dispatchable generation (not including wind and run-of-the-river)";}
	...
	*/
	...
	class MiscGenMinusRowPSP : public Variable::IVariable<MiscGenMinusRowPSP<NextT>, NextT, VCardMiscGenMinusRowPSP>
	{
	public:
	...
	public:
		...
		void initializeFromArea(Data::Study* study, Data::Area* area)
		{
			...
			for(unsigned int numSpace = 0; numSpace < pNbYearsParallel; numSpace++)
			{
				...
				(void)::memcpy(pValuesForTheCurrentYear[numSpace].hour, area->miscGen.entry[0], sizeof(double) * area->miscGen.height);
