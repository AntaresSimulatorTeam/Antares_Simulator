...
namespace Economy
{
	...
	{
		//! Caption
		static const char* Caption() {return "SOLAR";}
		//! Unit
		static const char* Unit() {return "MWh";}

		//! The short description of the variable
		static const char* Description() {return "Solar generation, thoughout all MC years";}
	...
	*/
	...
	class TimeSeriesValuesSolar : public Variable::IVariable<TimeSeriesValuesSolar<NextT>, NextT, VCardTimeSeriesValuesSolar>
	{
	public:
	...
	public:
		...
		void yearBegin(unsigned int year, unsigned int numSpace)
		{
			...
			(void)::memcpy(pValuesForTheCurrentYear[numSpace].hour,
				pArea->solar.series->series.entry[NumeroChroniquesTireesParPays[numSpace][pArea->index]->Solar],
