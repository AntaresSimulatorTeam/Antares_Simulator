...
namespace Economy
{
	...
	{
		//! Caption
		static const char* Caption() {return "LOAD";}
		//! Unit
		static const char* Unit() {return "MWh";}

		//! The short description of the variable
		static const char* Description() {return "Load generation, thoughout all MC years";}
	...
	*/
	...
	class TimeSeriesValuesLoad : public Variable::IVariable<TimeSeriesValuesLoad<NextT>, NextT, VCardTimeSeriesValuesLoad>
	{
	public:
	...
	public:
		...
		void yearBegin(unsigned int year, unsigned int numSpace)
		{
			...
			(void)::memcpy(pValuesForTheCurrentYear[numSpace].hour,
				pArea->load.series->series[NumeroChroniquesTireesParPays[numSpace][pArea->index]->Consommation],
