...
namespace Economy
{
	...
	{
		//! Caption
		static const char* Caption() {return "PSP";}
		//! Unit
		static const char* Unit() {return "MWh";}

		//! The short description of the variable
		static const char* Description() {return "PSP";}
	...
	*/
	...
	public:
		...
		void initializeFromArea(Data::Study* study, Data::Area* area)
		{
			// Copy raw values
			for(unsigned int numSpace = 0; numSpace < pNbYearsParallel; numSpace++)
				(void)::memcpy(pValuesForTheCurrentYear[numSpace].hour, area->miscGen.entry[Data::fhhPSP], sizeof(double) * area->miscGen.height);
