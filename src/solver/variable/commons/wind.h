...
namespace Economy
{
	...
	struct VCardTimeSeriesValuesWind
	{
		//! Caption
		static const char* Caption() {return "WIND";}
		//! Unit
		static const char* Unit() {return "MWh";}

		//! The short description of the variable
		static const char* Description() {return "Wind generation, thoughout all MC years";}
		...
		typedef VCardTimeSeriesValuesWind  VCardForSpatialAggregate;
	...
	/*!
	** \brief Marginal TimeSeriesValuesWind
	*/
	template<class NextT = Container::EndOfList>
	class TimeSeriesValuesWind : public Variable::IVariable<TimeSeriesValuesWind<NextT>, NextT, VCardTimeSeriesValuesWind>
	{
	public:
		//! Type of the next static variable
		typedef NextT NextType;
		//! VCard
		typedef VCardTimeSeriesValuesWind VCardType;
		//! Ancestor
		typedef Variable::IVariable<TimeSeriesValuesWind<NextT>, NextT, VCardType> AncestorType;
	...
	public:
		...
		void yearBegin(unsigned int year, unsigned int numSpace)
		{
			...
			const Matrix<>::ColumnType& load = pArea->wind.series->series.entry[NumeroChroniquesTireesParPays[numSpace][pArea->index]->Eolien];
			(void)::memcpy(pValuesForTheCurrentYear[numSpace].hour, load, sizeof(double) * pArea->wind.series->series.height);
...
#endif // __SOLVER_VARIABLE_ECONOMY_TimeSeriesValuesWind_H__
