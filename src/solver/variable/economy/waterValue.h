...
namespace Economy
{
	...
	{
		//! Caption
		static const char* Caption() { return "H. VAL"; }
		//! Unit
		static const char* Unit() { return "Euro/MWh"; }

		//! The short description of the variable
		static const char* Description() { return "Water value"; }
	...
	public:
		...
		void hourForEachArea(State& state, unsigned int numSpace)
		{
			...
			pValuesForTheCurrentYear[numSpace].hour[state.hourInTheYear] = state.hourlyResults->valeurH2oHoraire[state.hourInTheWeek];
