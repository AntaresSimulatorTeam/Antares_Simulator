...
namespace Economy
{
	...
	{
		//! Caption
		static const char* Caption() {return "NODU by plant";}
		//! Unit
		static const char* Unit() {return "NODU";}

		//! The short description of the variable
		static const char* Description() {return "Number of Dispatchable Units by plant";}
	...
	*/
	...
	class NbOfDispatchedUnitsByPlant : public Variable::IVariable<NbOfDispatchedUnitsByPlant<NextT>, NextT, VCardNbOfDispatchedUnitsByPlant>
	{
	public:
	...
	public:
		...
		void yearEndBuildPrepareDataForEachThermalCluster(State& state, uint year, unsigned int numSpace)
		{
			...
			{
					state.thermalClusterDispatchedUnitsCountForYear[i] += static_cast<uint>(pValuesForTheCurrentYear[numSpace][state.cluster->areaWideIndex].hour[i]);
			}
		...
		void yearEndBuildForEachThermalCluster(State& state, uint year, unsigned int numSpace)
		{
			...
			{
				 pValuesForTheCurrentYear[numSpace][state.cluster->areaWideIndex].hour[i] = state.thermalClusterDispatchedUnitsCountForYear[i];
			}
		...
		{	
			...
			pValuesForTheCurrentYear[numSpace][state.cluster->areaWideIndex].hour[state.hourInTheYear] = state.thermalClusterNumberON;
