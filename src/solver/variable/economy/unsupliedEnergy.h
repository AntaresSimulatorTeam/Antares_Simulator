...
namespace Economy
{
	...
	{
		//! Caption
		static const char* Caption() {return "UNSP. ENRG";}
		//! Unit
		static const char* Unit() {return "MWh";}
		//! The short description of the variable
		static const char* Description() {return "Unsuplied Energy (demand that cannot be satisfied)";}
	...
	*/
	...
	class UnsupliedEnergy : public Variable::IVariable<UnsupliedEnergy<NextT>, NextT, VCardUnsupliedEnergy>
	{
	public:
