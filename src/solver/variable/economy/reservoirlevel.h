	...
	namespace Solver
	{
		namespace Variable
		{
			namespace Economy
			{
				...
				{
					//! Caption
					static const char* Caption() { return "H. LEV"; }
					//! Unit
					static const char* Unit() { return "%"; }

					//! The short description of the variable
					static const char* Description() { return "Hydro Level"; }
				...
				public:
					...
					void hourForEachArea(State& state, unsigned int numSpace)
					{
						...
						pValuesForTheCurrentYear[numSpace].hour[state.hourInTheYear] = state.hourlyResults->niveauxHoraires[state.hourInTheWeek];
