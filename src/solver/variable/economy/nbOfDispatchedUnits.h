...
namespace Economy
{
	...
	{
		//! Caption
		static const char* Caption() {return "NODU";}
		//! Unit
		static const char* Unit() {return " ";}

		//! The short description of the variable
		static const char* Description() {return "Number Of Dispatched Units throughout all MC years, of all the thermal dispatchable clusters";}
		...
		typedef VCardNbOfDispatchedUnits VCardForSpatialAggregate;
	...
	*/
	...
	class NbOfDispatchedUnits : public Variable::IVariable<NbOfDispatchedUnits<NextT>, NextT, VCardNbOfDispatchedUnits>
	{
	public:
		//! Type of the next static variable
		typedef NextT NextType;
		//! VCard
		typedef VCardNbOfDispatchedUnits VCardType;
		//! Ancestor
		typedef Variable::IVariable<NbOfDispatchedUnits<NextT>, NextT, VCardType> AncestorType;
	...
	public:
		...
		void yearEndBuildForEachThermalCluster(State& state, uint year, unsigned int numSpace)
		{
			...
			{
				pValuesForTheCurrentYear[numSpace][i] += state.thermalClusterDispatchedUnitsCountForYear[i];
			}
