...
class ProductionByRenewablePlant
 : public Variable::
     IVariable<ProductionByRenewablePlant<NextT>, NextT, VCardProductionByRenewablePlant>
{
public:
    ...
    //! Ancestor
    typedef Variable::IVariable<ProductionByRenewablePlant<NextT>, NextT, VCardType>
      AncestorType;
