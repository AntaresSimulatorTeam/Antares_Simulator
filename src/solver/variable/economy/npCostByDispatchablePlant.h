...
namespace Economy
{
	...
	{
		//! Caption
		static const char* Caption() {return "NP Cost by plant";}
		//! Unit
		static const char* Unit() {return "NP Cost - Euro";}

		//! The short description of the variable
		static const char* Description() {return "Non proportional costs by all the clusters";}
	...
	*/
	...
	class NonProportionalCostByDispatchablePlant : public Variable::IVariable<NonProportionalCostByDispatchablePlant<NextT>, NextT, VCardNonProportionalCostByDispatchablePlant>
	{
	public:
		...
		//! Ancestor
		typedef Variable::IVariable<NonProportionalCostByDispatchablePlant<NextT>, NextT, VCardType> AncestorType;
	...
	public:
		...
		void yearEndBuildForEachThermalCluster(State& state, uint year, unsigned int numSpace)
		{
			...
			{
				 pValuesForTheCurrentYear[numSpace][state.cluster->areaWideIndex].hour[i] = state.thermalClusterNonProportionalCostForYear[i];
			}
