...
namespace Economy
{
	...
	*/
	typedef // Prices
			...
			< Marge
			< NonProportionalCost						// Startup cost + Fixed cost - MBO 13/05/2014 - refs: #21
			< NonProportionalCostByDispatchablePlant	// Startup cost + Fixed cost per thermal plant detail- MBO 13/05/2014 - refs: #21
			< NbOfDispatchedUnits						// Number of Units Dispatched - MBO 25/02/2016 - refs: #55
	...
	*/
	typedef // Prices
			Common::SpatialAggregate<OverallCost,
			Common::SpatialAggregate<OperatingCost,
			Common::SpatialAggregate<Price,
			// CO2
			Common::SpatialAggregate<CO2,
			// Production by thermal cluster
			Common::SpatialAggregate<Balance,
			// Misc Gen.
			Common::SpatialAggregate<RowBalance,
			Common::SpatialAggregate<PSP,
			Common::SpatialAggregate<MiscGenMinusRowPSP,
			// Time series
			Common::SpatialAggregate<TimeSeriesValuesLoad,
			Common::SpatialAggregate<TimeSeriesValuesHydro,
			Common::SpatialAggregate<TimeSeriesValuesWind,
			Common::SpatialAggregate<TimeSeriesValuesSolar,
			// Other
			...
			Common::SpatialAggregate<LOLP,

			Common::SpatialAggregate<AvailableDispatchGen,
			Common::SpatialAggregate<DispatchableGenMargin,
			Common::SpatialAggregate<Marge,

			//Detail Prices
			Common::SpatialAggregate<NonProportionalCost,	// MBO 13/05/2014 - refs: #21
	...
	typedef
		Variable::Join<
			...
			Variable::SetsOfAreas<VariablesPerSetOfAreas> >   ItemList;
