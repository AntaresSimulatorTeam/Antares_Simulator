...
namespace Economy
{
	...
	{
		//! Caption
		static const char* Caption() {return "NP COST";}
		//! Unit
		static const char* Unit() {return "Euro";}

		//! The short description of the variable
		static const char* Description() {return "Non Proportional Cost throughout all MC years, of all the thermal dispatchable clusters";}
	...
	*/
	...
	class NonProportionalCost : public Variable::IVariable<NonProportionalCost<NextT>, NextT, VCardNonProportionalCost>
	{
	public:
	...
	public:
		...
		void yearEndBuildForEachThermalCluster(State& state, uint year, unsigned int numSpace)
		{
			...
			{
				pValuesForTheCurrentYear[numSpace][i] += state.thermalClusterNonProportionalCostForYear[i];
			}
