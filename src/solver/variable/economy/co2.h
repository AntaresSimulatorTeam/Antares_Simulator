...
namespace Economy
{
	...
	{
		//! Caption
		static const char* Caption() {return "CO2 EMIS.";}
		//! Unit
		static const char* Unit() {return "Tons";}

		//! The short description of the variable
		static const char* Description() {return "Overall CO2 emissions expected from all the thermal dispatchable clusters";}
