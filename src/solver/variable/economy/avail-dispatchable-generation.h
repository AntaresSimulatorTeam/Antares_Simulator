...
namespace Economy
{
	...
	{
		//! Caption
		static const char* Caption() {return "AVL DTG";}
		//! Unit
		static const char* Unit() {return "MWh";}

		//! The short description of the variable
		static const char* Description() {return "Available dispatchable generation";}
	...
	*/
	...
	class AvailableDispatchGen : public Variable::IVariable<AvailableDispatchGen<NextT>, NextT, VCardAvailableDispatchGen>
	{
	public:
	...
	public:
		...
		void addThermalClusterList(Data::ThermalClusterList& list, unsigned int numSpace)
		{
			...
			for (Data::ThermalClusterList::const_iterator i = list.begin(); i != end; ++i)
			{
				...
				unsigned int chro = NumeroChroniquesTireesParPays[numSpace][pArea->index]->ThermiqueParPalier[cluster.areaWideIndex];
