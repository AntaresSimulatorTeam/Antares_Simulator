...
class STstorageWithdrawalByCluster
    : public Variable::
    IVariable<STstorageWithdrawalByCluster<NextT>, NextT, VCardSTstorageWithdrawalByCluster>
{
public:
    ...
    //! Ancestor
    typedef Variable::IVariable<STstorageWithdrawalByCluster<NextT>, NextT, VCardType>
        AncestorType;
...
public:
    ...
    {
        uint64 r = (sizeof(IntermediateValues) * nbClusters_ + IntermediateValues::MemoryUsage())
            * pNbYearsParallel;
