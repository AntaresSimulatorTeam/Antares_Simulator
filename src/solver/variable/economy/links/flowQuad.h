...
namespace Economy
{
	...
	{
		//! Caption
		static const char* Caption() {return "FLOW QUAD.";}
		//! Unit
		static const char* Unit() {return "MWh";}

		//! The short description of the variable
		static const char* Description() {return "Flow (quad.)";}

		//! The expecte results
		typedef Results<
			R::AllYears::Raw<      // Raw values
			> >  ResultsType;
	...
	*/
	...
	public:
		...
		void simulationEnd()
		{
			...
			(void)::memcpy(pValuesForTheCurrentYear.hour, ResultatsParInterconnexion[pLinkGlobalIndex]->TransitMoyenRecalculQuadratique,
