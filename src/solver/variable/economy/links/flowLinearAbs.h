...
namespace Economy
{
	...
	{
		//! Caption
		static const char* Caption() {return "UCAP LIN.";}
		//! Unit
		static const char* Unit() {return "MWh";}

		//! The short description of the variable
		static const char* Description() {return "Used capacity assessed, over all MC years, through linear optimization";}
	...
	*/
	...
	public:
		...
		//! VCard
		typedef VCardFlowLinearAbs VCardType;
		//! Ancestor
		typedef Variable::IVariable<FlowLinearAbs<NextT>, NextT, VCardType> AncestorType;
