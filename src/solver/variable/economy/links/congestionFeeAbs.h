...
namespace Economy
{
	...
	{
		//! Caption
		static const char* Caption() {return "CONG. FEE (ABS.)";}
		//! Unit
		static const char* Unit() {return "Euro";}

		//! The short description of the variable
		static const char* Description() {return "Congestion fee collected throughout all MC years (Absolute value)";}
	...
	*/
	...
	class CongestionFeeAbs : public Variable::IVariable<CongestionFeeAbs<NextT>, NextT, VCardCongestionFeeAbs>
	{
	public:
	...
	public:
		...
		void hourForEachLink(State& state, unsigned int numSpace)
		{
			...
			pValuesForTheCurrentYear[numSpace].hour[state.hourInTheYear] =
				Yuni::Math::Abs(state.ntc->ValeurDuFlux[state.link->index] * (UPSTREAM_PRICE - DOWNSTREAM_PRICE));
			// Next item in the list
