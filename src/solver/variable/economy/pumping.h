...
namespace Economy
{
	...
	{
		//! Caption
		static const char* Caption() { return "H. PUMP"; }
		//! Unit
		static const char* Unit() { return "MWh"; }

		//! The short description of the variable
		static const char* Description() { return "Hydraulic pumping"; }
	...
	public:
		...
		void hourForEachArea(State& state, unsigned int numSpace)
		{
			...
			pValuesForTheCurrentYear[numSpace].hour[state.hourInTheYear] = state.hourlyResults->PompageHoraire[state.hourInTheWeek];
