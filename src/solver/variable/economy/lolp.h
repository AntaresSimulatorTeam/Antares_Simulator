...
namespace Economy
{
	...
	{
		//! Caption
		static const char* Caption() {return "LOLP";}
		//! Unit
		static const char* Unit() {return "%";}

		//! The short description of the variable
		static const char* Description() {return "LOLP";}
		...
		typedef VCardLOLP VCardForSpatialAggregate;
	...
	*/
	...
	class LOLP : public Variable::IVariable<LOLP<NextT>, NextT, VCardLOLP>
	{
	public:
		//! Type of the next static variable
		typedef NextT NextType;
		//! VCard
		typedef VCardLOLP VCardType;
		//! Ancestor
		typedef Variable::IVariable<LOLP<NextT>, NextT, VCardType> AncestorType;
...
#endif // __SOLVER_VARIABLE_ECONOMY_LOLP_H__
