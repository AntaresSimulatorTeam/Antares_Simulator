...
typedef struct {
	...
	int * NumeroVar_overflow;			// Deversements (ecarts journaliers entre niveaux et les 100 % du reservoir)
	int * NumeroVar_deviations;			// Deviations (ecarts journaliers entre turbinés et crédits cibles brutes)
	int * NumeroVar_violations;			// Violations (ecarts journaliers entre niveaux et courbes guides sup et inf)
