...
{
int i; int NbPdt; int j; int NombreDeVariables; int NombreDeContraintes; int NombreDeTermesAlloues;
...
ProblemeHydraulique->CorrespondanceDesVariables = (CORRESPONDANCE_DES_VARIABLES *) malloc( sizeof( CORRESPONDANCE_DES_VARIABLES ) );
if ( ProblemeHydraulique->CorrespondanceDesVariables == NULL ) {
  return( 0 );
}

ProblemeHydraulique->ProblemeLineairePartieFixe = (PROBLEME_LINEAIRE_PARTIE_FIXE *) malloc( sizeof( PROBLEME_LINEAIRE_PARTIE_FIXE ) );
if ( ProblemeHydraulique->ProblemeLineairePartieFixe == NULL ) {
  return( 0 );
}

ProblemeHydraulique->ProblemeLineairePartieVariable = (PROBLEME_LINEAIRE_PARTIE_VARIABLE *) malloc( sizeof( PROBLEME_LINEAIRE_PARTIE_VARIABLE ) );
if ( ProblemeHydraulique->ProblemeLineairePartieVariable == NULL ) {
  return( 0 );
}

ProblemeHydraulique->ProblemeSpx = (void **) malloc( (unsigned int) NombreDeReservoirs * sizeof( void * ) );
...
CorrespondanceDesVariables->NumeroDeVariableVolume = (int *) malloc( (unsigned int) NbPdt * sizeof( int ) );
if ( CorrespondanceDesVariables->NumeroDeVariableVolume == NULL ) {
  return( 0 );
}

CorrespondanceDesVariables->NumeroDeVariableTurbine = (int *) malloc( (unsigned int) NbPdt * sizeof( int ) );
if ( CorrespondanceDesVariables->NumeroDeVariableTurbine == NULL ) {
  return( 0 );
}

CorrespondanceDesVariables->NumeroDeVariableDepassementVolumeMin = (int *) malloc( (unsigned int) NbPdt * sizeof( int ) );
if ( CorrespondanceDesVariables->NumeroDeVariableDepassementVolumeMin == NULL ) {
  return( 0 );
}

CorrespondanceDesVariables->NumeroDeVariableDepassementVolumeMax = (int *) malloc( (unsigned int) NbPdt * sizeof( int ) );
if ( CorrespondanceDesVariables->NumeroDeVariableDepassementVolumeMax == NULL ) {
  return( 0 );
}

CorrespondanceDesVariables->NumeroDeVariableDEcartPositifAuTurbineCible = (int *) malloc( (unsigned int) NbPdt * sizeof( int ) );
if ( CorrespondanceDesVariables->NumeroDeVariableDEcartPositifAuTurbineCible == NULL ) {
  return( 0 );
}

CorrespondanceDesVariables ->NumeroDeVariableDEcartNegatifAuTurbineCible = (int *) malloc( (unsigned int) NbPdt * sizeof( int ) );
...
ProblemeLineairePartieFixe->CoutLineaire = (double *) malloc( (unsigned int) NombreDeVariables * sizeof( double ) );
if ( ProblemeLineairePartieFixe->CoutLineaire == NULL ) {
  return( 0 );
}
ProblemeLineairePartieFixe->TypeDeVariable = (int *) malloc( (unsigned int) NombreDeVariables * sizeof( int ) );
...
ProblemeLineairePartieFixe->Sens = (char *) malloc( (unsigned int) NombreDeContraintes * sizeof( char ) );
if ( ProblemeLineairePartieFixe->Sens == NULL ) {
  return( 0 );
}
ProblemeLineairePartieFixe->IndicesDebutDeLigne = (int *) malloc( (unsigned int) NombreDeContraintes * sizeof( int ) );
if ( ProblemeLineairePartieFixe->IndicesDebutDeLigne == NULL ) {
  return( 0 );
}
ProblemeLineairePartieFixe->NombreDeTermesDesLignes = (int *) malloc( (unsigned int) NombreDeContraintes * sizeof( int ) );
...
ProblemeLineairePartieFixe->CoefficientsDeLaMatriceDesContraintes = (double *) malloc( (unsigned int) NombreDeTermesAlloues * sizeof( double ) );
if ( ProblemeLineairePartieFixe->CoefficientsDeLaMatriceDesContraintes == NULL ) {
  return( 0 );
}
ProblemeLineairePartieFixe->IndicesColonnes = (int *) malloc( (unsigned int) NombreDeTermesAlloues * sizeof( int ) );
if ( ProblemeLineairePartieFixe->IndicesColonnes == NULL ) {
  return( 0 );
}

ProblemeLineairePartieVariable->Xmin = (double *) malloc( (unsigned int) NombreDeVariables * sizeof( double ) );
if ( ProblemeLineairePartieVariable->Xmin == NULL ) {
  return( 0 );
}

ProblemeLineairePartieVariable->Xmax = (double *) malloc( (unsigned int) NombreDeVariables * sizeof( double ) );
if ( ProblemeLineairePartieVariable->Xmax == NULL ) {
  return( 0 );
}
ProblemeLineairePartieVariable->SecondMembre = (double *) malloc( (unsigned int) NombreDeContraintes * sizeof( double ) );
if ( ProblemeLineairePartieVariable->SecondMembre == NULL ) {
  return( 0 );
}

ProblemeLineairePartieVariable->AdresseOuPlacerLaValeurDesVariablesOptimisees = (double **) malloc( (unsigned int) NombreDeVariables * sizeof( double * ) );
if ( ProblemeLineairePartieVariable ->AdresseOuPlacerLaValeurDesVariablesOptimisees == NULL ) {
  return( 0 );
}

ProblemeLineairePartieVariable->X = (double *) malloc( (unsigned int) NombreDeVariables * sizeof( double ) );
...
ProblemeLineairePartieVariable->PositionDeLaVariable = (int *) malloc( (unsigned int) NombreDeVariables * sizeof( int ) );
if ( ProblemeLineairePartieVariable->PositionDeLaVariable == NULL ) {
  return( 0 );
}

ProblemeLineairePartieVariable->ComplementDeLaBase = (int *) malloc( (unsigned int) NombreDeContraintes * sizeof( int ) );
if ( ProblemeLineairePartieVariable->ComplementDeLaBase == NULL ) {
  return( 0 );
}

ProblemeLineairePartieVariable->CoutsReduits = (double *) malloc( (unsigned int) NombreDeVariables * sizeof( double ) );
if ( ProblemeLineairePartieVariable->CoutsReduits == NULL ) {
  return( 0 );
}

ProblemeLineairePartieVariable->CoutsMarginauxDesContraintes = (double *) malloc( (unsigned int) NombreDeContraintes * sizeof( double ) );
