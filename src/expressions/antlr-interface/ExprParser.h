...
public:
  enum {
    ...
    TIME = 15, IDENTIFIER = 16, COMPARISON = 17, EXTRA_OUTPUTS = 18, WS = 19
  };
  ...
  class  ExtraOutputsContext : public ExprContext {
  public:
    ExtraOutputsContext(ExprContext *ctx);

    antlr4::tree::TerminalNode *EXTRA_OUTPUTS();
