...
class ManagementHydrocluster : public wxScrolledWindow, public Yuni::IEventObserver<ManagementHydrocluster>
{
public:
    //! \name Constructor & Destructor
    //@{
    ...
    ** \brief Constructor
    */
    ManagementHydrocluster(wxWindow* parent, Toolbox::InputSelector::HydroclusterCluster* notifier);
    //! Destructor
    virtual ~ManagementHydrocluster();
    //@}
...
private:
    //! The input area selector
    Toolbox::InputSelector::HydroclusterCluster* pInputHydroclusterClusterSelector;
    Data::HydroclusterCluster* pHydroclusterCluster = nullptr;
    bool pComponentsAreReady = false;
    Component::Panel* pSupport = nullptr;
    wxTextCtrl* pIntermonthlyBreakdown = nullptr;
    wxTextCtrl* pInterdailyBreakdown = nullptr;
