...
namespace Window
{
		...
		pUpdatesToSkip(0)
	{
		...
		ssz->Add(btn);
		btn = new Component::Button(this, wxEmptyString, "images/16x16/italic.png", this, &Notes::onItalic);
		ssz->Add(btn);
		btn = new Component::Button(this, wxEmptyString, "images/16x16/underline.png", this, &Notes::onUnderline);
		ssz->Add(btn);

		Antares::Component::AddVerticalSeparator(this, ssz);

		btn = new Component::Button(this, wxEmptyString, "images/16x16/alignleft.png", this, &Notes::onAlignLeft);
		ssz->Add(btn);
		btn = new Component::Button(this, wxEmptyString, "images/16x16/aligncentre.png", this, &Notes::onAlignCenter);
		ssz->Add(btn);
		btn = new Component::Button(this, wxEmptyString, "images/16x16/alignright.png", this, &Notes::onAlignRight);
		ssz->Add(btn);

		Antares::Component::AddVerticalSeparator(this, ssz);

		btn = new Component::Button(this, wxEmptyString, "images/16x16/list_bullet.png", this, &Notes::onListBullet);
		ssz->Add(btn);
		btn = new Component::Button(this, wxEmptyString, "images/16x16/list_numbered.png", this, &Notes::onListNumbered);
		ssz->Add(btn);

		Antares::Component::AddVerticalSeparator(this, ssz);

		btn = new Component::Button(this, wxEmptyString, "images/16x16/format_decreaseindent.png", this, &Notes::onIndentDecrease);
		ssz->Add(btn);
		btn = new Component::Button(this, wxEmptyString, "images/16x16/format_increaseindent.png", this, &Notes::onIndentIncrease);
		ssz->Add(btn);
	...
	void Notes::onListBullet(void*)
	{
		...
		if (pRichEdit->HasSelection())
		{
			...
			pRichEdit->SetListStyle(range, wxT("Bullet List"), wxRICHTEXT_SETSTYLE_WITH_UNDO|wxRICHTEXT_SETSTYLE_RENUMBER);
		}
	}
	...
	void Notes::onListNumbered(void*)
	{
		...
		{
			wxRichTextRange range = pRichEdit->GetSelectionRange();
			pRichEdit->SetListStyle(range, wxT("Numbered List"), wxRICHTEXT_SETSTYLE_WITH_UNDO|wxRICHTEXT_SETSTYLE_RENUMBER);
		}
	}
