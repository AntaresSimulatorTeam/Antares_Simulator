...
namespace Options
{
		...
		pTargetRef(nullptr)
	{
		...
		hz->AddSpacer(6);
		hz->Add(Resources::StaticBitmapLoadFromFile(this, wxID_ANY, "images/64x64/db.png"), 0, wxALL|wxALIGN_TOP|wxALIGN_CENTER_HORIZONTAL);
		hz->AddSpacer(35);
		...
		// Binding constraints
		{
			...
			button->menu(true);
			onPopup.bind(this, &Optimization::onPopupMenu, PopupInfo(study.parameters.include.constraints, wxT("binding constraints")));
		...
		// Hurdle costs
		{
			...
			button->SetBackgroundColour(bgColor);
			button->menu(true);
			onPopup.bind(this, &Optimization::onPopupMenu, PopupInfo(study.parameters.include.hurdleCosts, wxT("hurdle costs")));
			button->onPopupMenu(onPopup);
			s->Add(label, 0, wxRIGHT | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL);
			s->Add(button, 0, wxLEFT | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL);
		...
		// Thermal clusters Min Stable Power
		{
			...
			button->SetBackgroundColour(bgColor);
			button->menu(true);
			onPopup.bind(this, &Optimization::onPopupMenu, PopupInfo(study.parameters.include.thermal.minStablePower, wxT("thermal cluster min stable power")));
			button->onPopupMenu(onPopup);
			s->Add(label, 0, wxRIGHT | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL);
			s->Add(button, 0, wxLEFT | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL);
		...
		// Thermal clusters Min U/D time
		{
			...
			button->SetBackgroundColour(bgColor);
			button->menu(true);
			onPopup.bind(this, &Optimization::onPopupMenu, PopupInfo(study.parameters.include.thermal.minUPTime, wxT("thermal cluster min U/D time")));
			button->onPopupMenu(onPopup);
			s->Add(label, 0, wxRIGHT | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL);
			s->Add(button, 0, wxLEFT | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL);
		...
		// Day ahead reserve
		{
			...
			button->SetBackgroundColour(bgColor);
			button->menu(true);
			onPopup.bind(this, &Optimization::onPopupMenu, PopupInfo(study.parameters.include.reserve.dayAhead, wxT("day ahead reserve")));
			button->onPopupMenu(onPopup);
			s->Add(label, 0, wxRIGHT | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL);
			s->Add(button, 0, wxLEFT | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL);
		...
		// Primary reserve
		{
			...
			button->SetBackgroundColour(bgColor);
			button->menu(true);
			onPopup.bind(this, &Optimization::onPopupMenu, PopupInfo(study.parameters.include.reserve.primary, wxT("primary reserve")));
			button->onPopupMenu(onPopup);
			s->Add(label, 0, wxRIGHT | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL);
			s->Add(button, 0, wxLEFT | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL);
		...
		// Strategic reserve
		{
			...
			button->SetBackgroundColour(bgColor);
			button->menu(true);
			onPopup.bind(this, &Optimization::onPopupMenu, PopupInfo(study.parameters.include.reserve.strategic, wxT("strategic reserve")));
			button->onPopupMenu(onPopup);
			s->Add(label, 0, wxRIGHT | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL);
			s->Add(button, 0, wxLEFT | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL);
		...
		// Spinning reserve
		{
			...
			button->SetBackgroundColour(bgColor);
			button->menu(true);
			onPopup.bind(this, &Optimization::onPopupMenu, PopupInfo(study.parameters.include.reserve.spinning, wxT("spinning reserve")));
			button->onPopupMenu(onPopup);
			s->Add(label, 0, wxRIGHT | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL);
			s->Add(button, 0, wxLEFT | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL);
		...
		// Export mps
		{
			...
			button->SetBackgroundColour(bgColor);
			button->menu(true);
			onPopup.bind(this, &Optimization::onPopupMenuSpecify, PopupInfo(study.parameters.include.exportMPS, wxT("true")));
			button->onPopupMenu(onPopup);
			s->Add(label, 0, wxRIGHT | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL);
			s->Add(button, 0, wxLEFT | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL);
		...
		if (0)
		{
			label  = Component::CreateLabel(this, wxT("Weekly binding constraints will be ignored"), false, false, -1);
			s->Add(label, 0, wxRIGHT | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL);
			s->AddSpacer(2);
		}
		...
		button = new Component::Button(panel, wxT("Reset to default"), "images/16x16/param_reset.png", this, &Optimization::onResetToDefault);
		pnlSizerBtns->Add(22, 5);
		pnlSizerBtns->Add(button, 0, wxALL|wxEXPAND);

		pnlSizerBtns->AddStretchSpacer();
		wxButton* pBtnCancel = Antares::Component::CreateButton(panel, wxT("  Close  "), this, &Optimization::onClose);
		...
		Connect(GetId(), wxEVT_MOTION,
			wxMouseEventHandler(Optimization::onInternalMotion), NULL, this);
	...
	void Optimization::onResetToDefault(void*)
	{
		...
		if (!(!studyptr))
		{
			Window::Message message(this, wxT("Optimization preferences"),
				wxT("Optimization preferences"), wxT("Do you really want to reset to the default values ?"));
	...
	void Optimization::onPopupMenu(Component::Button&, wxMenu& menu, void*, const PopupInfo& info)
	{
		...
		it = Menu::CreateItem(&menu, wxID_ANY, wxString() << wxT("local values (") << info.text << wxT(")"),
			"images/16x16/light_green.png", wxEmptyString);
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(Optimization::onSelectModeInclude), nullptr, this);
		it = Menu::CreateItem(&menu, wxID_ANY, wxT("ignore"), "images/16x16/light_orange.png", wxEmptyString);
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(Optimization::onSelectModeIgnore), nullptr, this);
	}

	
	void Optimization::onPopupMenuSpecify(Component::Button&, wxMenu& menu, void*, const PopupInfo& info)
	{
		pTargetRef = &info.rval;
		wxMenuItem* it;

		it = Menu::CreateItem(&menu, wxID_ANY, wxString() << info.text,
			"images/16x16/light_green.png", wxEmptyString);
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(Optimization::onSelectModeInclude), nullptr, this);
		it = Menu::CreateItem(&menu, wxID_ANY, wxT("false"), "images/16x16/light_orange.png", wxEmptyString);
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(Optimization::onSelectModeIgnore), nullptr, this);
	}
	...
	{
		wxMenuItem* it;
		it = Menu::CreateItem(&menu, wxID_ANY, wxT("Day"), "images/16x16/calendar_day.png", wxEmptyString);
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(Optimization::onSelectSimplexDay), nullptr, this);
		it = Menu::CreateItem(&menu, wxID_ANY, wxT("Week"), "images/16x16/calendar_week.png", wxEmptyString);
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(Optimization::onSelectSimplexWeek), nullptr, this);
	}
	...
	void Optimization::onPopupMenuTransmissionCapacities(Component::Button&, wxMenu& menu, void*)
	{
		...
		it = Menu::CreateItem(&menu, wxID_ANY, wxString() << wxT("local values"),
			"images/16x16/light_green.png", wxEmptyString);
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(Optimization::onSelectTransCapInclude), nullptr, this);

		it = Menu::CreateItem(&menu, wxID_ANY, wxT("set to null"), "images/16x16/light_orange.png", wxEmptyString);
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(Optimization::onSelectTransCapIgnore), nullptr, this);
