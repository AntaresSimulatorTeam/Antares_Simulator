...
namespace Options
{
	...
	AdvancedParameters::AdvancedParameters(wxWindow* parent) :
		wxDialog(parent, wxID_ANY, wxT("Advanced parameters"), wxDefaultPosition, wxDefaultSize,
			wxCLOSE_BOX|wxCAPTION|wxCLIP_CHILDREN)
	{
		...
		hz->AddSpacer(6);
		hz->Add(Resources::StaticBitmapLoadFromFile(this, wxID_ANY, "images/64x64/advanced.png"), 0, wxALL|wxALIGN_TOP|wxALIGN_CENTER_HORIZONTAL);
		hz->AddSpacer(35);
		...
		{
			pEditSeeds[seed] = insertEdit(this, s,
		...
		button = new Component::Button(panel, wxT("Reset to default"), "images/16x16/param_reset.png", this, &AdvancedParameters::onResetToDefault);
		pnlSizerBtns->Add(22, 5);
		pnlSizerBtns->Add(button, 0, wxALL|wxEXPAND);

		pnlSizerBtns->AddStretchSpacer();
		wxButton* pBtnCancel = Antares::Component::CreateButton(panel, wxT("  Close  "), this, &AdvancedParameters::onClose);
		...
		Connect(GetId(), wxEVT_MOTION,
			wxMouseEventHandler(AdvancedParameters::onInternalMotion), NULL, this);
	...
	void AdvancedParameters::onResetToDefault(void*)
	{
		...
		Window::Message message(this, wxT("Advanced parameters"),
	...
	void AdvancedParameters::refresh()
	{
		...
		// accuracy
		{
			...
			pBtnNumericQualityLoad->caption((0 != (accuracy & Data::timeSeriesLoad))
				? wxT("high") : wxT("standard"));

			pBtnNumericQualitySolar->caption((0 != (accuracy & Data::timeSeriesSolar))
				? wxT("high") : wxT("standard"));

			pBtnNumericQualityWind->caption((0 != (accuracy & Data::timeSeriesWind))
				? wxT("high") : wxT("standard"));
		}
		...
		text = wxStringFromUTF8(DayAheadReserveManagementModeToCString(study.parameters.reserveManagement.daMode));
		//pBtnDAReserveAllocation->caption(text);
		pBtnDARreserveManagement->caption(wxT("global"));
	}


	wxTextCtrl* AdvancedParameters::insertEdit(wxWindow* parent, wxSizer* sizer, const wxString& text,
	...
	void AdvancedParameters::onNumericQuality(Component::Button&, wxMenu& menu, void*, Data::TimeSeries ts)
	{
		pCurrentTS = ts;
		wxMenuItem* it;
		...
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(AdvancedParameters::onSelectNumericQualityStandard), nullptr, this);

		it = Menu::CreateItem(&menu, wxID_ANY, wxT("high"), "images/16x16/tag.png");
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(AdvancedParameters::onSelectNumericQualityHigh), nullptr, this);
	}
	...
	void AdvancedParameters::onPowerFluctuations(Component::Button&, wxMenu& menu, void*)
	{
		...
		it = Menu::CreateItem(&menu, wxID_ANY, text, "images/16x16/tag.png");
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(AdvancedParameters::onSelectFreeModulations), nullptr, this);
		...
		it = Menu::CreateItem(&menu, wxID_ANY, text, "images/16x16/tag.png");
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(AdvancedParameters::onSelectMinimizeExcursions), nullptr, this);
		...
		it = Menu::CreateItem(&menu, wxID_ANY, text, "images/16x16/tag.png");
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(AdvancedParameters::onSelectMinimizeRamping), nullptr, this);
	}
	...
	void AdvancedParameters::onSheddingPolicy(Component::Button&, wxMenu& menu, void*)
	{
		...
		it = Menu::CreateItem(&menu, wxID_ANY, text, "images/16x16/tag.png");
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(AdvancedParameters::onSelectSHPShavePeaks), nullptr, this);

		text.clear();
		text = wxStringFromUTF8(SheddingPolicyToCString(Data::shpMinimizeDuration));
		it = Menu::CreateItem(&menu, wxID_ANY, text, "images/16x16/tag.png");
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(AdvancedParameters::onSelectSHPMinimizeDuration), nullptr, this);
	}
	...
	void AdvancedParameters::onUnitCommitmentMode(Component::Button&, wxMenu& menu, void*)
	{
		...
		it = Menu::CreateItem(&menu, wxID_ANY, text, "images/16x16/tag.png");
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(AdvancedParameters::onSelectUCHeuristic), nullptr, this);
		...
		it = Menu::CreateItem(&menu, wxID_ANY, text, "images/16x16/tag.png");
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(AdvancedParameters::onSelectUCMixedIntegerLinearProblem), nullptr, this);
	}
	...
	void AdvancedParameters::onNumberOfCores(Component::Button&, wxMenu& menu, void*)
	{
		...
		it = Menu::CreateItem(&menu, wxID_ANY, text, "images/16x16/tag.png");
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(AdvancedParameters::onSelectNCmin), nullptr, this);

		text.clear();
		text = wxStringFromUTF8(NumberOfCoresModeToCString(Data::ncLow)); // Low
		it = Menu::CreateItem(&menu, wxID_ANY, text, "images/16x16/tag.png");
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(AdvancedParameters::onSelectNClow), nullptr, this);
		...
		it = Menu::CreateItem(&menu, wxID_ANY, text, "images/16x16/tag.png");
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(AdvancedParameters::onSelectNCaverage), nullptr, this);

		text.clear();
		text = wxStringFromUTF8(NumberOfCoresModeToCString(Data::ncHigh)); // High
		it = Menu::CreateItem(&menu, wxID_ANY, text, "images/16x16/tag.png");
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(AdvancedParameters::onSelectNChigh), nullptr, this);

		text.clear();
		text = wxStringFromUTF8(NumberOfCoresModeToCString(Data::ncMax)); // Max
		it = Menu::CreateItem(&menu, wxID_ANY, text, "images/16x16/tag.png");
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(AdvancedParameters::onSelectNCmax), nullptr, this);
	...
	void AdvancedParameters::onDAReserveAllocationMode(Component::Button&, wxMenu& menu, void*)
	{
		...
		it = Menu::CreateItem(&menu, wxID_ANY, text, "images/16x16/tag.png");
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(AdvancedParameters::onSelectDAGlobal), nullptr, this);

		text.clear();
		text = wxStringFromUTF8(DayAheadReserveManagementModeToCString(Data::daLocal));
		it = Menu::CreateItem(&menu, wxID_ANY, text, "images/16x16/tag.png");
		menu.Connect(it->GetId(), wxEVT_COMMAND_MENU_SELECTED,
			wxCommandEventHandler(AdvancedParameters::onSelectDALocal), nullptr, this);
	}
