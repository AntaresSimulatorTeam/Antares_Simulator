...
namespace Inspector
{
	...
	*/
	...
	{
	public:
		InspectorGrid(Frame& frame, wxWindow *parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition,
	...
	protected:
		...
		bool onPropertyChanging_Cluster(wxPGProperty*, const PropertyNameType& name, const wxVariant& value);
