...
const wxChar* const renewableTSMode[] = {wxT("power generation"),
                                         wxT("production factor"),
                                         nullptr};
...
const wxChar* const localGenTS[] = {wxT("Use global parameter"),
                                    wxT("Force generation"),
                                    wxT("Force no generation"),
                                    nullptr};
