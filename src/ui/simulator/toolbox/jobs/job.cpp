...
StdPair CreateStdInfo(wxWindow* parent, const wxString& defText)
{
    ...
    const wxColour newC((unsigned char)Math::MinMax<int>(c.Red() - 110, 0, 255),
...
#warning "wxWidgets has not been compiled with the `AnimationCtrl` support"
    ...
    // Informations
    {
        ...
        spg->Add(p.first, 1, wxALL | wxALIGN_LEFT);
...
void Job::onCancel(void*)
{
    ...
    Window::Message message(Forms::ApplWnd::Instance(),
                            wxT("Simulation"),
