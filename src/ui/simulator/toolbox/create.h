...
namespace Component
{
	...
	*/
	...
	wxButton* CreateButton(wxWindow* parent, const StringT& caption,
		T* object = NULL, void (T::* method)(void*) = NULL, void* userdata = NULL);
