...
namespace Renderer
{
	...
	public:
		...
		public:
			...
			virtual IRenderer::CellStyle cellStyle(int, int) const {return IRenderer::cellStyleDefault;}
			virtual wxColour cellBackgroundColor(int, int) const {return wxColour(255,255,255);}
			virtual wxColour cellTextColor(int, int) const {return wxColour(255,0,0);}
	...
	public:
		...
		*/
		...
		void matrix(Antares::Matrix<>* matrix) {pMatrix = matrix;}
		...
		virtual Date::Precision precision() {return Date::stepAny;}
