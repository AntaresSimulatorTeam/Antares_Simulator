...
{
public:
    Column(Antares::Data::TimeSeriesEnum ts, const wxString& caption);
    virtual ~Column();
...
protected:
    ...
    Antares::Data::TimeSeriesEnum tsKind_;
    wxString caption_;
};
...
{
public:
    classicColumn(Antares::Data::TimeSeriesEnum ts, const wxString& caption);
