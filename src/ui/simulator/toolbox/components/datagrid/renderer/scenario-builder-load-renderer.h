...
namespace Renderer
{
	class loadScBuilderRenderer : public ScBuilderRendererBase
	{
	public:
...
#endif // __ANTARES_TOOLBOX_COMPONENT_DATAGRID_RENDERER_LOAD_SCENARIO_BUILDER_H__
