...
namespace Renderer
{
	...
	{
		//if (notifier)
		//	notifier->onSimulationTSManagementChanged.connect(this, &SimulationTSManagement::onSimulationTSManagementChanged);
	}
	...
	bool SimulationTSManagement::cellValue(int x, int y, const String& value)
	{
		if (not study || x < 0 || x > 4)
			return 0.;
		enum Antares::Data::TimeSeries mapping[] =
		{
			Data::timeSeriesLoad,
			...
			case 4:
				{
					...
					switch (x)
					{
						case 0: study->parameters.nbTimeSeriesLoad    = c; return true;
						case 1: study->parameters.nbTimeSeriesThermal = c; return true;
						case 2: study->parameters.nbTimeSeriesHydro   = c; return true;
						case 3: study->parameters.nbTimeSeriesWind    = c; return true;
						case 4: study->parameters.nbTimeSeriesSolar   = c; return true;
					}
					onSimulationTSManagementChanged();
					break;
				}
			...
			case 6:
				{
					...
					switch (x)
					{
						case 0: study->parameters.refreshIntervalLoad    = (uint)Math::Round(d);return true;
						case 1: study->parameters.refreshIntervalThermal = (uint)Math::Round(d);return true;
						case 2: study->parameters.refreshIntervalHydro   = (uint)Math::Round(d);return true;
						case 3: study->parameters.refreshIntervalWind    = (uint)Math::Round(d);return true;
						case 4: study->parameters.refreshIntervalSolar   = (uint)Math::Round(d);return true;
					}
					break;
				}
			case 7:
				{
					...
					{
						if ((conversionValid && Math::Equals(d, -1.)) ||  s == "monthly" || s == "month" || s == "m")
					...
					if (mode != Antares::Data::Correlation::modeNone)
					{
						switch (ts)
						{
							case Data::timeSeriesLoad:
								study->preproLoadCorrelation.mode(mode); return true;
							case Data::timeSeriesWind:
								study->preproWindCorrelation.mode(mode); return true;
							case Data::timeSeriesSolar:
								study->preproSolarCorrelation.mode(mode);return true;
							default:
								return true;
						}
					}
			...
			case 1:
				{
					...
					return (0 != (study->parameters.timeSeriesToGenerate & ts))
						? 0 : 1.;
				}
			case 3:
				{
			...
			case 4:
				{
					switch (x)
					{
						case 0: return study->parameters.nbTimeSeriesLoad;
						case 1: return study->parameters.nbTimeSeriesThermal;
						case 2: return study->parameters.nbTimeSeriesHydro;
						case 3: return study->parameters.nbTimeSeriesWind;
						case 4: return study->parameters.nbTimeSeriesSolar;
					}
					break;
				}
			case 5:
			...
			case 6:
				{
					switch (x)
					{
						case 0: return study->parameters.refreshIntervalLoad;
						case 1: return study->parameters.refreshIntervalThermal;
						case 2: return study->parameters.refreshIntervalHydro;
						case 3: return study->parameters.refreshIntervalWind;
						case 4: return study->parameters.refreshIntervalSolar;
					}
					break;
				}
			case 7:
			...
			case 4:
				{
					switch (x)
					{
						case 0: return wxString() << study->parameters.nbTimeSeriesLoad;
						case 1: return wxString() << study->parameters.nbTimeSeriesThermal;
						case 2: return wxString() << study->parameters.nbTimeSeriesHydro;
						case 3: return wxString() << study->parameters.nbTimeSeriesWind;
						case 4: return wxString() << study->parameters.nbTimeSeriesSolar;
					}
					break;
				}
			case 5:
			...
			case 6:
				{
					switch (x)
					{
						case 0: return wxString() << study->parameters.refreshIntervalLoad;
						case 1: return wxString() << study->parameters.refreshIntervalThermal;
						case 2: return wxString() << study->parameters.refreshIntervalHydro;
						case 3: return wxString() << study->parameters.refreshIntervalWind;
						case 4: return wxString() << study->parameters.refreshIntervalSolar;
					}
					break;
				}
			case 7:
				{
					...
					{
						case Data::timeSeriesLoad:
							mode = study->preproLoadCorrelation.mode();break;
						case Data::timeSeriesWind:
							mode = study->preproWindCorrelation.mode();break;
						case Data::timeSeriesSolar:
							mode = study->preproSolarCorrelation.mode();break;
	...
	IRenderer::CellStyle SimulationTSManagement::cellStyle(int x, int y) const
	{
		...
		switch (y)
		{
			...
			case 6:
				{
					return (tsGenerator && 0 != (study->parameters.timeSeriesToRefresh & ts))
						? IRenderer::cellStyleDefault : IRenderer::cellStyleDefaultDisabled;
				}
			case 7:
				{
					return (tsGenerator)
			...
			case 11:
				{
					return (0 != (study->parameters.intraModal & ts))
						? IRenderer::cellStyleDefault : IRenderer::cellStyleDefaultDisabled;
				}
			case 12:
				{
					return (0 != (study->parameters.interModal & ts))
						? IRenderer::cellStyleDefault : IRenderer::cellStyleDefaultDisabled;
				}
		}
