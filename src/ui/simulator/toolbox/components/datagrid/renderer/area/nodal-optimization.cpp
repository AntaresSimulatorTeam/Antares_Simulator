...
NodalOptimization::NodalOptimization(wxWindow* parent) : pControl(parent)
{
    ...
    OnStudyNodalOptimizationChanged.connect(this,
                                            &NodalOptimization::onNodalOptimizationExternalChanged);
}
...
wxString NodalOptimization::columnCaption(int colIndx) const
{
    ...
    case 3:
        return wxT("  Spilled  \n   Energy Cost   \n(spread)");
    case 4:
        return wxT("  Non dispatch. power  \n  Shedding Status");
    case 5:
        return wxT("  Dispatch. hydropower  \n  Shedding Status");
    case 6:
        return wxT("  Other Dispatch. power  \n  Shedding Status");
    }
    ...
    if (!(!study) && (uint)y < study->areas.size())
    {
        ...
        case 0:
            return Math::Zero(area.thermal.unsuppliedEnergyCost)
                     ...
                     : (area.thermal.unsuppliedEnergyCost < 0 ? IRenderer::cellStyleWarning
                                                              : IRenderer::cellStyleDefault);
        case 1:
            return Math::Zero(area.spreadUnsuppliedEnergyCost) ? IRenderer::cellStyleDefaultDisabled
                                                               : IRenderer::cellStyleDefault;
        case 2:
            return Math::Zero(area.thermal.spilledEnergyCost)
                     ? IRenderer::cellStyleDefaultDisabled
                     : (area.thermal.spilledEnergyCost < 0 ? IRenderer::cellStyleWarning
                                                           : IRenderer::cellStyleDefault);
        case 3:
            return Math::Zero(area.spreadSpilledEnergyCost) ? IRenderer::cellStyleDefaultDisabled
                                                            : IRenderer::cellStyleDefault;
        case 4:
