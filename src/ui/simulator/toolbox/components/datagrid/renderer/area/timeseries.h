...
protected:
    ...
    {
        matrix((area && Data::Study::Current::Valid()) ? &(area->load.series->time_series) : NULL);
...
protected:
    virtual void internalAreaChanged(Antares::Data::Area* area)
    {
        matrix((area && Data::Study::Current::Valid()) ? &(area->solar.series->time_series) : NULL);
        Renderer::ARendererArea::internalAreaChanged(area);
    }
};
...
protected:
    virtual void internalAreaChanged(Antares::Data::Area* area)
    {
        matrix((area && Data::Study::Current::Valid()) ? &(area->wind.series->time_series) : NULL);
        Renderer::ARendererArea::internalAreaChanged(area);
    }
};
...
protected:
    ...
    {
        matrix((Data::Study::Current::Valid() && cluster) ? &(cluster->series->time_series) : NULL);
    }
