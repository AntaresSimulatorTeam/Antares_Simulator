...
namespace Renderer
{
	...
	wxString XCastAllAreas<T>::columnCaption(int colIndx) const
	{
		switch (colIndx)
		{
			case 0: return wxT("      Capacity ");
			case 1: return wxT("Distribution");
			case 2: return wxT("Conversion");
			case 3: return wxT("              Translation");
		}
	...
	IRenderer::CellStyle XCastAllAreas<T>::cellStyle(int x, int y) const
	{
		...
		{
			case 0:
				return Yuni::Math::Zero(xcastData.capacity)
					? IRenderer::cellStyleDefaultCenterDisabled
					: IRenderer::cellStyleConstraintWeight;
			case 2:
				return xcastData.useConversion
					? IRenderer::cellStyleDefaultCenter
					: IRenderer::cellStyleDefaultCenterDisabled;
			case 3:
				{
