...
wxString ThermalClusterSummarySingleArea::cellValue(int x, int y) const
{
    ...
    case 9:
        return DoubleToWxString(cluster->emissions.factors[0]); //emissionFactor[0] = CO2
    case 10:
...
double ThermalClusterSummarySingleArea::cellNumericValue(int x, int y) const
{
    ...
    case 9:
        return cluster->emissions.factors[0]; //emissionFactor[0] = CO2
    case 10:
...
bool ThermalClusterSummarySingleArea::cellValue(int x, int y, const String& v)
{
    ...
    if (cluster)
    {
        ...
        case 9:
            return Update<double, NoCheck, RefeshInspector>(cluster->emissions.factors[0], v); //emissionFactor[0] = CO2
        case 10:
