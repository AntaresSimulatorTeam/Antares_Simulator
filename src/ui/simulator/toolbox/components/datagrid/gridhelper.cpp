...
namespace Datagrid
{
	...
	public:
			...
			pParent(parent)
		{
			...
			pStyles[CellStyle::cellStyleDefaultAlternateDisabled]->SetBackgroundColour(wxColour(245, 245, 255));
			pStyles[CellStyle::cellStyleDefaultAlternateDisabled]->SetTextColour(wxColour(200, 200, 200));
			// Default disabled
			...
			// Default alternate
			pStyles[CellStyle::cellStyleDefaultCenterAlternate]->SetBackgroundColour(wxColour(245, 245, 255));
			pStyles[CellStyle::cellStyleDefaultCenterAlternate]->SetAlignment(wxALIGN_CENTRE, wxALIGN_CENTRE);
			// Default alternate disabled
			pStyles[CellStyle::cellStyleDefaultCenterAlternateDisabled]->SetBackgroundColour(wxColour(245, 245, 255));
			pStyles[CellStyle::cellStyleDefaultCenterAlternateDisabled]->SetTextColour(wxColour(200, 200, 200));
			pStyles[CellStyle::cellStyleDefaultCenterAlternateDisabled]->SetAlignment(wxALIGN_CENTRE, wxALIGN_CENTRE);
			// Default disabled
			pStyles[CellStyle::cellStyleDefaultCenterDisabled]->SetTextColour(wxColour(200, 200, 200));
			pStyles[CellStyle::cellStyleDefaultCenterDisabled]->SetAlignment(wxALIGN_CENTRE, wxALIGN_CENTRE);
			...
			// Constraint - Enabled
			{
				pStyles[CellStyle::cellStyleConstraintEnabled]->SetBackgroundColour(wxColour(186, 255, 184));
				pStyles[CellStyle::cellStyleConstraintEnabled]->SetAlignment(wxALIGN_CENTRE, wxALIGN_CENTRE);
				pStyles[CellStyle::cellStyleConstraintEnabled]->SetTextColour(wxColour(100, 100, 100));
			}
			// Constraint - Disabled
			{
				pStyles[CellStyle::cellStyleConstraintDisabled]->SetBackgroundColour(wxColour(255, 179, 179));
				pStyles[CellStyle::cellStyleConstraintDisabled]->SetTextColour(wxColour(100, 100, 100));
				pStyles[CellStyle::cellStyleConstraintDisabled]->SetAlignment(wxALIGN_CENTRE, wxALIGN_CENTRE);
			}
			// Constraint - No Weight
			{
				pStyles[CellStyle::cellStyleConstraintNoWeight]->SetTextColour(wxColour(200, 200, 200));
				pStyles[CellStyle::cellStyleConstraintNoWeight]->SetAlignment(wxALIGN_CENTRE, wxALIGN_CENTRE);
			}
			// Constraint - Weight
			{
				pStyles[CellStyle::cellStyleConstraintWeight]->SetTextColour(wxColour(255, 100, 43));
				pStyles[CellStyle::cellStyleConstraintWeight]->SetAlignment(wxALIGN_CENTRE, wxALIGN_CENTRE);
			}
			// Constraint - Weight count
			{
				pStyles[CellStyle::cellStyleConstraintWeightCount]->SetBackgroundColour(wxColour(230, 230, 230));
				pStyles[CellStyle::cellStyleConstraintWeightCount]->SetTextColour(wxColour(170, 170, 220));
				pStyles[CellStyle::cellStyleConstraintWeightCount]->SetRenderer(new wxGridCellNumberRenderer());
			}
			// Constraint - Operator
			{
				pStyles[CellStyle::cellStyleConstraintOperator]->SetBackgroundColour(wxColour(230, 230, 230));
			...
			// Constraint - Type
			{
				pStyles[CellStyle::cellStyleConstraintType]->SetBackgroundColour(wxColour(230, 230, 230));
		...
		void appendCSSForAllCellStyles(wxString& s)
		{
			...
			s << wxT("th {white-space:nowrap;font-weight:bold;text-align:center;border:1px solid black;background-color:#222222;color:white;}\r\n");
		...
		void appendCSSForAllCellStyles2(Yuni::String& s)
		{
			...
			s << "th {white-space:nowrap;font-weight:bold;text-align:center;border:1px solid black;background-color:#222222;color:white;}\r\n";
	...
	private:
		void internalAppendCSSCode(wxString& s, CellStyle::CellStyle style)
		{
			...
			switch (halign)
			{
				case wxALIGN_CENTER: s << wxT("text-align:center;");break;
				case wxALIGN_RIGHT: s << wxT("text-align:right;");break;
			}
			s << wxT("}\r\n");
		}
		...
		void internalAppendCSSCode(Yuni::String& s, CellStyle::CellStyle style)
		{
			...
			s	<< " {background-color:rgb("
				...
				<< (int) b.Blue()
				<< ");color:rgb("
				<< (int) pStyles[style]->GetTextColour().Red() << ','
			...
			switch (halign)
			{
				case wxALIGN_CENTER: s << "text-align:center;";break;
				case wxALIGN_RIGHT: s << "text-align:right;";break;
			}
			s << "}\r\n";
		}
	...
	{
		return (pRenderer and valid)
			? pRenderer->columnCaption(realCol(col))
			: wxString();
	}
	...
	{
		return (pRenderer and valid)
			? pRenderer->cellNumericValue(realCol(col), realRow(row))
			: 0.;
	}
