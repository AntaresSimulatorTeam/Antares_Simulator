...
namespace Datagrid
{
	...
	*/
	...
	public:
		...
		*/
		Component(wxWindow* parent, Renderer::IRenderer* renderer = NULL,
			const wxString& caption = wxEmptyString, bool hasFilter = true, bool colorMappingRowLabels = true,
			bool copypasteOnly = false, bool readonly = false, bool hasLayerFilter = false);
		/*!
		** \brief Destructor
		*/
		virtual ~Component();
