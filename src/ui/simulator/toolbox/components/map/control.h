...
namespace Map
{
	...
	*/
	...
	public:
		...
		*/
		const size_t& getUid() const {return this->uid;}

		//! \name Zoom
		//@{
		double zoom() const {return pZoom;}
		void zoom(const double v);
		//@}


		void invalidate() {pInvalidated = true;}
		const wxColour& getBackgroundColor(){return pBackgroundColor;}
		void setBackgroundColor(const wxColour& newColor){ pBackgroundColor = newColor;}
		...
		*/
		...
		void setpInfosAreaCount(wxStaticText* infosAreaCount) { pInfosAreaCount = infosAreaCount; }
		wxStaticText* getpInfosAreaCount() { return pInfosAreaCount; }

		/*!
		** \brief Get how many connections we have
		*/
		uint connectionsCount() const;
		void setpInfosConnxCount(wxStaticText* infosConnxCount) { pInfosConnxCount = infosConnxCount; }
		wxStaticText* getpInfosConnxCount() { return pInfosConnxCount; }

		void setPointX(wxTextCtrl* textCtrl) { pointX = textCtrl; }
		wxTextCtrl* getPointX() { return pointX; }
		void setPointY(wxTextCtrl* textCtrl) { pointY = textCtrl; }
		wxTextCtrl* getPointY() { return pointY; }
