...
namespace Map
{
	...
	*/
	...
	public:
		...
		*/
		Data::Study::Ptr study() const {return pStudy;}
		//@}
		...
		*/
		uint selectedItemsCount() const {return (uint) pSelectedItems.size();}

		uint selectedItemsAsConnectionCount() const {return (uint) pSelectedItemsAsConnection;};
		...
		*/
		...
		bool hasChanges() const {return pHasChanges;}
		void setChangesFlag(bool v) {pHasChanges = v;}
