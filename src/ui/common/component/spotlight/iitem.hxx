...
namespace Component
{
	...
	template<class StringT>
	inline void Spotlight::IItem::addTag(const StringT& text, Yuni::uint8 r, Yuni::uint8 g, Yuni::uint8 b)
	{
	...
	template<class StringT>
	inline void Spotlight::IItem::addRightTag(const StringT& text, Yuni::uint8 r, Yuni::uint8 g, Yuni::uint8 b)
	{
