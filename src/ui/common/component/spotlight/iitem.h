...
# define __ANTARES_UI_COMMON_COMPONENT_SPOTLIGHT_SPOTLIGHT_IITEM_H__
	...
	public:
		...
		public:
			...
			{}
			Tag(const wxChar* t, Yuni::uint8 r, Yuni::uint8 g, Yuni::uint8 b) :
				text(t), color(r, g, b)
			{}
	...
	public:
		...
		*/
		...
		//! Set the caption
		template<class StringT> void caption(const StringT& caption);
		//! Set the caption
		...
		//! Set the caption
		template<class StringT> void subcaption(const StringT& caption);
		...
		//! Set the group
		template<class StringT> void group(const StringT& g);
		//! Compare with another group
		template<class StringT> bool isSameGroup(const StringT& group) const;
		//@}
		...
		//@{
		//! Add a new tag
		template<class StringT> void addTag(const StringT& text);
		//! Add a new tag
		template<class StringT> void addTag(const StringT& text, Yuni::uint8 r, Yuni::uint8 g, Yuni::uint8 b);
		//! Add a new tag on the right
		template<class StringT> void addRightTag(const StringT& text);
		//! Add a new tag on the right
		template<class StringT> void addRightTag(const StringT& text, Yuni::uint8 r, Yuni::uint8 g, Yuni::uint8 b);
		//! Clear all tags
		void clearTags();
		//@}
		...
		** \param[in,out] bounds The bounds of the surface. The width and the height should be be modified
		*/
