...
def check_integrity_first_opt(path):
    ...
    np.testing.assert_allclose(reference_values[0:4], output_values[0:4], atol=1e-4, rtol=0)
...
def check_integrity_second_opt(path):
    ...
    np.testing.assert_allclose(reference_values[4:8], output_values[4:8], atol=1e-4, rtol=0)
...
def run_study(path, use_ortools, ortools_solver):
    # Launch antares-solver
    launch_solver(path, use_ortools, ortools_solver)

## TESTS ##
@pytest.mark.short
def test_001_one_node_passive(use_ortools, ortools_solver):
    study_path = ALL_STUDIES_PATH / "short-tests" / "001 One node - passive"
    run_study(study_path, use_ortools, ortools_solver)
    check_integrity_first_opt(study_path)
    check_integrity_second_opt(study_path)

@pytest.mark.short
def test_002_thermal_fleet_base(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_003_thermal_fleet_must_run(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_004_thermal_fleet_partial_must_run(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_005_thermal_fleet_minimum_stable_power_and_min_up_down_times(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_006_thermal_fleet_extra_costs(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_007_thermal_fleet_fast_unit_commitment(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_008_thermal_fleet_accurate_unit_commitment(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_009_ts_generation_thermal_power(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_010_ts_generation_wind_speed(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_011_ts_generation_wind_power_small_scale(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_012_ts_generation_wind_power_large_scale(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_013_ts_generation_solar_power(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_014_ts_generation_load(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_015_ts_generation_hydro_power(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_016_probabilistic_vs_deterministic_1(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_018_probabilistic_vs_deterministic_3(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_020_single_mesh_dc_law(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_021_four_areas_dc_law(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_022_negative_marginal_price(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_023_anti_pricewise_flows(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_024_hurdle_costs_1(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_025_hurdle_costs_2(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_026_day_ahead_reserve_1(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_027_day_ahead_reserve_2(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_028_pumped_storage_plant_1(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_029_pumped_storage_plant_2(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_030_pumped_storage_plant_3(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_031_wind_analysis(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_033_mixed_expansion_storage(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_034_mixed_expansion_smart_grid_model_1(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_036_multistage_study_1_isolated_systems(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_037_multistage_study_2_copperplate(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_040_multistage_study_5_derated(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_044_psp_strategies_1_no_psp(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_045_psp_strategies_2_det_pumping(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_046_psp_strategies_3_opt_daily(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_047_psp_strategies_4_opt_weekly(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_053_system_map_editor_1(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_054_system_map_editor_2(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_055_system_map_editor_3(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_056_system_map_editor_4(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_057_four_areas_grid_outages_01(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_058_four_areas_grid_outages_02(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_059_four_areas_grid_outages_03(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_060_four_areas_grid_outages_04(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_061_four_areas_grid_outages_05(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_062_grid_topology_changes_on_contingencies_01(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_063_grid_topology_changes_on_contingencies_02(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_064_probabilistic_exchange_capacity(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_065_pumped_storage_plant_explicit_model_01(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_066_pumped_storage_plant_explicit_model_02(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_067_pumped_storage_plant_explicit_model_03(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_068_hydro_reservoir_model_enhanced_01(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_069_hydro_reservoir_model_enhanced_02(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_070_hydro_reservoir_model_enhanced_03(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_071_hydro_reservoir_model_enhanced_04(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_072_hydro_reservoir_model_enhanced_05(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_073_hydro_reservoir_model_enhanced_06(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_074_kcg_on_four_areas_01(use_ortools, ortools_solver):
...
@pytest.mark.short
def test_075_kcg_on_four_areas_02(use_ortools, ortools_solver):
...
@pytest.mark.medium
def test_000_free_data_sample(use_ortools, ortools_solver):
...
@pytest.mark.medium
def test_017_probabilistic_vs_deterministic_2(use_ortools, ortools_solver):
...
@pytest.mark.medium
def test_032_exploited_wind_fields(use_ortools, ortools_solver):
...
@pytest.mark.medium
def test_035_mixed_expansion_smart_grid_model_2(use_ortools, ortools_solver):
...
@pytest.mark.medium
def test_038_multistage_study_3_ptdf(use_ortools, ortools_solver):
...
@pytest.mark.medium
def test_039_multistage_study_4_kirchhoff(use_ortools, ortools_solver):
...
@pytest.mark.medium
def test_041_multistage_study_6_ntc(use_ortools, ortools_solver):
...
@pytest.mark.medium
def test_042_multistage_study_7_ptdf(use_ortools, ortools_solver):
...
@pytest.mark.medium
def test_043_multistage_study_8_kirchhoff(use_ortools, ortools_solver):
...
@pytest.mark.medium
def test_048_benchmark_cpu_ram_hdd_1(use_ortools, ortools_solver):
...
@pytest.mark.medium
def test_076_kcg_on_regional_dataset_01(use_ortools, ortools_solver):
...
@pytest.mark.medium
def test_077_kcg_on_regional_dataset_02(use_ortools, ortools_solver):
...
@pytest.mark.medium
def test_078_kcg_on_regional_dataset_03(use_ortools, ortools_solver):
...
@pytest.mark.long
def test_049_benchmark_cpu_ram_hdd_2(use_ortools, ortools_solver):
...
@pytest.mark.long
def test_050_export_mps_file(use_ortools, ortools_solver):
...
@pytest.mark.long
def test_051_benchmark_cpu_ram_hdd_3(use_ortools, ortools_solver):
...
@pytest.mark.long
def test_052_benchmark_cpu_ram_hdd_4(use_ortools, ortools_solver):
...
@pytest.mark.long
def test_079_zero_power_balance_type_1(use_ortools, ortools_solver):
...
@pytest.mark.long
def test_080_zero_power_balance_type_2(use_ortools, ortools_solver):
...
@pytest.mark.long
def test_081_zero_power_balance_type_3(use_ortools, ortools_solver):
...
@pytest.mark.long
def test_082_zero_power_balance_type_4(use_ortools, ortools_solver):
...
@pytest.mark.long
def test_083_zero_energy_balance_daily(use_ortools, ortools_solver):
...
@pytest.mark.long
def test_084_zero_energy_balance_weekly(use_ortools, ortools_solver):
...
@pytest.mark.long
def test_085_zero_energy_balance_annual(use_ortools, ortools_solver):
