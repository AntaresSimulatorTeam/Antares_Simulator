...
BOOST_FIXTURE_TEST_CASE(scenario_builder, HydroMaxPowerStudy)
{
    ...
    BOOST_TEST(hydro->series->maxHourlyGenPower.timeseriesNumbers[0] == 2U);
    BOOST_TEST(hydro->series->maxHourlyGenPower.timeseriesNumbers[1] == 1U);
    BOOST_TEST(hydro->series->maxHourlyGenPower.timeseriesNumbers[2] == 0);
