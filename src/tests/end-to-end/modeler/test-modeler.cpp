...
Antares::ModelerStudy::SystemModel::Component copyComponent(Antares::ModelerStudy::SystemModel::Component c) {
...
public:
    ...
    Antares::Modeler::Data loadAll() override {
        fixture.createModelWithOneFloatVar("some_model", {}, "var1", fixture.literal(-5), fixture.literal(10), {});
