...
//     Node* sum = create<SumNode>(create<LiteralNode>(60.), create<ParameterNode>("param"),
//     product); EvaluationContext evaluation_context({{"param", {-5.}}}, {});
//     ReadLinearExpressionVisitor visitor(evaluation_context);
//     auto linear_expression = visitor.dispatch(sum);
...
//       create<MultiplicationNode>(create<LiteralNode>(6.), create<VariableNode>("var2")) // 6 *
//       var2
//     );
//
...
//                           checkMessage("ReadLinearExpressionVisitor cannot visit
//                           PortFieldNodes"));
//
