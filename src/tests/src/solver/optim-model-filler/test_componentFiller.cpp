...
//                 {},
//                 {{"variable", ValueType::FLOAT, parameter("parameter-not-in-model"),
//                 literal(10)}},
//                 {});
...
//     createModel("model",
//                 {"pmin", "pmax"},
//                 {{"var1", ValueType::INTEGER, parameter("pmin"), parameter("pmax"), false,
//                 false}},
//                 {});
...
//
//     createModel("my_new_model", {}, {var1Data, var2Data}, {{"ct1", ct1_node}, {"ct2",
//     ct2_node}}); createComponent("my_new_model", "my_component", {}); buildLinearProblem();
//
//     BOOST_CHECK_EQUAL(pb->variableCount(), 2);
...
//
//     createModelWithOneFloatVar("model", {}, "x", literal(-50), literal(-40), {}, objective,
//     true); createComponent("model", "componentA", {});
//
//     constexpr unsigned int last_time_step = 9;
//     FillContext ctx{0, last_time_step};
//     buildLinearProblem(ctx);
...
//                               variable("x"));
//     createModelWithOneFloatVar("model", {"param"}, "x", literal(-50), literal(-40), {},
//     objective); createComponent("model", "componentA", {{"param", 5}}); buildLinearProblem();
//
//     BOOST_CHECK_EQUAL(pb->variableCount(), 1);
//     BOOST_CHECK_NO_THROW(pb->getVariable("componentA.x"));
...
//                           invalid_argument,
//                           checkMessage("Antares does not support objective offsets (found in
//                           model "
