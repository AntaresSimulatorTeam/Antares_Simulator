...
// ========================
Area* addAreaToStudy(Study& study, const std::string& areaName)
{
...
BOOST_AUTO_TEST_CASE(
  two_areas_3_thermal_clusters_with_respectively_4_1_4_ready_made_ts___check_intra_modal_consistency_OK)
{
    // Creating a study
    Study study;
    initializeStudy(study);
...
BOOST_AUTO_TEST_CASE(
  two_areas_3_renew_clusters_with_respectively_4_4_1_ready_made_ts___check_intra_modal_consistency_OK)
{
    // Creating a study
    Study study;
    initializeStudy(study);
  ...
  two_areas_3_renew_clusters_with_different_number_of_ready_made_ts___check_intra_modal_consistency_KO)
{
    ...
    // ... Area 1 : renewable cluster 2
    auto rnCluster_12 = addClusterToArea<RenewableCluster>(area_1, "rn-cluster-12");
    rnCluster_12->series->series.resize(
      3, 1); // Caution : number of TS different from previous cluster
