...
BOOST_AUTO_TEST_CASE(empty_file)
{
    ...
    BOOST_CHECK_EXCEPTION(auto _ = repo.getDataSeries("empty").getData(1, 0),
                          TimeSeriesSet::Empty,
                          checkMessage(
...
BOOST_AUTO_TEST_CASE(one_line_one_column)
{
    ...
    BOOST_CHECK_EXCEPTION(auto _ = repo.getDataSeries("one").getData(2, 0),
                          TimeSeriesSet::RankTooBig,
                          checkMessage(
                            "TS set 'one' : TS number 2 exceeds TS set's number of columns (1)"));
    BOOST_CHECK_EXCEPTION(auto _ = repo.getDataSeries("one").getData(1, 1),
...
BOOST_AUTO_TEST_CASE(one_line_two_columns)
{
    ...
    BOOST_CHECK_EXCEPTION(
      auto _ = repo.getDataSeries("one_by_two").getData(3, 0),
      TimeSeriesSet::RankTooBig,
      checkMessage("TS set 'one_by_two' : TS number 3 exceeds TS set's number of columns (2)"));
    BOOST_CHECK_EXCEPTION(auto _ = repo.getDataSeries("one_by_two").getData(2, 1),
                          TimeSeriesSet::HourTooBig,
...
BOOST_AUTO_TEST_CASE(two_lines_one_column)
{
    ...
    BOOST_CHECK_EXCEPTION(
      auto _ = repo.getDataSeries("two_by_one").getData(2, 0),
      TimeSeriesSet::RankTooBig,
      checkMessage("TS set 'two_by_one' : TS number 2 exceeds TS set's number of columns (1)"));
    BOOST_CHECK_EXCEPTION(auto _ = repo.getDataSeries("two_by_one").getData(1, 2),
                          TimeSeriesSet::HourTooBig,
...
BOOST_AUTO_TEST_CASE(two_lines_two_columns)
{
    ...
    BOOST_CHECK_EXCEPTION(
      auto _ = repo.getDataSeries("two_by_two").getData(3, 1),
      TimeSeriesSet::RankTooBig,
      checkMessage("TS set 'two_by_two' : TS number 3 exceeds TS set's number of columns (2)"));
    BOOST_CHECK_EXCEPTION(auto _ = repo.getDataSeries("two_by_two").getData(2, 2),
                          TimeSeriesSet::HourTooBig,
...
BOOST_AUTO_TEST_CASE(two_lines_three_columns_three_separators)
{
    ...
    BOOST_CHECK_EXCEPTION(auto _ = repo.getDataSeries("2x3").getData(4, 1),
                          TimeSeriesSet::RankTooBig,
                          checkMessage(
                            "TS set '2x3' : TS number 4 exceeds TS set's number of columns (3)"));
    BOOST_CHECK_EXCEPTION(auto _ = repo.getDataSeries("2x3").getData(3, 2),
                          TimeSeriesSet::HourTooBig,
...
BOOST_AUTO_TEST_CASE(three_small_files)
{
    ...
    BOOST_CHECK_EXCEPTION(
      auto _ = repo.getDataSeries("gen2_p_max").getData(2, 0),
      TimeSeriesSet::RankTooBig,
      checkMessage("TS set 'gen2_p_max' : TS number 2 exceeds TS set's number of columns (1)"));
    BOOST_CHECK_EXCEPTION(auto _ = repo.getDataSeries("gen2_p_max").getData(1, 4),
                          TimeSeriesSet::HourTooBig,
    ...
    BOOST_CHECK_EXCEPTION(
      auto _ = repo.getDataSeries("node1_load").getData(3, 0),
      TimeSeriesSet::RankTooBig,
      checkMessage("TS set 'node1_load' : TS number 3 exceeds TS set's number of columns (2)"));
    BOOST_CHECK_EXCEPTION(auto _ = repo.getDataSeries("node1_load").getData(1, 4),
                          TimeSeriesSet::HourTooBig,
