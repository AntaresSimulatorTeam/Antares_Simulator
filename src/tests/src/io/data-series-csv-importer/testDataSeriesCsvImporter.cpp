...
BOOST_AUTO_TEST_CASE(one_line_one_column)
{
    ...
    BOOST_CHECK_EXCEPTION(repo.getDataSeries("one").getData(2, 0),
                          ...
                          checkMessage("TS set 'one' : rank 2 exceeds TS set's width"));
...
BOOST_AUTO_TEST_CASE(one_line_two_columns)
{
    ...
    BOOST_CHECK_EXCEPTION(repo.getDataSeries("one_by_two").getData(3, 0),
                          TimeSeriesSet::RankTooBig,
                          checkMessage("TS set 'one_by_two' : rank 3 exceeds TS set's width"));
...
BOOST_AUTO_TEST_CASE(two_lines_one_column)
{
    ...
    BOOST_CHECK_EXCEPTION(repo.getDataSeries("two_by_one").getData(2, 0),
                          TimeSeriesSet::RankTooBig,
                          checkMessage("TS set 'two_by_one' : rank 2 exceeds TS set's width"));
...
BOOST_AUTO_TEST_CASE(two_lines_two_columns)
{
    ...
    BOOST_CHECK_EXCEPTION(repo.getDataSeries("two_by_two").getData(3, 1),
                          TimeSeriesSet::RankTooBig,
                          checkMessage("TS set 'two_by_two' : rank 3 exceeds TS set's width"));
...
BOOST_AUTO_TEST_CASE(two_lines_three_columns_three_separators)
{
    ...
    BOOST_CHECK_EXCEPTION(repo.getDataSeries("2x3").getData(4, 1),
                          TimeSeriesSet::RankTooBig,
                          checkMessage("TS set '2x3' : rank 4 exceeds TS set's width"));
...
BOOST_AUTO_TEST_CASE(three_small_files)
{
    ...
    BOOST_CHECK_EXCEPTION(repo.getDataSeries("gen1_p_max").getData(5, 0),
                          TimeSeriesSet::RankTooBig,
                          checkMessage("TS set 'gen1_p_max' : rank 5 exceeds TS set's width"));
    ...
    BOOST_CHECK_EXCEPTION(repo.getDataSeries("gen2_p_max").getData(2, 0),
                          TimeSeriesSet::RankTooBig,
                          checkMessage("TS set 'gen2_p_max' : rank 2 exceeds TS set's width"));
    ...
    BOOST_CHECK_EXCEPTION(repo.getDataSeries("node1_load").getData(3, 0),
                          TimeSeriesSet::RankTooBig,
                          checkMessage("TS set 'node1_load' : rank 3 exceeds TS set's width"));
