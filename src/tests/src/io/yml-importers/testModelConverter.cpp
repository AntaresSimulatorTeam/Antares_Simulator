...
BOOST_FIXTURE_TEST_CASE(model_with_one_objective_properly_translated, Fixture)
{
    YmlModel::Model model1{.id = "model1",
                           ...
                           .constraints = {},
                           .binding_constraints = {},
                            .objectives = {{"objective-id", "param1", 0, "subproblems"}},
                           .extra_outputs = {}};
...
BOOST_FIXTURE_TEST_CASE(model_variables_properly_translated, Fixture)
{
    YmlModel::Model model1{
      ...
      .variables = {{"var1", "7", 0, "pmax", 0, ValueType::BOOL, true, true, "master"},
                    {"var2", "999.99", 0, "var1", 0, ValueType::INTEGER, true, true, "subproblems"}},
      .ports = {},
      .port_field_definitions = {},
      .constraints = {},
      .binding_constraints = {},
       .objectives = {{"objective-id", "var1", 0, "subproblems"}},
      .extra_outputs = {}};
    library.models = {model1};
    SystemModel::Library lib = ModelConverter::convert(library);
    auto& model = lib.Models().at("model1");
...
BOOST_FIXTURE_TEST_CASE(wrong_value_type, Fixture)
{
    YmlModel::Model model1{
      ...
      .description = "description",
      .parameters = {{"param1", true, false}, {"param2", false, false}},
      .variables = {{"varP", "7", 0, "param2", 0, static_cast<ValueType>(5), true, true, "master"}},
      .ports = {},
      .port_field_definitions = {},
      .constraints = {},
      .binding_constraints = {},
...
BOOST_FIXTURE_TEST_CASE(model_constraints_properly_translated, Fixture)
{
    YmlModel::Model model1{
      ...
      .ports = {},
      .port_field_definitions = {},
      .constraints = {{"constraint1", "expression1", 0, "subproblems", ""},
                      {"constraint2", "expression2", 0, "master-and-subproblems", ""}},
      .binding_constraints = {{"constraint3", "expression3", 0, "master", ""}},
      .objectives = {},
      .extra_outputs = {}};
    library.models = {model1};
    SystemModel::Library lib = ModelConverter::convert(library);
...
BOOST_FIXTURE_TEST_CASE(multiple_models_properly_translated, Fixture)
{
    ...
    YmlModel::Model ymlModel_2{
      ...
      .description = "description",
      .parameters = {},
      .variables = {{"var1", "7", 0, "8", 0, ValueType::BOOL, true, true, "master"},
                    {"var2", "9999.9", 0, "var1", 0, ValueType::INTEGER, true, true, "subproblems"}},
      .ports = {},
      .port_field_definitions = {},
      .constraints = {},
      .binding_constraints = {},
...
BOOST_FIXTURE_TEST_CASE(model_port_field_definitions_properly_translated, Fixture)
{
    ...
    YmlModel::Model model1{.id = "model1",
                           ...
                           .variables = {},
                           .ports = {{"port1", "flow"}},
                            .port_field_definitions = {{"port1", "field1", "param1", 0}},
                           .constraints = {},
                           .binding_constraints = {},
                           .objectives = {},
                           .extra_outputs = {}};
...
BOOST_FIXTURE_TEST_CASE(port_fields_definitions_forbid_usage_of_sum_connections, Fixture)
{
    ...
    YmlModel::Model model{
      ...
      .port_field_definitions = {{"port", "field", "sum_connections(port.field)", 0}},
      .constraints = {},
      .binding_constraints = {},
      .objectives = {},
      .extra_outputs = {}};
...
BOOST_FIXTURE_TEST_CASE(in_port_fields_definitions__min_operator_accepts_a_variable, Fixture)
{
    ...
    Variable spillage = {"spillage", "0", 0, "100", 0, ValueType::CONTINUOUS, true, true, location};
    Variable ens = {"ens", "0", 0, "100", 0, ValueType::CONTINUOUS, true, true, location};
    ...
    YmlModel::Model model{.id = "my-model",
                          ...
                          .ports = {{"port", "my-port-type"}},
                           .port_field_definitions = {{"port", "field", "min(spillage, ens)", 0}},
                          .constraints = {},
                          .binding_constraints = {},
                          .objectives = {},
                          .extra_outputs = {}};
...
BOOST_FIXTURE_TEST_CASE(port_field_definition_error_cases, Fixture)
{
    ...
    YmlModel::Model model1{.id = "model1",
                           ...
                           .variables = {},
                           .ports = {{"port1", "flow"}},
                            .port_field_definitions = {{"port2", "field1", "param1", 0}},
                           .constraints = {},
                           .binding_constraints = {},
                           .objectives = {},
                           .extra_outputs = {}};
    ...
    YmlModel::Model model2{.id = "model2",
                           ...
                           .variables = {},
                           .ports = {{"port2", "flow"}},
                            .port_field_definitions = {{"port2", "field2", "param2", 0}},
                           .constraints = {},
                           .binding_constraints = {},
                           .objectives = {},
                           .extra_outputs = {}};
    ...
    YmlModel::Model model3{.id = "model3",
                           ...
                           .ports = {{"port3", "flow"}, {"port4", "flow"}},
                            .port_field_definitions = {{"port4", "field1", "port3.field1", 0},
                                                       {"port3", "field1", "", 0}},
                           .constraints = {},
                           .binding_constraints = {},
                           .objectives = {},
...
BOOST_FIXTURE_TEST_CASE(model_extra_outputs_properly_translated, Fixture)
{
    YmlModel::Model model1{
      ...
      .description = "description",
      .parameters = {{"param1", true, false}},
      .variables = {{"var1", "7", 0, "8", 0, ValueType::CONTINUOUS, true, true, "subproblems"}},
      .ports = {},
      .port_field_definitions = {},
      .constraints = {},
      .binding_constraints = {},
      .objectives = {},
      .extra_outputs = {{"output1", "5 * param1", 0}, {"output2", "param1 / var1 * 95.4", 0}}};
