...
BOOST_AUTO_TEST_CASE(identifier)
{
    YmlModel::Model model{.id = "model0",
                          ...
                          .parameters = {{"param1", true, false}, {"param2", false, false}},
                           ...
                           .constraints = {},
                           .binding_constraints = {},
                           .objectives = {{"objective-id", {.expression = ""}, "test.yaml"}},
                          .extra_outputs = {},
                          .filename = ""};
...
BOOST_AUTO_TEST_CASE(portfield)
{
    YmlModel::Model model{.id = "model0",
                          ...
                          .ports = {{.id = "port1", .type = "blue"}},
                           .port_field_definitions = {{"port1", "field1", {.expression = ""}}},
                          .constraints = {},
                          .binding_constraints = {},
                           .objectives = {{"objective-id", {.expression = ""}, "test.yaml"}},
                          .extra_outputs = {},
...
struct SupplyModelForDualOperator
{
    YmlModel::Model model{.id = "model0",
                          ...
                          .ports = {},
                          .port_field_definitions = {},
                           .constraints = {{"constraintA", {.expression = ""}, "test.yaml", ""}},
                           .binding_constraints = {{"constraintB", {.expression = ""}, "test.yaml", ""}},
                           .objectives = {{"objective-id", {.expression = ""}, "test.yaml"}},
                          .extra_outputs = {},
                          .filename = ""};
};
