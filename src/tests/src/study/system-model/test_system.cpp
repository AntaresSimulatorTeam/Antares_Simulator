...
{
    return {.id = "x",
            .lower_bound = {.expression = "2", .metadata = {}},
            .upper_bound = {.expression = "4", .metadata = {}},
...
static Model createModelWith2PortsOneWayExchange()
{
    ...
    YmlModel::Model ymlmodel{.id = "model1",
                             ...
                             .variables = {var},
                             .ports = {},
                             .port_field_definitions = {{"port1", "field", {.expression = var.id, .metadata = {}}}},
                             .constraints = {},
                             .binding_constraints = {},
                             .objectives = {},
                             .extra_outputs = {},
...
static Model createModelWith2Ports2WayExchange()
{
    ...
    YmlModel::Model ymlmodel{.id = "model1",
                             ...
                             .variables = {var},
                             .ports = {},
                             .port_field_definitions = {{"port1", "rice", {.expression = var.id, .metadata = {}}},
                                                        {"port2", "corn", {.expression = p.id, .metadata = {}}}},
                             .constraints = {},
                             .binding_constraints = {},
                             .objectives = {},
                             .extra_outputs = {},
