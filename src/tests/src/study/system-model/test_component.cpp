...
// BOOST_AUTO_TEST_CASE(handle_area_connections)
// {
...
//
//     // port with no area-connection field ID defined
//     Port portNoAC("portNoAC", portTypeWithoutAreaConnection);
//     // port with an area-connection field ID defined, but port field will not be defined in model
//     Port portACNoDef("portACNoDef", portTypeWithAreaConnection);
//     // port with an area-connection field ID defined, and field will be defined in the model
...
//                    .withPorts({portNoAC, portACNoDef, portACDef})
...
//
//     // Fail if trying to connect an area to a port with no area-connection field id defined
//     BOOST_CHECK_EXCEPTION(
...
//     BOOST_CHECK_EQUAL(component.areaConnectedToPort("portNoAC").has_value(), false);
//
//     // Fail if trying to connect an area to a port field that is not defined in the model
//     BOOST_CHECK_EXCEPTION(
...
//     BOOST_CHECK_EQUAL(component.areaConnectedToPort("portACNoDef").has_value(), false);
//
//     // Succeed when connecting an area to a port field with an area-connection field, and a
//     // port-field definition existing in the model
...
//
//     // Fail when trying to connect to an extra area
