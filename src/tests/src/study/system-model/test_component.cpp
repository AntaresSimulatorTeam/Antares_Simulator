...
BOOST_AUTO_TEST_CASE(fail_when_connecting_area_to_unexisting_port)
{
    ...
    BOOST_CHECK(component.areaConnectionPerPort().empty());
}
...
BOOST_AUTO_TEST_CASE(successfully_connect_area_to_port)
{
    ...
    BOOST_CHECK_EQUAL(component.areaConnectionPerPort().size(), 1);
    BOOST_CHECK_EQUAL(component.areaConnectionPerPort().at("portACDef"), "area1");
