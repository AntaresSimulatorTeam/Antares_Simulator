...
//                           std::invalid_argument,
//                           checkMessage("Parameter 'param1' not found in component
//                           'component2'"));
...
//                           std::invalid_argument,
//                           checkMessage(
//                             "The component \"component\" has 0 parameter(s), but its model has
//                             2"));
// }
//
...
//                           std::invalid_argument,
//                           checkMessage(
//                             "The component \"component\" has 1 parameter(s), but its model has
//                             2"));
// }
//
...
//                           std::invalid_argument,
//                           checkMessage(
//                             "The component \"component\" has 3 parameter(s), but its model has
//                             2"));
// }
//
