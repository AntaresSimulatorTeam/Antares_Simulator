...
public:
    ...
    void addObjectives(ILinearProblem& pb, const FillContext& ctx) override;
...
void OneVarFiller::addObjectives(ILinearProblem& pb, [[maybe_unused]] const FillContext& ctx)
{
