...
void Balance::addVariables(LinearProblem *problem, LinearProblemData *data)
{
    // nothing to do
}
...
void Balance::addObjective(Antares::optim::api::LinearProblem *problem, Antares::optim::api::LinearProblemData *data)
{
    // nothing to do
}

void Balance::update(Antares::optim::api::LinearProblem *problem, Antares::optim::api::LinearProblemData *data)
{
    // nothing to do
}
