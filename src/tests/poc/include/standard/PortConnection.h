...
public:
    PortConnection(ComponentAndPort componentAndPort1, ComponentAndPort componentAndPort2) :
     componentAndPort1(componentAndPort1), componentAndPort2(componentAndPort2)
    {
    }
    [[nodiscard]] const ComponentAndPort& getComponentAndPort1() const
    {
        return componentAndPort1;
    }
    [[nodiscard]] const ComponentAndPort& getComponentAndPort2() const
    {
        return componentAndPort2;
    }
};
...
public:
    ...
    {
        connections.emplace_back(componentAndPort1, componentAndPort2);
    }
