Feature: tests for v9.2
  ...
  And in area "AREA", week 1, year 1, daily mingens for group "HARD COAL" are 10, 30, 50, 50, 40, 30, 20
  # area : AREA 2
  ...
  And in area "AREA 2", week 1, year 1, daily mingens for group "GAS" are 20, 60, 100, 100, 80, 60, 40
  And in area "AREA 2", week 1, year 1, daily mingens for group "HARD COAL" are 1, 3, 5, 5, 4, 3, 2
  # area : AREA 3
