...
# On ajoute donc dans l'étude un cluster qui a des contraintes de rampes thermiques à la hausse et à la baisse, mais on désactive les rampes. Ces dernières ne doivent pas être prises en compte dans l'optimisation
  Scenario: ramping_1_disabled
    ...
    And in area "area", during year 1, hourly production of "thermal_1" for hour 16 is equal to 50 MWh
    And in area "area", during year 1, hourly production of "thermal_1" for hour 23 is equal to 50 MWh
    And in area "area", during year 1, hourly production of "thermal_1" for hour 24 is equal to 70 MWh
    And in area "area", during year 1, hourly production of "thermal_1" for hour 31 is equal to 70 MWh
    And in area "area", during year 1, hourly production of "thermal_1" for hour 32 is equal to 100 MWh
    ...
    And the annual system cost is 5.06784e+07
...
# On a donc dans l'étude un cluster qui a des contraintes de rampes thermiques à la hausse et à la baisse, et on vérifie qu'elles ne sont pas dépassées
  Scenario: ramping_1_enabled
    ...
    And in area "area", during year 1, hourly production of "thermal_1" for hour 16 is equal to 50 MWh
    And in area "area", during year 1, hourly production of "thermal_1" for hour 23 is equal to 50 MWh
    And in area "area", during year 1, hourly production of "thermal_1" for hour 24 is equal to 54 MWh
    And in area "area", during year 1, hourly production of "thermal_1" for hour 25 is equal to 58 MWh
    And in area "area", during year 1, hourly production of "thermal_1" for hour 31 is equal to 70 MWh
    And in area "area", during year 1, hourly production of "thermal_1" for hour 32 is equal to 74 MWh
    And in area "area", during year 1, hourly production of "thermal_1" for hour 35 is equal to 86 MWh
    ...
    And in area "area", during year 1, hourly production of "thermal_1" for hour 56 is equal to 74 MWh
    And the annual system cost is 5.09371e+07