...
namespace DBI
{
inline Row::Row(::yn_dbi_adapter& adapter, void* handle) : pAdapter(adapter), pHandle(handle)
{
}

inline Row::Row(const Row& rhs) : pAdapter(rhs.pAdapter), pHandle(rhs.pHandle)
{
}
