...
namespace DBI
{
Transaction::Transaction(Transaction&& other) : pTxHandle(other.pTxHandle)
{
    pChannel.swap(other.pChannel);
    other.pTxHandle = nullHandle;
}

Transaction::Transaction(Yuni::Private::DBI::ConnectorDataPtr& data) : pTxHandle(nullHandle)
{
...
Transaction::Transaction(Yuni::Private::DBI::ChannelPtr& channel) :
 pChannel(channel), pTxHandle(nullHandle)
{
