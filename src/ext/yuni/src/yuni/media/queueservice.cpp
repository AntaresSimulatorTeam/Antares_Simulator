...
QueueService::QueueService() : pReady(false), pMediaLoop(this)
{
...
bool QueueService::Emitters::attach(const AnyString& emitterName, const AnyString& sourceName)
{
...
bool QueueService::Emitters::move(const AnyString& emitterName, const Point3D<>& position)
{
    ThreadingPolicy::MutexLocker locker(*this);
...
bool QueueService::Emitters::move(const AnyString& emitterStr,
