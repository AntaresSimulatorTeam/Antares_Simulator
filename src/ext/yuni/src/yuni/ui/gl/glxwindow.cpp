...
bool GLXWindow::initialize()
{
    ...
    pWindow = XCreateWindow(pDisplay,
                            root,
                            30,
                            30,
                            pWidth,
...
bool GLXWindow::vsync() const
{
    ...
    {
        getSwapIntervalEXT
          = (SwapGetIntervalProto)glXGetProcAddress((const GLubyte*)"glXGetSwapIntervalMESA");
...
void GLXWindow::vsync(bool active)
{
    ...
    if (extensions.find("GLX_SGI_swap_control") != String::npos)
        swapIntervalEXT
          = (SwapIntervalProto)glXGetProcAddress((const GLubyte*)"glXSwapIntervalSGI");
    else
    {
        if (extensions.find("GLX_MESA_swap_control") != String::npos)
            swapIntervalEXT
              = (SwapIntervalProto)glXGetProcAddress((const GLubyte*)"glXSwapIntervalMESA");
    }
