...
namespace Gfx3D
{
const ShaderProgram::Ptr ShaderManager::getFromFiles(const AnyString& vShader,
                                                     const AnyString& fShader)
{
    String fullPath;
...
const ShaderProgram::Ptr ShaderManager::getFromMemory(const AnyString& vsCode,
                                                      const AnyString& fsCode)
{
