...
protected:
    //! Protected empty constructor
    With() : normal(0.0f, 0.0f, 0.0f)
    {
    }

    //! Protected copy constructor
    With(const With& other) : normal(other.normal)
    {
    }
};
...
protected:
    ...
    //! Protected copy constructor
    RGB(const RGB& other) : color(other.color)
    {
    }
};
...
protected:
    ...
    //! Protected copy constructor
    RGBA(const RGBA& other) : color(other.color)
    {
    }
};
...
protected:
    ...
    //! Copy constructor
    UV(const UV& other) : u(other.u), v(other.v)
    {
    }
...
protected:
    //! Protected constructor
    ST3() : s0(0.0f), t0(0.0f), s1(0.0f), t1(0.0f), s2(0.0f), t2(0.0f)
    {
    }

    //! Copy constructor
    ST3(const ST3& other) :
     s0(other.s0), t0(other.t0), s1(other.s1), t1(other.t1), s2(other.s2), t2(other.t2)
    {
    }
...
protected:
    ...
    //! Protected copy constructor
    With(const With& other) : data(other.data)
    {
    }
