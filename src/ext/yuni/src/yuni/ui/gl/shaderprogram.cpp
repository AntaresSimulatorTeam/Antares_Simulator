...
namespace Gfx3D
{
static inline int GetUniformLocation(uint id,
                                     ShaderProgram::LocationCache& cache,
...
ShaderProgram::ShaderProgram() : pID(::glCreateProgram()), pLinked(false)
{
}
...
ShaderProgram::ShaderProgram(const AnyString& vShaderPath, const AnyString& fShaderPath) :
 pID(::glCreateProgram()), pLinked(false)
{
...
void ShaderProgram::bindUniformArray(const AnyString& name,
                                     uint count,
                                     uint components,
...
void ShaderProgram::bindImage(const AnyString& name,
