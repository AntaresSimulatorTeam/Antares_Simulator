...
namespace Gfx3D
{
template<template<class> class NorP,
         template<class>
         class ColP,
         template<class>
         class TexP,
         class UserP>
inline Vertex<NorP, ColP, TexP, UserP>::Vertex() : Yuni::Point3D<float>(0.0f, 0.0f, 0.0f)
{
}
...
inline Vertex<NorP, ColP, TexP, UserP>::Vertex(U x, V y, W z) : Yuni::Point3D<float>(x, y, z)
{
}
...
template<template<class> class NorP,
         ...
         class TexP,
         class UserP>
inline typename Vertex<NorP, ColP, TexP, UserP>::NormalPolicy&
  Vertex<NorP, ColP, TexP, UserP>::normal()
{
...
template<template<class> class NorP,
         ...
         class TexP,
         class UserP>
inline const typename Vertex<NorP, ColP, TexP, UserP>::NormalPolicy&
  Vertex<NorP, ColP, TexP, UserP>::normal() const
{
...
template<template<class> class NorP,
         ...
         class TexP,
         class UserP>
inline typename Vertex<NorP, ColP, TexP, UserP>::ColorPolicy&
  Vertex<NorP, ColP, TexP, UserP>::color()
{
...
template<template<class> class NorP,
         ...
         class TexP,
         class UserP>
inline const typename Vertex<NorP, ColP, TexP, UserP>::ColorPolicy&
  Vertex<NorP, ColP, TexP, UserP>::color() const
{
...
template<template<class> class NorP,
         ...
         class TexP,
         class UserP>
inline typename Vertex<NorP, ColP, TexP, UserP>::TexCoordPolicy&
  Vertex<NorP, ColP, TexP, UserP>::texCoord()
{
...
template<template<class> class NorP,
         ...
         class TexP,
         class UserP>
inline const typename Vertex<NorP, ColP, TexP, UserP>::TexCoordPolicy&
  Vertex<NorP, ColP, TexP, UserP>::texCoord() const
{
...
template<template<class> class NorP,
         ...
         class TexP,
         class UserP>
inline typename Vertex<NorP, ColP, TexP, UserP>::UserDataPolicy&
  Vertex<NorP, ColP, TexP, UserP>::user()
{
...
template<template<class> class NorP,
         ...
         class TexP,
         class UserP>
inline const typename Vertex<NorP, ColP, TexP, UserP>::UserDataPolicy&
  Vertex<NorP, ColP, TexP, UserP>::user() const
{
