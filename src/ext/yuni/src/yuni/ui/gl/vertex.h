...
*/
template<template<class> class NorP = Policy::Normal::With,
...
class Vertex
 : public Yuni::Point3D<float>,
   ...
   public UserP,
   public VertexPadding<sizeof(Yuni::Point3D<float>) + NorP<Vertex<NorP, ColP, TexP, UserP>>::Size
                        + ColP<Vertex<NorP, ColP, TexP, UserP>>::Size
                        + TexP<Vertex<NorP, ColP, TexP, UserP>>::Size + UserP::Size>
{
public:
    //! Full type
    ...
    //! Padding type
    typedef VertexPadding<sizeof(Yuni::Point3D<float>) + NorP<Vertex<NorP, ColP, TexP, UserP>>::Size
                          + ColP<Vertex<NorP, ColP, TexP, UserP>>::Size
                          + TexP<Vertex<NorP, ColP, TexP, UserP>>::Size + UserP::Size>
      PaddingT;
    //! Smart pointer
...
public:
    enum // anonymous
    {
        ...
        DataSize = (sizeof(Yuni::Point3D<float>) + NorP<Vertex<NorP, ColP, TexP, UserP>>::Size
                    + ColP<Vertex<NorP, ColP, TexP, UserP>>::Size
                    + TexP<Vertex<NorP, ColP, TexP, UserP>>::Size + UserP::Size),
