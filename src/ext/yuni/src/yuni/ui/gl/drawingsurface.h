...
public:
    ...
    void drawText(const String& text,
                  ...
                  float y,
                  uint tabWidth = 4u,
                  bool drawOnBaseline = false);

    //! Draw text from a given coordinate with a given background color
    void drawTextOnColor(const String& text,
                         const FTFont::Ptr& font,
                         const Color::RGBA<float>& color,
    ...
    void drawTextInRect(const String& text,
                        const FTFont::Ptr& font,
                        const Color::RGBA<float>& color,
                        float x,
                        float y,
    ...
    void drawTextOnColorInRect(const String& text,
                               const FTFont::Ptr& font,
                               const Color::RGBA<float>& color,
                               const Color::RGBA<float>& backColor,
                               float x,
    ...
    void drawLine(const Color::RGBA<float>& color,
                  float startX,
                  float startY,
                  float endX,
                  float endY,
    ...
    **
    ** \warning `imageOpacity` is used only for the image, the alpha from `fillColor` is used for
    *out of bounds opacity
    */
    void drawImage(const Gfx3D::Texture::Ptr& texture,
                   float x,
                   float y,
                   float width,
                   float height,
