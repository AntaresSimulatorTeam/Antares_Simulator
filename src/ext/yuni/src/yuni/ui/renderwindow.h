...
public:
    ...
    */
    ...
    {
        return pFB.initialize(Gfx3D::FrameBuffer::fbPingPong, pMultiSampling);
    }
    ...
    */
    ...
    uint samplingMultiplier() const
    {
        return MultiSampling::Multiplier(pMultiSampling);
    }
