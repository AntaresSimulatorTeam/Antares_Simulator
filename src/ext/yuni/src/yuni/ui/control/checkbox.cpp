...
void CheckBox::draw(DrawingSurface::Ptr& surface, float xOffset, float yOffset) const
{
    ...
    // Draw the check box
    surface->drawFilledRectangle(theme.borderColor,
                                 theme.buttonColor,
                                 pos.x,
                                 pos.y,
                                 theme.checkBoxSize,
    ...
    if (pChecked)
    {
        surface->drawLine(theme.borderColor,
                          theme.buttonColor,
                          pos.x,
                          pos.y,
                          pos.x + theme.checkBoxSize,
                          pos.y + theme.checkBoxSize,
                          theme.borderWidth);
        surface->drawLine(theme.borderColor,
                          theme.buttonColor,
                          pos.x + theme.checkBoxSize,
    ...
    // Draw the label
    surface->drawText(
      pText, theme.font, theme.textColor, pos.x + theme.checkBoxSize + theme.margin, pos.y);
    pModified = false;
}
