...
template<bool DetachedT>
inline Flow IIterator<DetachedT>::onBeginFolder(const String&, const String&, const String&)
{
    return flowContinue; // Do nothing
}

template<bool DetachedT>
inline void IIterator<DetachedT>::onEndFolder(const String&, const String&, const String&)
{
    // Do nothing
}
...
template<bool DetachedT>
inline Flow IIterator<DetachedT>::onError(const String&)
{
    return flowContinue; // Do nothing
}

template<bool DetachedT>
inline Flow IIterator<DetachedT>::onAccessError(const String&)
{
    return flowContinue;
}
