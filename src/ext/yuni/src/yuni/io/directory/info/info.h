...
#include "iterator.inc.hpp"
    ...
    //! The default iterator, for recursively iterating through all files and folders within a
    //! directory
    ...
    //! The default iterator, for iterating through all folders within a directory
    typedef Yuni::IIterator<Model::Iterator<itFolder | itRecursive>, true>
      recursive_folder_iterator;
