    ...
    if (catchfolder)
    {
        if (recursive)
        {
            ...
            for (String::Vector::const_iterator i = directories.begin(); i != end; ++i)
            {
                ...
                for (IO::Directory::Info::recursive_iterator it = info.recursive_begin();
                     it != itend;
                     ++it)
                {
    ...
    else
    {
        if (recursive)
        {
            ...
            for (String::Vector::const_iterator i = directories.begin(); i != end; ++i)
            {
                ...
                for (IO::Directory::Info::recursive_file_iterator it = info.recursive_file_begin();
                     it != itend;
                     ++it)
                {
                    // Checking for the prefix
