...
const uint64 sizeHardLimit = 85899345920u; // 80Mo = 80 * 1024 * 1024 * 1024
...
** \param[out] size The size (in bytes) of the file. The value is guaranteed to be set (null) is an
*error has occured
...
**
** If the file size is greater than \p hardlimit, the content will be truncated (see
*'errMemoryLimit').
