...
public:
    ...
    */
    ...
    /*!
    ** \brief Set the position indicator associated with the currently opened file from the
    ...
    */
    ...
    /*!
    ** \brief Set the position indicator associated with the currently opened file from the end of
    *the file
    **
    ** \param offset A relative offset
    ** \return True if the operation succeeded, False otherwise
    ...
    */
    ...
    bool readline(StringT& buffer, bool trim = true);
