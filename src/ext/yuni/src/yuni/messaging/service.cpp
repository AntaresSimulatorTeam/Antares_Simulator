...
Service::Service() : pState(stStopped), pData(nullptr)
{
...
Net::Error Service::Transports::add(const AnyString& address,
                                    const Net::Port& port,
                                    Transport::ITransport::Ptr transport)
{
    ...
    {
        // The item to insert
        std::pair<Net::HostAddressPort, Messaging::Transport::ITransport::Ptr> item(addrport,
                                                                                    transport);
