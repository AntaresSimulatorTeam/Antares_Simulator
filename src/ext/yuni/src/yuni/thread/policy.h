...
/*!
** \brief Implementation of the Threading Model policy in a multi-threaded environnement (one
*recursive mutex per object)
**
...
public:
    ...
    struct Class
    {
        typedef ObjectLevelLockable<T> Type;
    };
...
protected:
    ...
    template<class>
    friend class MutexExtractor;

}; // class ObjectLevelLockable

/*!
** \brief Implementation of the Threading Model policy in a multi-threaded environnement (one mutex
*per object, not recursive)
** \ingroup Policies
*/
template<class Host>
...
public:
    ...
    struct Class
    {
        typedef ObjectLevelLockableNotRecursive<T> Type;
    };
...
public:
    ...
    struct Class
    {
        typedef ClassLevelLockable<T> Type;
    };
