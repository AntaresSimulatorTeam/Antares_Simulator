...
** \ingroup Threads
*/
class YUNI_DECL Mutex final : public NonMovable<Mutex> // an OS's native mutex must have invariant
                                                       // address and thus can not be moved
{
public:
    /*!
...
template<class T>
Mutex Mutex::ClassLevelLockable<T>::mutex;
