...
public:
    ...
    **
    ** \param timeout The delay in milliseconds to wait. O will only return if the thread should
    *exit
...
private:
    ...
    // There is no portable value to determine if pThreadID is valid or not. We have to use a
    // separate flag
    bool pThreadIDValid;
