...
uint OpenAL::CreateSource(Point3D<> position,
                          Vector3D<> velocity,
                          Vector3D<> direction,
                          float pitch,
                          float gain,
...
bool OpenAL::ModifySource(uint source, float pitch, float gain, bool attenuate, bool loop)
{
    ::alGetError();
...
bool OpenAL::MoveSource(uint source,
