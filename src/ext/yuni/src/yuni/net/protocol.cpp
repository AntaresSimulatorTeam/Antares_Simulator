...
Type SchemeToType(const String& s)
{
    if (!s.empty())
    {
        ...
        {
        case 'f':
            return schemeToType_F(s);
        case 'h':
            return schemeToType_H(s);
        case 'i':
            return schemeToType_I(s);
        case 'k':
            return schemeToType_K(s);
        case 'l':
            return schemeToType_L(s);
        case 'n':
            return schemeToType_N(s);
        case 'p':
            return schemeToType_P(s);
        case 'r':
            return schemeToType_R(s);
        case 's':
            return schemeToType_S(s);
        }
    }
    return unknown;
}
