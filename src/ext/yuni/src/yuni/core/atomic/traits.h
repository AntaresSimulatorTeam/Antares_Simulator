...
struct ThreadingPolicy final
{
    ...
    typedef typename Static::
      If<ThreadSafe, Policy::ObjectLevelLockable<C>, Policy::SingleThreaded<C>>::ResultType Type;
#else
...
struct Operator<32, TP> final
{
    ...
    template<class T>
    static typename Yuni::Atomic::Int<32, TP>::Type Increment(const T& t,
                                                              typename T::ScalarType value)
    {
#ifdef YUNI_OS_WINDOWS
...
struct Operator<64, TP> final
{
    ...
    template<class T>
    static typename Yuni::Atomic::Int<64, TP>::Type Increment(const T& t,
                                                              typename T::ScalarType value)
    {
#ifdef YUNI_OS_WINDOWS
#ifdef YUNI_OS_MINGW32
