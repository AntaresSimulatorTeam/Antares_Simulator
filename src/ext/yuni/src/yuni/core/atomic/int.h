...
*/
template<int Size = 8 * sizeof(void*),
         /* 32 or 64Bits */                                     // Size in Bits of the scalar type
...
public:
    ...
    ** for example.
    */
    typedef typename Private::AtomicImpl::ThreadingPolicy<threadSafe, Int<Size, TP>>::Type
      ThreadingPolicy;
    //! The scalar type
...
private:
    ...
    friend struct Yuni::Private::AtomicImpl::Operator;
