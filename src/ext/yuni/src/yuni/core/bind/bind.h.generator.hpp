...
<% require File.dirname(__FILE__) + '/../../../tools/generators/commons.rb' generator
 = Generator.new() %><%= generator.thisHeaderHasBeenGenerated("bind.h.generator.hpp") %>
  ...
  namespace Yuni
{
    ...
    */
    ...
    <% (0..(generator.argumentCount)).each do | i |
      ...
      */
      template <<
      %= tmpl[0] % >> class YUNI_DECL Bind << %= tmpl[1] % >,
      <%= tmpl[2] %> > final
    {
    public:
        //! The Bind Type
         ...
         */
         static BindType
         FromSymbol(const Yuni::DynamicLibrary::Symbol& symbol);
    ...
    public:
        ...
        */
        template<class C>
        Bind(C * c, R(C::*member)(<%= generator.list(i) %>));
        ...
        */
        template<class U>
        void bind(R(*pointer)(<%= generator.list(i, 'A', "", ", ") %> U),
        ...
        */
        template<class C>
        void bind(C * c, R(C::*member)(<%= generator.list(i) %>));
        ...
        */
        template<class C,
                 ...
                 template<class>
                 class ConsP>
        void bind(const SmartPtr<C, OwspP, ChckP, ConvP, StorP, ConsP>& c,
        ...
        */
        template<class C>
        void bind(const C* c, R (C::*member)(<%= generator.list(i) %>) const);
        ...
        */
        ...
        template<class U>
        bool operator==(const U* object) const;
        //@}
    ...
    private:
        ...
        */
        ...
        template<bool>
        friend struct Yuni::Private::BindImpl::MoveConstructor;
