...
public:
    ...
    typedef typename Static::If<adapter or (0 == expandable and chunkSize > 512),
                                CString<>,
                                CStringType>::RetTrue WritableType;
...
public:
    ...
    ** \return An integer greater than, equal to, or less than 0, according as the string is greater
    *than,
...
public:
    ...
    */
    ...
    CString(const IIterator<ModelT, ConstT>& begin,
    ...
    */
    template<class ModelT, bool ConstT, class ModelT2, bool ConstT2, class StringT>
    void assign(const IIterator<ModelT, ConstT>& begin,
                const IIterator<ModelT2, ConstT2>& end,
                const StringT& separator);
    ...
    */
    template<class ModelT, bool ConstT, class ModelT2, bool ConstT2, class StringT>
    void append(const IIterator<ModelT, ConstT>& begin,
                const IIterator<ModelT2, ConstT2>& end,
                const StringT& separator);
    ...
    */
    template<class StringT>
    void append(const StringT& s, Size size);
    ...
    */
    ...
    template<class U>
    void write(const U& cstr);
    //! \see template<class U> append(const U&, const Size)
    template<class U>
    void write(const U& cstr, Size size);
    ...
    */
    template<class StringT>
    bool insert(Size offset, const StringT& string, Size size);
    ...
    */
    template<class StringT>
    bool prepend(const StringT& string, Size size);
    ...
    */
    template<class StringT>
    void overwriteRight(const StringT& s);
    ...
    */
    template<class StringT>
    void overwriteRight(Size offset, const StringT& s);
    ...
    */
    template<class StringT>
    void overwriteCenter(const StringT& s);
    ...
    */
    template<class StringT>
    void fill(const StringT& pattern);
    ...
    */
    template<class StringT>
    void fill(Size offset, const StringT& pattern);
    ...
    */
    template<class StringT>
    Size find(const StringT& s, Size offset = 0) const;
    ...
    */
    template<class StringT>
    Size ifind(const StringT& s, Size offset = 0) const;
    ...
    */
    template<class StringT>
    Size rfind(const StringT& s, Size offset = npos) const;
    ...
    */
    template<class StringT>
    Size irfind(const StringT& s, Size offset = npos) const;
    ...
    */
    template<class StringT>
    uint indexOf(Size offset, const StringT& s) const;
    ...
    */
    ...
    /*!
    ** \brief Searches the string for any of the characters that are not part of `seq` (case
    *insensitive)
    **
    ** \param sequence List of ASCII characters
    ** \param offset Position of the first character in the string to be taken
    ...
    */
    ...
    bool words(const AnyString& separators,
               const PredicateT& predicate,
               bool keepEmptyElements = true) const;
    ...
    */
    ...
    void split(ListT<UType, Alloc>& out,
               const AnyString& sep,
               bool keepEmptyElements = false,
               bool trimElements = true,
               bool emptyBefore = true) const;
    ...
    */
    ...
    void extractKeyValue(StringT1& key,
                         StringT2& value,
    ...
    */
    template<class StringT>
    void adapt(const StringT& string);
    /*!
    ** \brief Adapt from any known string
    */
    template<class StringT>
    void adapt(const StringT& string, Size length, Size offset);
    //@}
...
private:
    ...
    friend class Private::CStringImpl::From;
    template<class, class>
    friend class Yuni::Extension::CString::Append;
    template<class, class>
    friend class Yuni::Extension::CString::Assign;
    template<class, class>
    friend class Yuni::Extension::CString::Fill;
    template<class, bool>
    friend struct Private::CStringImpl::AdapterAssign;
    template<class, bool>
    friend struct Private::CStringImpl::Consume;
    template<uint, bool>
