...
inline CString<ChunkSizeT, ExpandableT>::CString(const IIterator<ModelT, ConstT>& begin,
...
template<uint ChunkSizeT, bool ExpandableT>
inline CString<ChunkSizeT, ExpandableT>::CString(const CString<ChunkSizeT, ExpandableT>& rhs) :
 AncestorType(rhs)
{
}
...
template<uint ChunkSizeT, bool ExpandableT>
inline CString<ChunkSizeT, ExpandableT>::CString(CString<ChunkSizeT, ExpandableT>&& rhs) :
 AncestorType(rhs)
{
}
#endif
...
template<uint ChunkSizeT, bool ExpandableT>
inline CString<ChunkSizeT, ExpandableT>::CString(size_t n, char c)
{
...
template<uint ChunkSizeT, bool ExpandableT>
inline CString<ChunkSizeT, ExpandableT>::CString(size_t n, unsigned char c)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    // Resizing the buffer to `n`
    resize(n);
...
CString<ChunkSizeT, ExpandableT>::CString(const CString<SizeT, ExpT>& s, Size offset)
{
    ...
    {
        if (not adapter)
            AncestorType::assign(reinterpret_cast<const char* const>(s.c_str()) + offset,
                                 s.size() - offset);
        else
...
template<uint ChunkSizeT, bool ExpandableT>
inline CString<ChunkSizeT, ExpandableT>::CString(const char* const cstring, Size blockSize)
{
    if (not adapter)
...
struct TraitsSelectorAssign final
{
    ...
    {
        string.assign(Traits::CString<U>::Perform(u),
                      Traits::Length<U, typename CStringT::Size>::Value(u));
    };
};

template<>
struct TraitsSelectorAssign<true, true> final
{
    template<class U, class CStringT>
    static inline void Perform(const U& u, CStringT& string)
    {
        string.adapt(Traits::CString<U>::Perform(u),
                     Traits::Length<U, typename CStringT::Size>::Value(u));
    };
};

template<bool AdapterT>
struct TraitsSelectorAssign<false, AdapterT> final
{
    template<class U, class CStringT>
    static inline void Perform(const U& u, CStringT& string)
    {
        ...
        typedef
          typename Static::Remove::Const<typename Static::Remove::RefOnly<U>::Type>::Type UType;
...
struct TraitsSelectorAppend final
{
    ...
    static inline void Perform(const U& u, CStringT& string)
    {
        string.append(Traits::CString<U>::Perform(u),
                      Traits::Length<U, typename CStringT::Size>::Value(u));
    };
};

template<>
struct TraitsSelectorAppend<false> final
{
    template<class U, class CStringT>
    static inline void Perform(const U& u, CStringT& string)
    {
...
struct AppendIterator final
{
    ...
    static void Perform(StringT& s,
                        const IteratorT& begin,
                        const IteratorT2& end,
...
template<uint ChunkSizeT, bool ExpandableT>
template<class U>
inline void CString<ChunkSizeT, ExpandableT>::assign(const U& u)
{
    TraitsSelectorAssign<(Traits::CString<U>::valid and Traits::Length<U>::valid), // Standard
                                                                                   // CString ?
...
template<uint ChunkSizeT, bool ExpandableT>
template<class U>
inline void CString<ChunkSizeT, ExpandableT>::append(const U& u)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    TraitsSelectorAppend<Traits::CString<U>::valid
                         and Traits::Length<U>::valid>::template Perform<U, CStringType>(u, *this);
}

template<uint ChunkSizeT, bool ExpandableT>
template<class ModelT, bool ConstT, class ModelT2, bool ConstT2>
inline void CString<ChunkSizeT, ExpandableT>::assign(const IIterator<ModelT, ConstT>& begin,
                                                     const IIterator<ModelT2, ConstT2>& end)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
...
template<uint ChunkSizeT, bool ExpandableT>
template<class ModelT, bool ConstT, class ModelT2, bool ConstT2>
inline void CString<ChunkSizeT, ExpandableT>::append(const IIterator<ModelT, ConstT>& begin,
                                                     const IIterator<ModelT2, ConstT2>& end)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    typedef typename IIterator<ModelT, ConstT>::value_type HeldType;
...
inline void CString<ChunkSizeT, ExpandableT>::append(const StringT& s, Size size)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
...
template<uint ChunkSizeT, bool ExpandableT>
template<class StringT>
inline void CString<ChunkSizeT, ExpandableT>::append(const StringT& str, Size size, Size offset)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    YUNI_STATIC_ASSERT(Traits::CString<StringT>::valid, CString_InvalidTypeForBuffer);
...
template<uint ChunkSizeT, bool ExpandableT>
template<class U>
inline void CString<ChunkSizeT, ExpandableT>::write(const U& u, Size size)
{
    append(u, size);
}
...
template<uint ChunkSizeT, bool ExpandableT>
template<class U>
inline void CString<ChunkSizeT, ExpandableT>::write(const U& u)
{
    append(u);
}
...
template<uint ChunkSizeT, bool ExpandableT>
template<class U>
inline void CString<ChunkSizeT, ExpandableT>::push_back(const U& u)
{
    append(u);
}
...
template<uint ChunkSizeT, bool ExpandableT>
template<class U>
inline void CString<ChunkSizeT, ExpandableT>::push_front(const U& u)
{
    insert(0, u);
}
...
template<uint ChunkSizeT, bool ExpandableT>
template<class StringT>
inline void CString<ChunkSizeT, ExpandableT>::assign(const StringT& str, Size size)
{
    YUNI_STATIC_ASSERT(Traits::CString<StringT>::valid, CString_InvalidTypeForBuffer);
...
template<uint ChunkSizeT, bool ExpandableT>
template<class StringT>
inline void CString<ChunkSizeT, ExpandableT>::assign(const StringT& str, Size size, Size offset)
{
    YUNI_STATIC_ASSERT(Traits::CString<StringT>::valid, CString_InvalidTypeForBuffer);
...
*/
template<class StringT>
static typename StringT::Size FindEndOfSequence(const char* str,
                                                char quote,
                                                typename StringT::Size maxLen)
{
    if (str)
    {
...
template<uint ChunkSizeT, bool ExpandableT>
void CString<ChunkSizeT, ExpandableT>::assignFromEscapedCharacters(const char* const str,
                                                                   Size maxLen,
                                                                   Size offset)
{
    clear();
    ...
    for (Size i = offset; i < maxLen; ++i, ++retPos)
    {
        if ('\\' == str[i] and i + 1 != maxLen)
        {
            ...
            {
            case 'r':
                AncestorType::data[retPos] = '\r';
                break;
            case 'n':
                AncestorType::data[retPos] = '\n';
                break;
            case '\\':
                AncestorType::data[retPos] = '\\';
                break;
            case ';':
                ...
                break;
            case 'a':
                AncestorType::data[retPos] = '\a';
                break;
            case 'f':
                AncestorType::data[retPos] = '\f';
                break;
            case 't':
                AncestorType::data[retPos] = '\t';
                break;
...
template<uint ChunkSizeT, bool ExpandableT>
inline void CString<ChunkSizeT, ExpandableT>::reserve(Size minCapacity)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
...
template<uint ChunkSizeT, bool ExpandableT>
inline void CString<ChunkSizeT, ExpandableT>::put(char c)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    AncestorType::put(c);
}
...
template<uint ChunkSizeT, bool ExpandableT>
inline void CString<ChunkSizeT, ExpandableT>::put(const unsigned char c)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
...
template<uint ChunkSizeT, bool ExpandableT>
template<class U>
inline void CString<ChunkSizeT, ExpandableT>::put(const U& rhs)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    append(rhs);
}
...
void CString<ChunkSizeT, ExpandableT>::fill(const StringT& pattern)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    typedef
      typename Static::Remove::Const<typename Static::Remove::RefOnly<StringT>::Type>::Type UType;
    YUNI_STATIC_ASSERT(Traits::Length<StringT>::valid, CString_InvalidTypeForBufferSize);

    if (AncestorType::size)
    {
        Yuni::Extension::CString::Fill<CString, UType>::Perform(
...
void CString<ChunkSizeT, ExpandableT>::fill(Size offset, const StringT& pattern)
{
    ...
    {
        Yuni::Extension::CString::Fill<CString, UType>::Perform(
          AncestorType::data + offset, AncestorType::size - offset, pattern);
    }
}

template<uint ChunkSizeT, bool ExpandableT>
bool CString<ChunkSizeT, ExpandableT>::hasChar(char c) const
{
...
template<uint ChunkSizeT, bool ExpandableT>
uint CString<ChunkSizeT, ExpandableT>::countChar(char c) const
{
    uint r = 0;
    for (Size i = 0; i != AncestorType::size; ++i)
    {
...
template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::hasChar(unsigned char c) const
{
    return hasChar(static_cast<char>(c));
}

template<uint ChunkSizeT, bool ExpandableT>
typename CString<ChunkSizeT, ExpandableT>::Size CString<ChunkSizeT, ExpandableT>::find(char c) const
{
    return find(c, 0);
}

template<uint ChunkSizeT, bool ExpandableT>
typename CString<ChunkSizeT, ExpandableT>::Size CString<ChunkSizeT, ExpandableT>::find(
  char c,
  Size offset) const
{
    if (offset < AncestorType::size)
...
template<uint ChunkSizeT, bool ExpandableT>
template<class StringT>
inline typename CString<ChunkSizeT, ExpandableT>::Size CString<ChunkSizeT, ExpandableT>::find(
  const StringT& s,
  Size offset) const
{
    YUNI_STATIC_ASSERT(Traits::CString<StringT>::valid, CString_InvalidTypeForBuffer);
    ...
    if (Traits::Length<StringT, Size>::isFixed)
    {
        ...
        return find(
          Traits::CString<StringT>::Perform(s), offset, Traits::Length<StringT, Size>::fixedLength);
    }
    // A mere CString, with a known length at runtime only
    return find(
      Traits::CString<StringT>::Perform(s), offset, Traits::Length<StringT, Size>::Value(s));
}

template<uint ChunkSizeT, bool ExpandableT>
typename CString<ChunkSizeT, ExpandableT>::Size CString<ChunkSizeT, ExpandableT>::ifind(
  char c) const
{
...
template<uint ChunkSizeT, bool ExpandableT>
template<class StringT>
inline typename CString<ChunkSizeT, ExpandableT>::Size CString<ChunkSizeT, ExpandableT>::ifind(
  const StringT& s,
  Size offset) const
{
    YUNI_STATIC_ASSERT(Traits::CString<StringT>::valid, CString_InvalidTypeForBuffer);
...
template<uint ChunkSizeT, bool ExpandableT>
typename CString<ChunkSizeT, ExpandableT>::Size CString<ChunkSizeT, ExpandableT>::rfind(
  char c) const
{
...
template<uint ChunkSizeT, bool ExpandableT>
template<class StringT>
inline typename CString<ChunkSizeT, ExpandableT>::Size CString<ChunkSizeT, ExpandableT>::rfind(
  const StringT& s,
  Size offset) const
{
    YUNI_STATIC_ASSERT(Traits::CString<StringT>::valid, CString_InvalidTypeForBuffer);
...
template<uint ChunkSizeT, bool ExpandableT>
typename CString<ChunkSizeT, ExpandableT>::Size CString<ChunkSizeT, ExpandableT>::irfind(
  char c) const
{
    c = static_cast<char>(ToLower(c));
    Size i = AncestorType::size;
...
template<uint ChunkSizeT, bool ExpandableT>
template<class StringT>
inline typename CString<ChunkSizeT, ExpandableT>::Size CString<ChunkSizeT, ExpandableT>::irfind(
  const StringT& s,
  Size offset) const
{
    YUNI_STATIC_ASSERT(Traits::CString<StringT>::valid, CString_InvalidTypeForBuffer);
...
template<uint ChunkSizeT, bool ExpandableT>
bool CString<ChunkSizeT, ExpandableT>::contains(char c) const
{
...
template<uint ChunkSizeT, bool ExpandableT>
bool CString<ChunkSizeT, ExpandableT>::contains(const char* const cstr, Size len) const
{
...
template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::contains(const AnyString& string) const
{
    return contains(string.c_str(), string.size());
}

template<uint ChunkSizeT, bool ExpandableT>
bool CString<ChunkSizeT, ExpandableT>::icontains(char c) const
{
    c = static_cast<char>(ToLower(c));
    for (Size i = 0; i != AncestorType::size; ++i)
    {
...
template<uint ChunkSizeT, bool ExpandableT>
bool CString<ChunkSizeT, ExpandableT>::icontains(const char* const cstr, Size len) const
{
    if (cstr and len and len <= AncestorType::size)
    {
        Size end = AncestorType::size - len + 1;
...
template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::icontains(const AnyString& string) const
{
    return icontains(string.c_str(), string.size());
}

template<uint ChunkSizeT, bool ExpandableT>
uint CString<ChunkSizeT, ExpandableT>::indexOf(Size offset, char c) const
{
...
template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::startsWith(const char* const cstr, Size len) const
{
...
template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::startsWith(const AnyString& string) const
{
...
template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::startsWith(char c) const
{
    return (0 != AncestorType::size) and (AncestorType::data[0] == c);
}

template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::istartsWith(const char* const cstr, Size len) const
{
    if (cstr and len and len <= AncestorType::size)
    {
...
template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::istartsWith(const AnyString& string) const
{
    return istartsWith(string.c_str(), string.size());
}

template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::istartsWith(char c) const
{
    return (0 != AncestorType::size) and (ToLower(AncestorType::data[0]) == ToLower(c));
}

template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::endsWith(const char* const cstr, Size len) const
{
    return (cstr and len and len <= AncestorType::size)
...
template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::endsWith(const AnyString& string) const
{
    return endsWith(string.c_str(), string.size());
}

template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::endsWith(char c) const
{
    return (0 != AncestorType::size) and (AncestorType::data[AncestorType::size - 1] == c);
}

template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::iendsWith(const char* const cstr, Size len) const
{
    if (cstr and len and len <= AncestorType::size)
    {
        uint offset = 0;
...
template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::iendsWith(const AnyString& string) const
{
    return endsWith(string.c_str(), string.size());
}

template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::iendsWith(char c) const
{
    return (0 != AncestorType::size)
           and (ToLower(AncestorType::data[AncestorType::size - 1]) == ToLower(c));
}

template<uint ChunkSizeT, bool ExpandableT>
inline void CString<ChunkSizeT, ExpandableT>::removeLast()
{
    if (AncestorType::size != 0)
    {
        --(AncestorType::size);
        if (zeroTerminated)
            Yuni::Private::CStringImpl::FinalZero<adapter>::Set(AncestorType::data,
                                                                AncestorType::size);
    }
}

template<uint ChunkSizeT, bool ExpandableT>
inline void CString<ChunkSizeT, ExpandableT>::removeTrailingSlash()
{
    if (AncestorType::size != 0)
    {
        if (('/' == AncestorType::data[AncestorType::size - 1]
             or '\\' == AncestorType::data[AncestorType::size - 1]))
            resize(AncestorType::size - 1);
    }
}

template<uint ChunkSizeT, bool ExpandableT>
inline void CString<ChunkSizeT, ExpandableT>::chop(uint n)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
...
template<uint ChunkSizeT, bool ExpandableT>
bool CString<ChunkSizeT, ExpandableT>::glob(const AnyString& pattern) const
{
    // TODO This method should be completly removed
    return Yuni::Private::CStringImpl::Glob(
      AncestorType::data, AncestorType::size, pattern.c_str(), pattern.size());
}

template<uint ChunkSizeT, bool ExpandableT>
uint CString<ChunkSizeT, ExpandableT>::indexOf(Size offset, const char* const cstr, Size len) const
{
    if (cstr and len and len <= AncestorType::size)
    {
        Size end = AncestorType::size - len + 1;
...
template<uint ChunkSizeT, bool ExpandableT>
template<class StringT>
uint CString<ChunkSizeT, ExpandableT>::indexOf(Size offset, const StringT& s) const
{
    YUNI_STATIC_ASSERT(Traits::CString<StringT>::valid, CString_InvalidTypeForBuffer);
    YUNI_STATIC_ASSERT(Traits::Length<StringT>::valid, CString_InvalidTypeForBufferSize);
    ...
    if (Traits::Length<StringT, Size>::isFixed)
    {
        ...
        // Researching for the substring with a known length
        return indexOf(
          offset, Traits::CString<StringT>::Perform(s), Traits::Length<StringT, Size>::fixedLength);
    }
    // A mere CString, with a known length at runtime only
    return indexOf(
      offset, Traits::CString<StringT>::Perform(s), Traits::Length<StringT, Size>::Value(s));
}
...
template<uint ChunkSizeT, bool ExpandableT>
inline uint CString<ChunkSizeT, ExpandableT>::replace(char from, char to)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    uint count = 0;
    for (Size i = 0; i != AncestorType::size; ++i)
...
template<uint ChunkSizeT, bool ExpandableT>
inline uint CString<ChunkSizeT, ExpandableT>::ireplace(char from, char to)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    uint count = 0;
...
template<uint ChunkSizeT, bool ExpandableT>
inline uint CString<ChunkSizeT, ExpandableT>::replace(Size offset, char from, char to)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    uint count = 0;
    for (Size i = offset; i != AncestorType::size; ++i)
...
template<uint ChunkSizeT, bool ExpandableT>
inline uint CString<ChunkSizeT, ExpandableT>::replace(const AnyString& from, const AnyString& to)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
...
template<uint ChunkSizeT, bool ExpandableT>
inline uint CString<ChunkSizeT, ExpandableT>::ireplace(const AnyString& from, const AnyString& to)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
...
template<uint ChunkSizeT, bool ExpandableT>
uint CString<ChunkSizeT, ExpandableT>::replace(Size offset,
...
template<uint ChunkSizeT, bool ExpandableT>
uint CString<ChunkSizeT, ExpandableT>::ireplace(Size offset,
                                                const AnyString& from,
                                                const AnyString& to)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
...
template<uint ChunkSizeT, bool ExpandableT>
inline uint CString<ChunkSizeT, ExpandableT>::ireplace(Size offset, char from, char to)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    uint count = 0;
    from = static_cast<char>(ToLower(from));
...
template<uint ChunkSizeT, bool ExpandableT>
inline void CString<ChunkSizeT, ExpandableT>::consume(Size n)
{
    if (n)
...
template<uint ChunkSizeT, bool ExpandableT>
template<class U>
inline U CString<ChunkSizeT, ExpandableT>::to() const
{
...
template<uint ChunkSizeT, bool ExpandableT>
template<class U>
inline bool CString<ChunkSizeT, ExpandableT>::to(U& out) const
{
    typedef typename Static::Remove::Const<typename Static::Remove::RefOnly<U>::Type>::Type UType;
...
inline void CString<ChunkSizeT, ExpandableT>::erase(const IIterator<ModelT, ConstT>& it, Size len)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    erase(it.offset(), len);
}
...
template<uint ChunkSizeT, bool ExpandableT>
void CString<ChunkSizeT, ExpandableT>::erase(Size offset, Size len)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    ...
    if (offset < AncestorType::size and len)
    {
        ...
        else
        {
            ...
            (void)::memmove(AncestorType::data + sizeof(Char) * (offset),
                            AncestorType::data + sizeof(Char) * (offset + len),
                            sizeof(Char) * (AncestorType::size - offset - len));
...
template<uint ChunkSizeT, bool ExpandableT>
inline int CString<ChunkSizeT, ExpandableT>::at(Size offset) const
{
...
template<uint ChunkSizeT, bool ExpandableT>
template<class ModelT, bool ConstT>
inline void CString<ChunkSizeT, ExpandableT>::insert(const IIterator<ModelT, ConstT>& it,
...
template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::insert(Size offset, const AnyString& string)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
...
template<uint ChunkSizeT, bool ExpandableT>
template<class StringT>
inline bool CString<ChunkSizeT, ExpandableT>::insert(Size offset, const StringT& string, Size size)
{
...
template<uint ChunkSizeT, bool ExpandableT>
bool CString<ChunkSizeT, ExpandableT>::insert(Size offset, const char* const cstr, Size size)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    if (size > 0)
    {
...
template<uint ChunkSizeT, bool ExpandableT>
bool CString<ChunkSizeT, ExpandableT>::insert(Size offset, char c)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    if (offset >= AncestorType::size)
    {
...
template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::prepend(const AnyString& string)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
...
template<uint ChunkSizeT, bool ExpandableT>
template<class StringT>
inline bool CString<ChunkSizeT, ExpandableT>::prepend(const StringT& string, Size size)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    // do not use AnyString here (libyuni should not try to compute the length
    // of the input string, since it may not be zero-terminated)
...
template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::prepend(const char* const cstr, Size size)
{
    return insert(0, cstr, size);
}

template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::prepend(char c)
{
    return insert(0, c);
}

template<uint ChunkSizeT, bool ExpandableT>
void CString<ChunkSizeT, ExpandableT>::overwrite(Size offset, const char* const cstr, Size size)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    if (offset < AncestorType::size and size)
    {
        if (offset + size > AncestorType::size)
            YUNI_MEMCPY(AncestorType::data + offset,
                        AncestorType::capacity,
                        cstr,
                        sizeof(Char) * (AncestorType::size - offset));
        else
            YUNI_MEMCPY(
              AncestorType::data + offset, AncestorType::capacity, cstr, sizeof(Char) * size);
    }
}

template<uint ChunkSizeT, bool ExpandableT>
inline void CString<ChunkSizeT, ExpandableT>::overwrite(Size offset, const AnyString& string)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
...
template<uint ChunkSizeT, bool ExpandableT>
inline void CString<ChunkSizeT, ExpandableT>::overwrite(const AnyString& string)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
...
template<uint ChunkSizeT, bool ExpandableT>
template<class StringT>
inline void CString<ChunkSizeT, ExpandableT>::overwriteRight(Size offset, const StringT& s)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    YUNI_STATIC_ASSERT(Traits::CString<StringT>::valid, CString_InvalidTypeForBuffer);
    YUNI_STATIC_ASSERT(Traits::Length<StringT>::valid, CString_InvalidTypeForBufferSize);
    ...
    if (Traits::Length<StringT, Size>::isFixed)
    {
        ...
        if (1 == Traits::Length<StringT, Size>::fixedLength)
            return overwrite(
              AncestorType::size - offset - 1, Traits::CString<StringT>::Perform(s), 1);
        // Researching for the substring with a known length
        return overwrite(AncestorType::size - offset - Traits::Length<StringT, Size>::fixedLength,
                         Traits::CString<StringT>::Perform(s),
                         Traits::Length<StringT, Size>::fixedLength);
    }
...
template<uint ChunkSizeT, bool ExpandableT>
template<class StringT>
inline void CString<ChunkSizeT, ExpandableT>::overwriteRight(const StringT& s)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    YUNI_STATIC_ASSERT(Traits::CString<StringT>::valid, CString_InvalidTypeForBuffer);
    YUNI_STATIC_ASSERT(Traits::Length<StringT>::valid, CString_InvalidTypeForBufferSize);
...
template<uint ChunkSizeT, bool ExpandableT>
template<class StringT>
inline void CString<ChunkSizeT, ExpandableT>::overwriteCenter(const StringT& s)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    YUNI_STATIC_ASSERT(Traits::CString<StringT>::valid, CString_InvalidTypeForBuffer);
    YUNI_STATIC_ASSERT(Traits::Length<StringT>::valid, CString_InvalidTypeForBufferSize);
    ...
    if (Traits::Length<StringT, Size>::isFixed)
    {
        ...
        // Researching for the substring with a known length
        return overwrite(
          (AncestorType::size >> 1) - (Traits::Length<StringT, Size>::fixedLength >> 1),
          Traits::CString<StringT>::Perform(s),
          Traits::Length<StringT, Size>::fixedLength);
    }
    ...
    Size len = Traits::Length<StringT, Size>::Value(s);
    return overwrite(
      (AncestorType::size >> 1) - (len >> 1), Traits::CString<StringT>::Perform(s), len);
}

template<uint ChunkSizeT, bool ExpandableT>
void CString<ChunkSizeT, ExpandableT>::truncate(Size newSize)
{
...
template<uint ChunkSizeT, bool ExpandableT>
inline typename CString<ChunkSizeT, ExpandableT>::Size CString<ChunkSizeT, ExpandableT>::utf8size()
  const
{
...
template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::utf8valid() const
{
    uint offset;
...
template<uint ChunkSizeT, bool ExpandableT>
UTF8::Error CString<ChunkSizeT, ExpandableT>::utf8valid(Size& offset) const
{
    offset = 0;
    do
    {
...
template<uint ChunkSizeT, bool ExpandableT>
bool CString<ChunkSizeT, ExpandableT>::utf8validFast() const
{
    uint i = 0;
...
UTF8::Error CString<ChunkSizeT, ExpandableT>::utf8next(Size& offset, UTF8::Char& out) const
{
    if (offset >= AncestorType::size)
    {
        out.reset();
...
template<uint ChunkSizeT, bool ExpandableT>
inline typename CString<ChunkSizeT, ExpandableT>::Size CString<ChunkSizeT, ExpandableT>::size()
  const
{
...
template<uint ChunkSizeT, bool ExpandableT>
inline typename CString<ChunkSizeT, ExpandableT>::Size CString<ChunkSizeT, ExpandableT>::length()
  const
{
    return AncestorType::size;
}
...
template<uint ChunkSizeT, bool ExpandableT>
inline size_t CString<ChunkSizeT, ExpandableT>::sizeInBytes() const
{
    return static_cast<size_t>(AncestorType::size) * sizeof(Char);
}

template<uint ChunkSizeT, bool ExpandableT>
inline typename CString<ChunkSizeT, ExpandableT>::Size CString<ChunkSizeT, ExpandableT>::capacity()
  const
{
...
template<uint ChunkSizeT, bool ExpandableT>
inline size_t CString<ChunkSizeT, ExpandableT>::max_size() const
{
    return static_cast<Size>(-1);
}

template<uint ChunkSizeT, bool ExpandableT>
inline size_t CString<ChunkSizeT, ExpandableT>::capacityInBytes() const
{
    return static_cast<size_t>(AncestorType::capacity) * sizeof(Char);
}

template<uint ChunkSizeT, bool ExpandableT>
inline const char* CString<ChunkSizeT, ExpandableT>::data() const
{
    return AncestorType::data;
}

template<uint ChunkSizeT, bool ExpandableT>
inline char* CString<ChunkSizeT, ExpandableT>::data()
{
    return AncestorType::data;
}

template<uint ChunkSizeT, bool ExpandableT>
inline const char* CString<ChunkSizeT, ExpandableT>::c_str() const
{
    return (not AncestorType::null() ? AncestorType::data : "");
}

template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::empty() const
{
    return (0 == AncestorType::size);
}

template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::null() const
{
    return AncestorType::null();
}

template<uint ChunkSizeT, bool ExpandableT>
inline void CString<ChunkSizeT, ExpandableT>::shrink()
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    AncestorType::shrink();
}
...
template<uint ChunkSizeT, bool ExpandableT>
inline void CString<ChunkSizeT, ExpandableT>::resize(Size len)
{
...
template<uint ChunkSizeT, bool ExpandableT>
void CString<ChunkSizeT, ExpandableT>::resize(Size len, const AnyString& pattern)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
...
template<uint ChunkSizeT, bool ExpandableT>
void CString<ChunkSizeT, ExpandableT>::trimRight(char c)
{
...
template<uint ChunkSizeT, bool ExpandableT>
inline void CString<ChunkSizeT, ExpandableT>::trimLeft()
{
    trimLeft(" \t\r\n");
}

template<uint ChunkSizeT, bool ExpandableT>
inline void CString<ChunkSizeT, ExpandableT>::trimRight()
{
    trimRight(" \t\r\n");
}

template<uint ChunkSizeT, bool ExpandableT>
void CString<ChunkSizeT, ExpandableT>::trimLeft(char c)
{
    if (AncestorType::size > 0)
    {
        Size offset = 0;
...
template<uint ChunkSizeT, bool ExpandableT>
void CString<ChunkSizeT, ExpandableT>::trimRight(const AnyString& whitespaces)
{
...
template<uint ChunkSizeT, bool ExpandableT>
void CString<ChunkSizeT, ExpandableT>::trimLeft(const AnyString& whitespaces)
{
    if (whitespaces.empty() or empty())
        return;
...
template<uint ChunkSizeT, bool ExpandableT>
inline void CString<ChunkSizeT, ExpandableT>::decalOffset(Size count)
{
...
template<uint ChunkSizeT, bool ExpandableT>
inline void CString<ChunkSizeT, ExpandableT>::trim()
{
...
template<uint ChunkSizeT, bool ExpandableT>
inline void CString<ChunkSizeT, ExpandableT>::trim(char c)
{
    // It seems more interesting to trim from the end first, to reduce the size
    // of the cstr as soon as possible and to reduce the amount of data to move
    // if a region must be removed by trimLeft.
...
template<uint ChunkSizeT, bool ExpandableT>
inline void CString<ChunkSizeT, ExpandableT>::trim(const AnyString& whitespaces)
{
    // It seems more interesting to trim from the end first, to reduce the size
    // of the cstr as soon as possible and to reduce the amount of data to move
    // if a region must be removed by trimLeft.
...
template<uint ChunkSizeT, bool ExpandableT>
inline typename CString<ChunkSizeT, ExpandableT>::Size
  CString<ChunkSizeT, ExpandableT>::assignWithoutChecking(const char* const block, Size blockSize)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
...
template<uint ChunkSizeT, bool ExpandableT>
inline typename CString<ChunkSizeT, ExpandableT>::Size
  CString<ChunkSizeT, ExpandableT>::appendWithoutChecking(const char* const block, Size blockSize)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
...
template<uint ChunkSizeT, bool ExpandableT>
CString<ChunkSizeT, ExpandableT>& CString<ChunkSizeT, ExpandableT>::format(const char* format, ...)
{
...
template<uint ChunkSizeT, bool ExpandableT>
CString<ChunkSizeT, ExpandableT>& CString<ChunkSizeT, ExpandableT>::appendFormat(const char* format,
                                                                                 ...)
{
    // warning: 'va_start' has undefined behavior with reference types.
    // Thus AnyString can not be used
...
template<uint ChunkSizeT, bool ExpandableT>
void CString<ChunkSizeT, ExpandableT>::vappendFormat(const char* format, va_list args)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    ...
    if (expandable)
    {
        ...
        do
        {
            ...
            i = Private::CStringImpl::vnsprintf<Char>(AncestorType::data + AncestorType::size,
                                                      (AncestorType::capacity - AncestorType::size),
                                                      format,
                                                      ag);
            va_end(ag);
...
template<uint ChunkSizeT, bool ExpandableT>
CString<ChunkSizeT, ExpandableT>& CString<ChunkSizeT, ExpandableT>::toLower()
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    for (Size i = 0; i < AncestorType::size; ++i)
    {
...
template<uint ChunkSizeT, bool ExpandableT>
CString<ChunkSizeT, ExpandableT>& CString<ChunkSizeT, ExpandableT>::toUpper()
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    for (Size i = 0; i < AncestorType::size; ++i)
    {
...
void CString<ChunkSizeT, ExpandableT>::split(ListT<UType, Alloc>& out,
                                             const AnyString& sep,
                                             bool keepEmptyElements,
                                             bool trimElements,
...
template<uint ChunkSizeT, bool ExpandableT>
inline char CString<ChunkSizeT, ExpandableT>::first() const
{
    return (AncestorType::size) ? AncestorType::data[0] : '\0';
}

template<uint ChunkSizeT, bool ExpandableT>
inline char CString<ChunkSizeT, ExpandableT>::last() const
{
    return (AncestorType::size) ? AncestorType::data[AncestorType::size - 1] : '\0';
}

template<uint ChunkSizeT, bool ExpandableT>
void CString<ChunkSizeT, ExpandableT>::convertSlashesIntoBackslashes()
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    for (uint i = 0; i != AncestorType::size; ++i)
    {
...
template<uint ChunkSizeT, bool ExpandableT>
void CString<ChunkSizeT, ExpandableT>::convertBackslashesIntoSlashes()
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    for (uint i = 0; i != AncestorType::size; ++i)
    {
...
template<uint ChunkSizeT, bool ExpandableT>
void CString<ChunkSizeT, ExpandableT>::duplicate(int n)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
...
template<uint ChunkSizeT, bool ExpandableT>
inline int CString<ChunkSizeT, ExpandableT>::Compare(const char* const s1,
                                                     uint l1,
                                                     const char* const s2,
                                                     uint l2)
{
...
template<uint ChunkSizeT, bool ExpandableT>
inline int CString<ChunkSizeT, ExpandableT>::CompareInsensitive(const char* const s1,
                                                                uint l1,
                                                                const char* const s2,
                                                                uint l2)
{
...
template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::equals(const AnyString& rhs) const
{
    return ((AncestorType::size == rhs.size())
            and (0 == AncestorType::size
                 or Yuni::Private::CStringImpl::Equals(
                   AncestorType::data, rhs.c_str(), AncestorType::size)));
}

template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::equalsInsensitive(const AnyString& rhs) const
{
    return ((AncestorType::size == rhs.size())
            and (0 == AncestorType::size
                 or Yuni::Private::CStringImpl::EqualsInsensitive(
                   AncestorType::data, rhs.c_str(), AncestorType::size)));
}

template<uint ChunkSizeT, bool ExpandableT>
inline int CString<ChunkSizeT, ExpandableT>::compare(const AnyString& rhs) const
{
    return Yuni::Private::CStringImpl::Compare(
      AncestorType::data, AncestorType::size, rhs.c_str(), rhs.size());
}

template<uint ChunkSizeT, bool ExpandableT>
inline int CString<ChunkSizeT, ExpandableT>::compareInsensitive(const AnyString& rhs) const
{
    return Yuni::Private::CStringImpl::CompareInsensitive(
      AncestorType::data, AncestorType::size, rhs.c_str(), rhs.size());
}
...
template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::operator!() const
{
    return !AncestorType::size;
}
...
template<uint ChunkSizeT, bool ExpandableT>
template<class U>
inline CString<ChunkSizeT, ExpandableT>& CString<ChunkSizeT, ExpandableT>::operator+=(const U& rhs)
{
    append(rhs);
    return *this;
}
...
template<uint ChunkSizeT, bool ExpandableT>
inline CString<ChunkSizeT, ExpandableT>& CString<ChunkSizeT, ExpandableT>::operator=(
  const CString<ChunkSizeT, ExpandableT>& rhs)
{
    assign(rhs);
    return *this;
}
...
template<uint ChunkSizeT, bool ExpandableT>
inline CString<ChunkSizeT, ExpandableT>& CString<ChunkSizeT, ExpandableT>::operator=(
  CString<ChunkSizeT, ExpandableT>&& rhs)
{
...
template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::operator<(const AnyString& rhs) const
{
    return Yuni::Private::CStringImpl::Compare(
             AncestorType::data, AncestorType::size, rhs.c_str(), rhs.size())
           < 0;
...
template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::operator==(char rhs) const
{
...
template<uint ChunkSizeT, bool ExpandableT>
CString<ChunkSizeT, ExpandableT>& CString<ChunkSizeT, ExpandableT>::operator*=(int n)
{
    duplicate(n);
    return *this;
}
...
template<uint ChunkSizeT, bool ExpandableT>
inline void CString<ChunkSizeT, ExpandableT>::adapt(const char* cstring, Size length)
{
    Yuni::Private::CStringImpl::AdapterAssign<CStringType, adapter>::Perform(
      *this, cstring, length);
}

template<uint ChunkSizeT, bool ExpandableT>
template<class StringT>
inline void CString<ChunkSizeT, ExpandableT>::adapt(const StringT& string)
{
    Yuni::Private::CStringImpl::AdapterAssign<CStringType, adapter>::Perform(
      *this,
...
template<uint ChunkSizeT, bool ExpandableT>
template<class StringT>
inline void CString<ChunkSizeT, ExpandableT>::adapt(const StringT& string, Size length, Size offset)
{
    Yuni::Private::CStringImpl::AdapterAssign<CStringType, adapter>::Perform(
      *this, Traits::CString<StringT>::Perform(string) + offset, length);
}

template<uint ChunkSizeT, bool ExpandableT>
inline void CString<ChunkSizeT, ExpandableT>::adaptWithoutChecking(const char* const cstring,
                                                                   Size length)
{
...
inline void CString<ChunkSizeT, ExpandableT>::extractKeyValue(StringT1& key,
                                                              StringT2& value,
                                                              bool ignoreCase,
                                                              char separator) const
{
    ...
    while (rv < AncestorType::size
           and (AncestorType::data[rv] == ' ' or AncestorType::data[rv] == '\t'
                or AncestorType::data[rv] == '\r' or AncestorType::data[rv] == '\n'))
    {
        ++rv;
    }
    ...
    if (rv < AncestorType::size) // Empty value
    {
        ...
        case '\'':
        {
            ...
            next
              = FindEndOfSequence<CStringType>(AncestorType::data + rv, c, AncestorType::size - rv);
            if (next != npos)
...
bool CString<ChunkSizeT, ExpandableT>::words(const AnyString& separators,
...
template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::append(const wchar_t* wbuffer,
                                                     Size wsize,
                                                     Size offset)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
...
template<uint ChunkSizeT, bool ExpandableT>
inline bool CString<ChunkSizeT, ExpandableT>::append(const wchar_t* wbuffer, Size wsize)
{
    YUNI_STATIC_ASSERT(!adapter, CString_Adapter_ReadOnly);
    ...
    if (written != 0)
    {
        ...
        resize(AncestorType::size
               + static_cast<Size>(written)); // making sure that the string is zero-terminated
        return true;
    }
