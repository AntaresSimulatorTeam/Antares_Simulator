    ...
    static void Perform(CStringT& s, const void* rhs)
    {
        ...
        else
        {
#ifdef YUNI_OS_MSVC
            {
                ...
                {
                    s.appendWithoutChecking(
                      buffer,
                      Yuni::Traits::Length<typename CStringT::Type*,
    ...
    public:                                                                                       \
        ...
        {                                                                                         \
            ...
            {                                                                                     \
                ...
                s.appendWithoutChecking(                                                          \
                  buffer,                                                                         \
                  Yuni::Traits::Length<typename CStringT::Type*, typename CStringT::Size>::Value( \
                    buffer));                                                                     \
            }                                                                                     \
        }                                                                                         \
    }
...
YUNI_PRIVATE_MEMORY_BUFFER_APPEND_IMPL_INT(int16_t);
YUNI_PRIVATE_MEMORY_BUFFER_APPEND_IMPL_INT(int32_t);
YUNI_PRIVATE_MEMORY_BUFFER_APPEND_IMPL_INT(int64_t);
YUNI_PRIVATE_MEMORY_BUFFER_APPEND_IMPL_INT(uint16_t);
YUNI_PRIVATE_MEMORY_BUFFER_APPEND_IMPL_INT(uint32_t);
YUNI_PRIVATE_MEMORY_BUFFER_APPEND_IMPL_INT(uint64_t);
#ifdef YUNI_HAS_LONG
