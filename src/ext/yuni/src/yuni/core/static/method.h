...
#define YUNI_IMPL_STATIC_HAS_METHOD(METHOD, RETURN_TYPE, ...)                                      \
    ...
    {                                                                                              \
        ...
        static TrueType deduce(C*, U C::* = 0);                                                    \
        template<class C>                                                                          \
        static FalseType deduce(...);                                                              \
                                                                                                   \
        template<class C>                                                                          \
        static FalseType deduce(C*,                                                                \
                                Identity<RETURN_TYPE(BaseMixin::*) __VA_ARGS__, &C::METHOD>* = 0); \
...
#define YUNI_IMPL_STATIC_HAS_METHOD(METHOD, RETURN_TYPE, ...)                         \
    ...
    {                                                                                 \
        ...
        static TrueType deduce(                                                       \
          C*,                                                                         \
          Helper<std::is_member_function_pointer<decltype(&C::METHOD)>::value>* = 0); \
        template<class C>                                                             \
        static FalseType deduce(...);                                                 \
                                                                                      \
    public:                                                                           \
