...
template<>
inline Variant Variant::New<char*>::Instance()
{
    return Variant(String());
}
template<>
inline Variant Variant::New<const char*>::Instance()
{
    return Variant(String());
}
template<>
inline Variant Variant::New<String>::Instance()
{
    return Variant(String());
}

template<>
inline Variant Variant::New<float>::Instance()
{
    return Variant(double());
}
template<>
inline Variant Variant::New<double>::Instance()
{
    return Variant(double());
}
...
template<>
inline Variant Variant::New<bool>::Instance()
{
    return Variant(bool());
}
template<>
...
inline Variant::Variant() : pShareContent(false)
{
}

inline Variant::Variant(const NullPtr&) : pShareContent(false)
{
}

inline Variant::Variant(const Variant& rhs) : pShareContent(false)
{
    assign(rhs);
}

template<uint ChunkT, bool ExpT>
inline Variant::Variant(const CString<ChunkT, ExpT>& rhs) : pShareContent(false)
{
    assign(rhs);
}

inline Variant::Variant(const char* rhs) : pShareContent(false)
{
    assign(rhs);
}

inline Variant::Variant(bool rhs) : pShareContent(false)
{
    assign(rhs);
}

inline Variant::Variant(char rhs) : pShareContent(false)
{
    assign(rhs);
}
...
inline Variant::Variant(float rhs) : pShareContent(false)
{
    assign(rhs);
}

inline Variant::Variant(double rhs) : pShareContent(false)
{
    assign(rhs);
}
...
inline void Variant::deepCopyIfNonUnique()
{
    ...
    {
        Private::Variant::IDataHolder* pointer
          = Private::Variant::IDataHolder::Ptr::WeakPointer(pData);
        pData = pointer->clone();
    }
}
...
#define YUNI_VARIANT_OPERATOR_TYPE                                                      \
    const typename Yuni::Static::Remove::Volatile<typename Yuni::Static::Remove::Const< \
