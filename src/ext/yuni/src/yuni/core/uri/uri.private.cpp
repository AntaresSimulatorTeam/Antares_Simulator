...
namespace Uri
{
Informations::Informations() : port(INT_MIN), isValid(false)
{
}
...
{
    return isValid and rhs.isValid and scheme == rhs.scheme and path == rhs.path
           and server == rhs.server and port == rhs.port and query == rhs.query
           and fragment == rhs.fragment and user == rhs.user and password == rhs.password;
}
