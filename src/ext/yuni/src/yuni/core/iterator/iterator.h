...
public:
    ...
    */
    ...
    //! Equality comparison
    template<class M, bool C>
    bool operator==(const IIterator<M, C>& rhs) const;
    ...
    //! Assignment
    template<class M, bool C>
    IteratorType& operator=(const IIterator<M, C>& rhs);
    //@}
...
template<class ModelT, bool ConstT>
inline Yuni::IIterator<ModelT, ConstT> operator+(
  const Yuni::IIterator<ModelT, ConstT>& it,
  typename Yuni::IIterator<ModelT, ConstT>::difference_type n)
{
