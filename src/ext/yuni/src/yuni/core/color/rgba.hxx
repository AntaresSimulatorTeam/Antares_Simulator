    ...
    static inline void Increase(RGBType& color, const T& value)
    {
        ...
        if (PlusT)
        {
            ...
            color.blue = Math::MinMaxEx<Type>(static_cast<CalculationType>(color.blue) + v,
                                              (CalculationType)lowerBound,
                                              (CalculationType)upperBound);
            color.alpha = Math::MinMaxEx<Type>(static_cast<CalculationType>(color.alpha) + v,
                                               (CalculationType)lowerBound,
                                               (CalculationType)upperBound);
        }
        else
    ...
    static inline void Assign(Yuni::Color::RGBA<U>& color, const Yuni::Color::RGBA<V>& value)
    {
        ...
        else
        {
            ...
            color.blue = static_cast<U>(static_cast<CalculationType>(value.blue)
                                        * Yuni::Color::RGBA<U>::upperBound
                                        / Yuni::Color::RGBA<V>::upperBound);
            color.alpha = static_cast<U>(static_cast<CalculationType>(value.alpha)
                                         * Yuni::Color::RGBA<U>::upperBound
                                         / Yuni::Color::RGBA<V>::upperBound);
        }
    }
...
struct RGBA<Yuni::Color::RGBA<U>, Yuni::Color::RGB<V>> final
{
    ...
    static inline bool IsEqual(Yuni::Color::RGBA<U>& color, const Yuni::Color::RGB<V>& value)
    {
        if ((int)Yuni::Color::RGBA<U>::upperBound == (int)Yuni::Color::RGB<V>::upperBound
            and (int) Yuni::Color::RGBA<U>::lowerBound == (int)Yuni::Color::RGB<V>::lowerBound)
        {
            return Math::Equals(value.alpha, Yuni::Color::RGBA<U>::upperBound)
...
{
    stream << "rgba(" << static_cast<PrintType>(red) << ',' << static_cast<PrintType>(green) << ','
...
YUNI_COLOR_RGBA_OPERATOR_TYPE_RGBA(uint8)
...
YUNI_COLOR_RGBA_OPERATOR_RGBA_TYPE(uint8)
