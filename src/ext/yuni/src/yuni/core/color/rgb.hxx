...
struct RGB final
{
    ...
    static inline void Increase(RGBType& color, const T& value)
    {
        ...
        if (PlusT)
        {
            color.red = Math::MinMaxEx<Type>(static_cast<CalculationType>(color.red) + v,
                                             (CalculationType)lowerBound,
                                             (CalculationType)upperBound);
            color.green = Math::MinMaxEx<Type>(static_cast<CalculationType>(color.green) + v,
                                               (CalculationType)lowerBound,
                                               (CalculationType)upperBound);
            color.blue = Math::MinMaxEx<Type>(static_cast<CalculationType>(color.blue) + v,
                                              (CalculationType)lowerBound,
                                              (CalculationType)upperBound);
        }
        else
...
struct RGB<Yuni::Color::RGB<U>, Yuni::Color::RGB<V>> final
{
        ...
        else
        {
            color.red
              = static_cast<U>(static_cast<CalculationType>(value.red)
                               * Yuni::Color::RGB<U>::upperBound / Yuni::Color::RGB<V>::upperBound);
            color.green
    ...
    static inline bool IsEqual(Yuni::Color::RGB<U>& color, const Yuni::Color::RGB<V>& value)
    {
        if ((int)Yuni::Color::RGB<U>::upperBound == (int)Yuni::Color::RGB<V>::upperBound
            and (int) Yuni::Color::RGB<U>::lowerBound == (int)Yuni::Color::RGB<V>::lowerBound)
        {
            return Math::Equals(color.red, static_cast<U>(value.red))
                   and Math::Equals(color.green, static_cast<U>(value.green))
                   and Math::Equals(color.blue, static_cast<U>(value.blue));
        }
        else
        {
            return Math::Equals(color.red,
                                static_cast<U>(static_cast<CalculationType>(value.red)
                                               * Yuni::Color::RGB<U>::upperBound
                                               / Yuni::Color::RGB<V>::upperBound))
                   and Math::Equals(color.green,
                                    static_cast<U>(static_cast<CalculationType>(value.green)
                                                   * Yuni::Color::RGB<U>::upperBound
                                                   / Yuni::Color::RGB<V>::upperBound))
                   and Math::Equals(color.blue,
                                    static_cast<U>(static_cast<CalculationType>(value.blue)
                                                   * Yuni::Color::RGB<U>::upperBound
                                                   / Yuni::Color::RGB<V>::upperBound));
        }
...
struct RGB<Yuni::Color::RGB<U>, Yuni::Color::RGBA<V>> final
{
    ...
    static inline void Assign(Yuni::Color::RGB<U>& color, const Yuni::Color::RGBA<V>& value)
    {
        ...
        {
            color.red = static_cast<U>(static_cast<CalculationType>(value.red)
                                       * Yuni::Color::RGB<U>::upperBound
                                       / Yuni::Color::RGBA<V>::upperBound);
            color.green = static_cast<U>(static_cast<CalculationType>(value.green)
                                         * Yuni::Color::RGB<U>::upperBound
                                         / Yuni::Color::RGBA<V>::upperBound);
            color.blue = static_cast<U>(static_cast<CalculationType>(value.blue)
                                        * Yuni::Color::RGB<U>::upperBound
                                        / Yuni::Color::RGBA<V>::upperBound);
        }
    }
    ...
    static inline bool IsEqual(Yuni::Color::RGB<U>& color, const Yuni::Color::RGBA<V>& value)
    {
        if ((int)Yuni::Color::RGB<U>::upperBound == (int)Yuni::Color::RGBA<V>::upperBound
            and (int) Yuni::Color::RGB<U>::lowerBound == (int)Yuni::Color::RGBA<V>::lowerBound)
        {
            return Math::Equals(value.alpha, Yuni::Color::RGBA<V>::upperBound)
...
{
template<class T>
inline RGB<T>::RGB() : red(lowerBound), green(lowerBound), blue(lowerBound)
{
}

template<class T>
inline RGB<T>::RGB(const RGB<T>& rhs) : red(rhs.red), green(rhs.green), blue(rhs.blue)
{
}
...
{
    return (red >= static_cast<T>(lowerBound) and red <= static_cast<T>(upperBound))
...
{
    stream << "rgb(" << static_cast<PrintType>(red) << ',' << static_cast<PrintType>(green) << ','
...
YUNI_COLOR_RGB_OPERATOR_TYPE_RGB(uint8)
...
YUNI_COLOR_RGB_OPERATOR_RGB_TYPE(uint8)
