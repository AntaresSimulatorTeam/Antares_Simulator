...
public:
    ...
    //! Pointer to a node
    typedef
      typename Static::If<ThreadingPolicy::threadSafe, PtrThreadSafe, PtrSingleThreaded>::ResultType
        Ptr;
    ...
    typedef IIterator<Private::Core::Tree::DepthPrefixIterator<Node>, true>
      const_depth_prefix_iterator;
    //   Infix
    typedef IIterator<Private::Core::Tree::DepthInfixIterator<Node>, false> depth_infix_iterator;
    typedef IIterator<Private::Core::Tree::DepthInfixIterator<Node>, true>
      const_depth_infix_iterator;
