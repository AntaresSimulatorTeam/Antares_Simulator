...
*/
#define YUNI_VAARGS_COUNT(...) YUNI_PRIVATE_VAARGS_N_ARG_(__VA_ARGS__, YUNI_PRIVATE_VAARGS_RSEQ_N())
...
#define YUNI_VAARGS_FOREACH(Macro, ...) \
    YUNI_PRIVATE_VAARGS_CALL_MACRO(Macro, YUNI_EMPTY, YUNI_VAARGS_COUNT(__VA_ARGS__), __VA_ARGS__)
...
#define YUNI_PRIVATE_VAARGS_N_ARG_(...) YUNI_PRIVATE_VAARGS_ARG_N_INTERMEDIATE(__VA_ARGS__)
...
#define YUNI_PRIVATE_VAARGS_CALL_MACRO(Macro, MacroSeparator, Total, ...)        \
    YUNI_EMPTY, YUNI_PRIVATE_VAARGS_CALL_MC_INTERMEDIATE(                        \
                  Macro,                                                         \
                  MacroSeparator,                                                \
                  YUNI_PRIVATE_VAARGS_JOIN(YUNI_PRIVATE_VAARGS_CALL_MC_, Total), \
                  __VA_ARGS__,                                                   \
                  piko)
