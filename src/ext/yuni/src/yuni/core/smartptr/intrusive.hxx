...
inline IIntrusiveSmartPtr<ChildT, VirtualT, TP>::IIntrusiveSmartPtr() : pRefCount()
{
}
...
template<class ChildT, bool VirtualT, template<class> class TP>
inline IIntrusiveSmartPtr<ChildT, VirtualT, TP>::IIntrusiveSmartPtr(
  const IIntrusiveSmartPtr<ChildT, VirtualT, TP>&) :
 pRefCount()
{
}
...
inline IIntrusiveSmartPtr<ChildT, false, TP>::IIntrusiveSmartPtr() : pRefCount()
{
}
...
template<class ChildT, template<class> class TP>
inline IIntrusiveSmartPtr<ChildT, false, TP>::IIntrusiveSmartPtr(
  const IIntrusiveSmartPtr<ChildT, false, TP>&) :
 ThreadingPolicy(), pRefCount()
{
}

template<class ChildT, template<class> class TP>
inline IIntrusiveSmartPtr<ChildT, false, TP>& IIntrusiveSmartPtr<ChildT, false, TP>::operator=(
  const IIntrusiveSmartPtr&)
{
    // Does nothing
    return *this;
}
