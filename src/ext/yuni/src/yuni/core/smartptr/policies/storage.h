...
public:
    ...
    static StoredType DefaultValue()
    {
        return nullptr;
    }
...
public:
    ...
    //! \name Get the data
    //@{
    friend PointerType storagePointer(const Pointer& rhs)
    {
        return rhs.pData;
    }
...
public:
    ...
    //! \name Get the data
    //@{
    friend PointerType storagePointer(const Array& rhs)
    {
        return rhs.pData;
    }
