...
public:
    ...
    */
    ...
    typedef SmartPtr<T, OwspP, ChckP, ConvP, StorP, Policy::Constness::PropagateConst>
      ConstSmartPtrType;
    //! A smart pointer with a non-const pointer
    typedef SmartPtr<T, OwspP, ChckP, ConvP, StorP, Policy::Constness::DontPropagateConst>
      NonConstSmartPtrType;

    //! The Type to use for the copy constructor
    typedef typename Static::
      If<OwnershipPolicy::destructiveCopy, SmartPtrType, const SmartPtrType>::ResultType CopyType;
...
public:
    ...
    typedef
      typename Static::If<ConversionPolicy::allow, const StoredType&, NeverMatched>::ResultType
        ImplicitStoredType;
...
public:
    ...
    {
        return Static::MoveConstructor<SmartPtr>(*this);
    }
