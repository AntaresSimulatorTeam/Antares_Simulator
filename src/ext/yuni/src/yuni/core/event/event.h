...
public:
    ...
    typedef
      typename Yuni::Private::EventImpl::template WithNArguments<BindType::argumentCount, BindType>
        AncestorType;
...
public:
    ...
    */
    template<class C>
    void connect(C* o, typename PointerToMember<C>::Type method);
    /*!
    ...
    */
    template<class C>
    void connect(const C* o, typename PointerToMember<C>::ConstType method);
    //@}
