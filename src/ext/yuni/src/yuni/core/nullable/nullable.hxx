...
template<class T, class Alloc>
template<class U>
inline Nullable<T, Alloc>::Nullable(const U& rhs) : pHolder(rhs)
{
}
...
template<class T, class Alloc>
inline Nullable<T, Alloc>::Nullable(const Nullable<T, Alloc>& rhs) : pHolder(rhs.pHolder)
{
}
...
inline Nullable<T, Alloc>::Nullable(const Nullable<T, Alloc1>& rhs) : pHolder(rhs.pHolder)
{
}
...
{
    return pHolder.empty() ? rhs.empty() : (rhs.pHolder.data() == pHolder.data());
}
...
template<class T, class Alloc>
inline Nullable<T, Alloc>& Nullable<T, Alloc>::operator=(
  typename Nullable<T, Alloc>::const_pointer rhs)
{
    if (rhs)
        pHolder.assign(*rhs);
    else
