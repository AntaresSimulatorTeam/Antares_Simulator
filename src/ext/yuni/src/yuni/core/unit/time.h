...
//! \brief Sidereal Year (time taken for Sun to return to the same position with respect to the
//! stars of the celestial sphere) \ingroup UnitTime
YUNI_UNIT_IMPL(SiderealYear, "siderealyear", "", double, 31558149.7632);
//! \brief Tropical Year (time it takes for the Sun to return to the same position in the cycle of
//! seasons) \ingroup UnitTime
...
//! \brief Second (Duration of 9,192,631,770 periods of the radiation corresponding to the
...
//! \brief Microsecond
//! \ingroup UnitTime
YUNI_UNIT_IMPL(Microsecond, "microsecond", "�s,", double, 1e-6);
//! \brief Nanosecond
//! \ingroup UnitTime
