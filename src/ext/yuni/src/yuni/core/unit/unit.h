...
public:
    ...
    //! Relation to SI
    static N RelationToSI()
    {
        return Child::RelationToSI();
    }
...
public:
    ...
    */
    ...
    //@{
    template<typename U>
    U toSIBaseUnit() const
    {
        return (U)((P)pValue * (P)Child::RelationToSI());
    }
    //@}
...
template<class Q,
         ...
         typename P1,
         typename N1>
inline const Yuni::Unit::Abstract<Q, Child, T, P, N> operator+(
  const Yuni::Unit::Abstract<Q, Child, T, P, N>& lhs,
