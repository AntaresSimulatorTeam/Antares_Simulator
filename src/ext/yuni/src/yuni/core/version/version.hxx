...
inline Version::Version(uint major) : hi(major), lo(), revision()
{
}

inline Version::Version(uint major, uint minor) : hi(major), lo(minor), revision()
{
}

inline Version::Version(uint major, uint minor, uint rev) : hi(major), lo(minor), revision(rev)
{
}

inline Version::Version(const Version& c) : hi(c.hi), lo(c.lo), revision(c.revision)
{
}
