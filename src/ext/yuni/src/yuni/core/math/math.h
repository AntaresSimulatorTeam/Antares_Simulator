...
*/
template<class U>
YUNI_DECL bool Equals(U a, U b);

/*!
** \brief Get if a value is equals to zero
*/
template<class U>
YUNI_DECL bool Zero(U a);

/*!
** \brief Get the integer absolute value
*/
template<class T>
YUNI_DECL T Abs(const T a);
...
*/
template<class T>
YUNI_DECL const T& MinMax(const T& expr, const T& min, const T& max);
...
*/
template<class U>
YUNI_DECL U SquareRootNoCheck(U x);
...
struct SquareRootInt final
{
    ...
    enum
    {
        value = (I * I < N) ? SquareRootInt<N, I + 1>::value : I
    };
...
*/
template<class T>
YUNI_DECL T DegreeToRadian(T x);
...
*/
template<class T>
YUNI_DECL T RadianToDegree(T x);

/*!
** \brief Determine whether the argument value is a NaN
*/
template<class T>
YUNI_DECL bool NaN(const T& x);
...
*/
template<class T>
YUNI_DECL int Infinite(const volatile T& x);

/*!
** \brief Floor function
*/
template<class T>
YUNI_DECL T Floor(T x);

/*!
** \brief Ceil function
*/
template<class T>
YUNI_DECL T Ceil(T x);

/*!
** \brief The fractional part function
*/
template<class T>
YUNI_DECL T Fract(T x);
...
*/
template<class T>
YUNI_DECL T Round(T x, uint place = 0);
...
*/
template<class T>
YUNI_DECL T Trunc(T x, uint place = 0);
...
struct YUNI_DECL RoundToInt;

/*!
** \brief Rounding up to the nearest multiple of a number
*/
template<class T>
T YUNI_DECL RoundUp(T value, T multiple);
