...
template<class D, int TableSize, bool Cyclic, template<class> class TP>
inline void Table<D, TableSize, Cyclic, TP>::reset()
{
...
template<class D, int TableSize, bool Cyclic, template<class> class TP>
inline void Table<D, TableSize, Cyclic, TP>::fill()
{
    typename ThreadingPolicy::MutexLocker locker(*this);
    fillWL();
}
...
template<class D, int TableSize, bool Cyclic, template<class> class TP>
void Table<D, TableSize, Cyclic, TP>::fillWL()
{
...
template<class D, int TableSize, bool Cyclic, template<class> class TP>
inline int Table<D, TableSize, Cyclic, TP>::size()
{
    return TableSize;
}

template<class D, int TableSize, bool Cyclic, template<class> class TP>
inline const typename Table<D, TableSize, Cyclic, TP>::Value Table<D, TableSize, Cyclic, TP>::next()
{
    // Lock
    typename ThreadingPolicy::MutexLocker locker(*this);
...
template<class D, int TableSize, bool Cyclic, template<class> class TP>
template<class U>
inline Table<D, TableSize, Cyclic, TP>& Table<D, TableSize, Cyclic, TP>::operator>>(U& u)
{
    u = next();
    return *this;
}
