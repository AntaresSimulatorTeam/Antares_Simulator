...
*/
template<typename T>
static bool SegmentIntersectsPlane(const Point3D<T>& startPoint,
...
*/
template<typename T>
static bool SegmentIntersectsTriangle(const Point3D<T>& segmentStart,
...
*/
template<typename T>
static bool SegmentIntersectsQuad(const Point3D<T>& segmentStart,
                                  const Point3D<T>& segmentEnd,
                                  const Point3D<T>& p1,
                                  const Point3D<T>& p2,
                                  const Point3D<T>& p3,
...
*/
template<typename T>
static bool SegmentIntersectsSphere(const Point3D<T>& startPoint,
                                    const Point3D<T>& endPoint,
