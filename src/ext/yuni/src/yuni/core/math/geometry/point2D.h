...
public:
    ...
    */
    template<class U>
    void translate(const Point2D<U>& p);
    ...
    */
    template<class U>
    bool isCloseTo(const Point2D<U>& rhs, const T& delta) const;
    ...
    */
    template<class U>
    bool operator==(const Point2D<U>& rhs) const;
