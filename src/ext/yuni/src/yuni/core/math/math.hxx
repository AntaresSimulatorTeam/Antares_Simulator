...
{
    return ((expr < min) ? static_cast<T>(min)
                         : ((expr > max) ? static_cast<T>(max) : static_cast<T>(expr)));
}

//! Factorial(1) = 1
template<>
struct Factorial<1> final
{
    enum
    {
        value = 1
...
template<int N>
struct SquareRootInt<N, N> final
{
    enum
    {
        value = N
...
template<class U>
inline bool Equals(U a, U b)
{
    return (a == b);
}

template<>
inline bool Equals<float>(float a, float b)
{
    return ::fabsf(a - b) < YUNI_EPSILON;
}

template<>
inline bool Equals<double>(double a, double b)
{
...
#ifdef YUNI_HAS_LONG_DOUBLE
template<>
inline bool Equals<long double>(long double a, long double b)
{
...
template<class U>
inline bool Zero(U a)
{
    return (0 == a);
}

template<>
inline bool Zero<float>(float a)
{
    return ::fabsf(a) < YUNI_EPSILON;
}

template<>
inline bool Zero<double>(double a)
{
...
#ifdef YUNI_HAS_LONG_DOUBLE
template<>
inline bool Zero<long double>(long double a)
{
...
template<>
inline double SquareRootNoCheck(double x)
{
    return ::sqrt(x);
}

template<>
inline float SquareRootNoCheck(float x)
{
    return ::sqrtf(x);
}
...
template<class T>
inline T DegreeToRadian(T x)
{
    return x * static_cast<T>(0.017453292);
}

template<class T>
inline T RadianToDegree(T x)
{
    return x * static_cast<T>(57.29578122);
}

template<class T>
inline bool NaN(const T& x)
{
...
template<class T>
inline int Infinite(const volatile T& x)
{
...
#ifdef YUNI_HAS_LONG_DOUBLE
template<>
inline long double Floor<long double>(long double x)
{
    return ::floorl(x);
}
#endif
...
#ifdef YUNI_HAS_LONG_DOUBLE
template<>
inline long double Ceil<long double>(const long double x)
{
    return ::ceill(x);
}
#endif
...
template<class T>
inline T Round(T x, uint)
{
    return x;
}

template<>
inline double Round<double>(double x, uint place)
{
    if (place)
    {
        double temp, mult;
...
#ifdef YUNI_HAS_LONG_DOUBLE
template<>
inline long double Round<long double>(long double x, uint place)
{
    if (place)
    {
...
template<>
inline float Round<float>(float x, uint place)
{
    if (place != 0)
    {
        float temp, mult;
...
template<class T>
inline T Trunc(T x, uint)
{
    return x;
}

template<>
inline double Trunc<double>(double x, uint place)
{
    if (place)
    {
        double temp, mult;
...
template<>
inline float Trunc<float>(float x, uint place)
{
    if (place)
    {
        float temp, mult;
...
#ifdef YUNI_HAS_LONG_DOUBLE
template<>
inline long double Trunc<long double>(long double x, uint place)
{
    if (place)
    {
        long double temp, mult;
...
template<>
inline long Abs<long>(const long x)
{
    return ::labs(x);
}

template<>
inline long long Abs<long long>(const long long x)
{
#ifdef YUNI_OS_MSVC
    return ::_abs64(x);
#else
...
#ifdef YUNI_HAS_LONG_DOUBLE
template<>
inline long double Abs<long double>(const long double x)
{
    return ::fabsl(x);
}
#endif
