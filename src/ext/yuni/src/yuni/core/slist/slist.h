...
public:
    ...
    LinkedList(const LinkedList<U, A>& rhs);
    //! Copy constructor from a standard std::list
    template<class U, class A>
    explicit LinkedList(const std::list<U, A>& rhs);
    //! Copy constructor from a standard std::vector
    template<class U, class A>
    explicit LinkedList(const std::vector<U, A>& rhs);
    //! Destructor
    ~LinkedList();
    //@}
    ...
    */
    template<class U, class A>
    void push_back(const LinkedList<U, A>& rhs);
    /*!
    ** \brief Add a list of values at the end of the list
    */
    template<class U, class A>
    void push_back(const std::list<U, A>& rhs);
    /*!
    ** \brief Add a list of values at the end of the list
    */
    template<class U, class A>
    void push_back(const std::vector<U, A>& rhs);
    ...
    */
    template<class U, class A>
    void push_front(const LinkedList<U, A>& rhs);
    /*!
    ** \brief Add a list of values at the beginning of the list
    */
    template<class U, class A>
    void push_front(const std::list<U, A>& rhs);
    /*!
    ** \brief Add a list of values at the beginning of the list
    */
    template<class U, class A>
    void push_front(const std::vector<U, A>& rhs);
    ...
    */
    template<class U, class A>
    Size remove(const LinkedList<U, A>& rhs);
    ...
    */
    template<class U, class A>
    Size remove(const std::list<U, A>& rhs);
    ...
    */
    template<class U, class A>
    Size remove(const std::vector<U, A>& rhs);
    ...
    */
    template<class U>
    LinkedList& operator+=(const U& value);
...
protected:
    ...
    public:
        ...
        inline explicit Item(Item* n) : next(n), data()
        {
        }
        inline explicit Item(value_type& value) : next(nullptr), data(value)
        {
        }
        template<class U>
        inline explicit Item(const U& value) : next(nullptr), data(value)
        {
        }
        inline Item(Item* n, reference_type value) : next(n), data(value)
        {
        }
        template<class U>
        inline Item(Item* n, const U& value) : next(n), data(value)
        {
        }
