...
namespace Yuni::Private::LinkedListImpl
{
...
template<class T, class Alloc>
typename LinkedList<T, Alloc>::iterator LinkedList<T, Alloc>::find(
  typename LinkedList<T, Alloc>::const_reference_type value)
{
    Item* it = pHead;
    while (it)
    {
...
template<class T, class Alloc>
typename LinkedList<T, Alloc>::const_iterator LinkedList<T, Alloc>::find(
  typename LinkedList<T, Alloc>::const_reference_type value) const
{
    Item* it = pHead;
    while (it)
    {
