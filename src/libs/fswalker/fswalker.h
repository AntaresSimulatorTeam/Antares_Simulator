...
namespace FSWalker
{
	...
	typedef void (* OnFileEvent) (const YString& filename, const YString& parent, yint64 modified, yuint64 size, void* user);
	...
	public:
		...
		*/
		virtual OnDirectoryEvent directoryEvent() {return nullptr;}

		/*!
		** \brief Provide a reentrant event for handling files
		*/
		virtual OnFileEvent fileEvent() {return nullptr;}

		/*!
		** \brief Get the user data
		*/
		virtual void* userdataCreate(DispatchJobEvent&) {return nullptr;}
