...
namespace FSWalker
{
	...
	protected:
		...
		bool triggerFileEvent(const String& filename, const String& parent, sint64 modified, uint64 size);
	...
	bool WalkerThread::triggerFileEvent(const String& filename, const String& parent, sint64 modified, uint64 size)
	{
	...
	void Walker::run()
	{
		...
		std::sort(pExtensions.begin(), pExtensions.end(), [] (const IExtension::Ptr& a, const IExtension::Ptr& b) {
