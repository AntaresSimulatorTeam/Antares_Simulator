...
void
FileContent::addItemToSection(const string& section, const string& key, int value)
{
...
void
FileContent::addItemToSection(const string& section, const string& key, const string& value)
{
    std::lock_guard guard(pSectionsMutex);
...
void
FileContent::addDurationItem(const string& name, unsigned int duration, int nbCalls)
{
