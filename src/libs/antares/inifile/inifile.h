...
namespace Antares
{
	...
	*/
	...
	public:
		...
		*/
		...
		public:
			...
			template<class StreamT> void saveToStream(StreamT& file, yuint64& written) const;
		...
		*/
		...
		public:
			...
			*/
			template<class U> Property* add(const AnyString& key, const U& value);
			...
			** \endcode
			*/
			template<class CallbackT> void each(const CallbackT& callback);
			...
			** \endcode
			*/
			template<class CallbackT> void each(const CallbackT& callback) const;
	...
	public:
		...
		** \endcode
		*/
		template<class CallbackT> void properties(const CallbackT& callback);
		...
		** \endcode
		*/
		template<class CallbackT> void properties(const CallbackT& callback) const;
		//@}
