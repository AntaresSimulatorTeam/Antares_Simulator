...
bool Study::clusterRename(Cluster* cluster, ClusterName newName, ClusterType clusterType)
{
    assert((clusterType == kThermal or clusterType == kRenewable) && "Wrong cluster type");
    // A name must not be empty
