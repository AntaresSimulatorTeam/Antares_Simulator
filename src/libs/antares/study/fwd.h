...
namespace Data
{
	...
	*/
	...
	template<int T> struct TimeSeriesBitPatternIntoIndex;

	template<> struct TimeSeriesBitPatternIntoIndex<1>  { enum {value = 0}; };
	template<> struct TimeSeriesBitPatternIntoIndex<2>  { enum {value = 1}; };
	template<> struct TimeSeriesBitPatternIntoIndex<4>  { enum {value = 2}; };
	template<> struct TimeSeriesBitPatternIntoIndex<8>  { enum {value = 3}; };
	template<> struct TimeSeriesBitPatternIntoIndex<16> { enum {value = 4}; };

	template<int T> struct TimeSeriesToCStr;
	template<> struct TimeSeriesToCStr<1>  { static const char* Value() {return "load";}};
	template<> struct TimeSeriesToCStr<2>  { static const char* Value() {return "hydro";}};
	template<> struct TimeSeriesToCStr<4>  { static const char* Value() {return "wind";}};
	template<> struct TimeSeriesToCStr<8>  { static const char* Value() {return "thermal";}};
	template<> struct TimeSeriesToCStr<16> { static const char* Value() {return "solar";}};
