	...
	public:
		...
		*/
		bool isVisibleOnLayer(const size_t& layerID)const
		{
			...
			std::vector<size_t>::iterator layerPosition = std::find(layerList.begin(), layerList.end(), layerID);
		...
		*/
		...
		template<int TimeSeriesT> bool storeTimeseriesNumbers(Study& study);
		...
		*/
		template<enum TimeSeries T> XCast* xcastData();
		template<enum TimeSeries T> const XCast* xcastData() const;
