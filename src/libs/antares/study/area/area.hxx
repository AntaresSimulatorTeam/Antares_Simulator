...
namespace Data
{
	...
	inline XCast* Area::xcastData()
	{
		switch (T)
		{
			case timeSeriesLoad:    return &(load.prepro->xcast);
			case timeSeriesSolar:   return &(solar.prepro->xcast);
			case timeSeriesWind:    return &(wind.prepro->xcast);
			case timeSeriesHydro:   return nullptr;
			case timeSeriesThermal: return nullptr;
		}
		return nullptr;
	}
