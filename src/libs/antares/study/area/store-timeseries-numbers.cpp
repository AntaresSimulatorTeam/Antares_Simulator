...
void Area::storeTimeseriesNumbersForHydroPowerCredits(Solver::IResultWriter::Ptr writer) const
{
    genericStoreTimeseriesNumbers(writer, hydro.series->timeseriesNumbersPowerCredits, id, "power-credits");
}
