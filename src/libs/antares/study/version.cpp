...
namespace Data
{
	...
	static inline Version StudyFormatCheckForThe2xFormat(const String& headerFile)
	{
		...
		switch (venum)
		{
			...
			case version1xx:
				{
					return (version and (uint) version > (uint) versionLatest)
						? versionFutur : versionUnknown;
				}
			default:
				return venum;
		}
	...
	const char* VersionToCStr(const Version v)
	{
		...
		switch (v)
		{
			case versionFutur:    return ">8.0";
			case version800:      return "8.0";
			...
			case version610:      return "6.1";
			case version600:      return "6.0";
			case version510:      return "5.1";
			case version500:      return "5.0";
			case version450:      return "4.5";
			case version440:      return "4.4";
			case version430:      return "4.3";
			case version420:      return "4.2";
			case version410:      return "4.1";
			case version400:      return "4.0";
			case version390:      return "3.9";
			case version380:      return "3.8";
			case version370:      return "3.7";
			case version360:      return "3.6";
			case version350:      return "3.5";
			case version340:      return "3.4";
			case version330:      return "3.3";
			case version320:      return "3.2";
			case version310:      return "3.1";
			case version300:      return "3.0";
			case version210:      return "2.1";
			case version200:      return "2.0";
			case version1xx:      return "1.0";
	...
	const wchar_t* VersionToWStr(const Version v)
	{
		...
		switch (v)
		{
			case versionFutur:		return L">8.0";
			case version800:		return L"8.0";
	...
	Version VersionIntToVersion(uint version)
	{
		...
		switch (version)
		{
			...
			case 630: return version630;
			case 620: return version620;
			case 610: return version610;
			case 600: return version600;
			case 510: return version510;
			case 500: return version500;
			case 450: return version450;
			case 440: return version440;
			case 430: return version430;
			case 420: return version420;
			case 410: return version410;
			case 400: return version400;
			case 390: return version390;
			case 380: return version380;
			case 370: return version370;
			case 360: return version360;
			case 350: return version350;
			case 340: return version340;
			case 330: return version330;
			case 320: return version320;
			case 310: return version310;
			case 300: return version300;
			case 210: return version210;
			case 200: return version200;
			case 100: return version1xx;
			case versionFutur:
