...
public:
    ...
    */
    ...
    //@}
    //Move constructor
    BindingConstraintsRepository(BindingConstraintsRepository&&) noexcept = default;
    //copy constructor
    BindingConstraintsRepository(const BindingConstraintsRepository&) = delete;
    //Move assignment operator
    BindingConstraintsRepository& operator=(BindingConstraintsRepository&&) noexcept = default;
