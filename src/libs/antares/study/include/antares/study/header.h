...
public:
    ...
    */
    ~StudyHeader() = default;
    //@}
    StudyHeader(const StudyHeader&) = default;
    StudyHeader(StudyHeader&&) = default;
    StudyHeader& operator=(const StudyHeader&) = default;
    StudyHeader& operator=(StudyHeader&&) = default;
