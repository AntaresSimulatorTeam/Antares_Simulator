...
namespace Area
{
	...
	DataTSGenerator::DataTSGenerator(Data::TimeSeries ts, const AnyString& areaname, const AnyString& clustername) :
		pType(ts),
		pOriginalAreaName(areaname),
	...
	void DataTSGenerator::registerViewsWL(Context& ctx)
	{
		switch (pType)
		{
			case Data::timeSeriesLoad:    ctx.view["2:Load"]["2:Generator"]   = this; break;
			case Data::timeSeriesSolar:   ctx.view["3:Solar"]["2:Generator"]  = this; break;
			case Data::timeSeriesWind:    ctx.view["4:Wind"]["2:Generator"]   = this; break;
			case Data::timeSeriesHydro:   ctx.view["5:Hydro"]["2:Generator"]  = this; break;
			case Data::timeSeriesThermal: ctx.view["6:hermal"]["2:Generator"] = this; break;
			default: break;
		}
	}
