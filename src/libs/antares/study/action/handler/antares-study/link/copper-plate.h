...
namespace Link
{
class CopperPlate : public IAction
{
public:
...
public:
    ...
    */
    CopperPlate(const AnyString& fromarea, const AnyString& toarea);
...
#endif // __ANTARES_LIBS_STUDY_ACTION_HANDLER_ANTARES_AREA_COPPERPLATE_H__
