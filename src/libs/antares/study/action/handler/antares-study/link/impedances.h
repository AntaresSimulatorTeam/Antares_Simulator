...
namespace Link
{
class Impedances : public IAction
{
public:
...
public:
    ...
    */
    Impedances(const AnyString& fromarea, const AnyString& toarea);
...
#endif // __ANTARES_LIBS_STUDY_ACTION_HANDLER_ANTARES_AREA_IMPEDANCES_H__
