...
namespace Data
{
	...
	{
	public:
		ThreadInputMemoryUsage(const Study& study) :
			pStudy(study)
		{
		}
			...
			case stdmEconomy:
				{
					enum
					{
						maxColumnsForExportation =
							Solver::Variable::Container::BrowseAllVariables<Solver::Variable::Economy::AllVariables>::maxValue,
					};
			...
			case stdmAdequacyDraft:
				{
					...
					{
						maxColumnsForExportation =
							Solver::Variable::Container::BrowseAllVariables<Solver::Variable::AdequacyDraft::AllVariables>::maxValue,
					};
