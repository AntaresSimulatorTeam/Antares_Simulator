...
namespace Data
{
	...
	*/
	...
	public:
		enum
		{
			...
			*/
			expectation = 0,
			/*!
			** \brief The standard deviation of the total capacity (ecart-type du logarithme de l'energie totale)
			**
			** These values will be modified before launching a simulation.
			** The solver requires log(expectaction) and log(stddeviation)
			*/
	...
	int PreproHydroLoadFromFolder(Study& s, PreproHydro* h, const AreaName& areaID, const char folder[]);
