...
namespace Data
{
	...
	*/
	...
	public:
		...
		*/
		template<class PredicateT> void each(const PredicateT& predicate);
		/*!
		** \brief Iterate through all thermal clusters (const)
		*/
		template<class PredicateT> void each(const PredicateT& predicate) const;
	...
	** \return A non-zero value if the operation succeeded, 0 otherwise
	*/
	bool ThermalClusterListLoadPreproFromFolder(Study& s, const StudyLoadOptions& options, ThermalClusterList* l, const AnyString& folder);
	...
	** \return A non-zero value if the operation succeeded, 0 otherwise
	*/
	int ThermalClusterListLoadDataSeriesFromFolder(Study& study, const StudyLoadOptions& options, ThermalClusterList* l, const AnyString& folder, int fast);
	...
	*/
	...
	int ThermalClusterListSaveDataSeriesToFolder(const ThermalClusterList* l, const AnyString& folder, const YString& msg);
