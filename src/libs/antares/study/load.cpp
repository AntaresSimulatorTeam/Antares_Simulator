...
namespace Data
{
	...
	bool Study::internalLoadCorrelationMatrices(const StudyLoadOptions& options)
	{
		if ((uint)header.version > (uint)version320)
		{
			...
			{
				buffer.clear() << folderInput << SEP
					<< "load" << SEP << "prepro" << SEP << "correlation.ini";
			...
			{
				buffer.clear() << folderInput << SEP
					<< "solar" << SEP << "prepro" << SEP << "correlation.ini";
		...
		// Wind
		{
			...
			{
				buffer.clear() << folderInput << SEP
					<< "wind" << SEP << "prepro" << SEP << "correlation.ini";
		...
		// Hydro
		{
			...
			{
				buffer.clear() << folderInput << SEP
					<< "hydro" << SEP << "prepro" << SEP << "correlation.ini";
