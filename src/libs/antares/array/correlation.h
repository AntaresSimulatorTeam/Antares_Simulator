...
namespace Data
{
	...
	public:
		...
		**   of the given study
		*/
		bool loadFromINI(Study& study, const IniFile& ini, bool warnings = true,
			int version = versionUnknown);
		...
		*/
		void copyFrom(const Correlation& source, const Study& studySource, const AreaName& areaSource,
